...
*/
(function(){if(!window.CKEDITOR||!window.CKEDITOR.dom)window.CKEDITOR||(window.CKEDITOR=function(){var a=/(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,e={timestamp:"EAPF",version:"4.4.6 (Standard)",revision:"08188c4",rnd:Math.floor(900*Math.random())+100,_:{pending:[],basePathSrcPattern:a},status:"unloaded",basePath:function(){var c=window.CKEDITOR_BASEPATH||"";if(!c)for(var d=document.getElementsByTagName("script"),b=0;b<d.length;b++){var f=d[b].src.match(a);if(f){c=f[1];break}}-1==c.indexOf(":/")&&
...
editor:a,data:k,listenerData:j,stop:f,cancel:h,removeListener:e};return c.call(d,a)===false?false:a.data}function e(){o.removeListener(b,c)}var k=a.call(this,b);if(k.getListenerIndex(c)<0){k=k.listeners;d||(d=this);isNaN(f)&&(f=10);var o=this;h.fn=c;h.priority=f;for(var p=k.length-1;p>=0;p--)if(k[p].priority<=f){k.splice(p+1,0,h);return{removeListener:e}}k.unshift(h)}return{removeListener:e}},once:function(){var a=Array.prototype.slice.call(arguments),c=a[1];a[1]=function(a){a.removeListener();return c.apply(this,
arguments)};return this.on.apply(this,a)},capture:function(){CKEDITOR.event.useCapture=1;var a=this.on.apply(this,arguments);CKEDITOR.event.useCapture=0;return a},fire:function(){var a=0,c=function(){a=1},d=0,b=function(){d=1};return function(f,h,i){var k=e(this)[f],f=a,o=d;a=d=0;if(k){var p=k.listeners;if(p.length)for(var p=p.slice(0),q,n=0;n<p.length;n++){if(k.errorProof)try{q=p[n].call(this,i,h,c,b)}catch(l){}else q=p[n].call(this,i,h,c,b);q===false?d=1:typeof q!="undefined"&&(h=q);if(a||d)break}}h=
d?false:typeof h=="undefined"?true:h;a=f;d=o;return h}}(),fireOnce:function(a,c,d){c=this.fire(a,c,d);delete e(this)[a];return c},removeListener:function(a,c){var d=e(this)[a];if(d){var b=d.getListenerIndex(c);b>=0&&d.listeners.splice(b,1)}},removeAllListeners:function(){var a=e(this),c;for(c in a)delete a[c]},hasListeners:function(a){return(a=e(this)[a])&&a.listeners.length>0}}}()),CKEDITOR.editor||(CKEDITOR.editor=function(){CKEDITOR._.pending.push([this,arguments]);CKEDITOR.event.call(this)},CKEDITOR.editor.prototype.fire=
...
"static")return a;a=a.getParent()}return null},getDocumentPosition:function(a){var b=0,g=0,f=this.getDocument(),h=f.getBody(),e=f.$.compatMode=="BackCompat";if(document.documentElement.getBoundingClientRect){var k=this.$.getBoundingClientRect(),o=f.$.documentElement,p=o.clientTop||h.$.clientTop||0,q=o.clientLeft||h.$.clientLeft||0,n=true;if(CKEDITOR.env.ie){n=f.getDocumentElement().contains(this);f=f.getBody().contains(this);n=e&&f||!e&&n}if(n){b=k.left+(!e&&o.scrollLeft||h.$.scrollLeft);b=b-q;g=
k.top+(!e&&o.scrollTop||h.$.scrollTop);g=g-p}}else{h=this;for(f=null;h&&!(h.getName()=="body"||h.getName()=="html");){b=b+(h.$.offsetLeft-h.$.scrollLeft);g=g+(h.$.offsetTop-h.$.scrollTop);if(!h.equals(this)){b=b+(h.$.clientLeft||0);g=g+(h.$.clientTop||0)}for(;f&&!f.equals(h);){b=b-f.$.scrollLeft;g=g-f.$.scrollTop;f=f.getParent()}f=h;h=(k=h.$.offsetParent)?new CKEDITOR.dom.element(k):null}}if(a){h=this.getWindow();f=a.getWindow();if(!h.equals(f)&&h.$.frameElement){a=(new CKEDITOR.dom.element(h.$.frameElement)).getDocumentPosition(a);
b=b+a.x;g=g+a.y}}if(!document.documentElement.getBoundingClientRect&&CKEDITOR.env.gecko&&!e){b=b+(this.$.clientLeft?1:0);g=g+(this.$.clientTop?1:0)}return{x:b,y:g}},scrollIntoView:function(a){var b=this.getParent();if(b){do{(b.$.clientWidth&&b.$.clientWidth<b.$.scrollWidth||b.$.clientHeight&&b.$.clientHeight<b.$.scrollHeight)&&!b.is("body")&&this.scrollIntoParent(b,a,1);if(b.is("html")){var g=b.getWindow();try{var f=g.$.frameElement;f&&(b=new CKEDITOR.dom.element(f))}catch(h){}}}while(b=b.getParent())
}},scrollIntoParent:function(a,b,g){var f,h,e,k;function o(b,d){if(/body|html/.test(a.getName()))a.getWindow().$.scrollBy(b,d);else{a.$.scrollLeft=a.$.scrollLeft+b;a.$.scrollTop=a.$.scrollTop+d}}function p(a,b){var c={x:0,y:0};if(!a.is(n?"body":"html")){var d=a.$.getBoundingClientRect();c.x=d.left;c.y=d.top}d=a.getWindow();if(!d.equals(b)){d=p(CKEDITOR.dom.element.get(d.$.frameElement),b);c.x=c.x+d.x;c.y=c.y+d.y}return c}function q(a,b){return parseInt(a.getComputedStyle("margin-"+b)||0,10)||0}!a&&
(a=this.getWindow());e=a.getDocument();var n=e.$.compatMode=="BackCompat";a instanceof CKEDITOR.dom.window&&(a=n?e.getBody():e.getDocumentElement());e=a.getWindow();h=p(this,e);var l=p(a,e),m=this.$.offsetHeight;f=this.$.offsetWidth;var s=a.$.clientHeight,t=a.$.clientWidth;e=h.x-q(this,"left")-l.x||0;k=h.y-q(this,"top")-l.y||0;f=h.x+f+q(this,"right")-(l.x+t)||0;h=h.y+m+q(this,"bottom")-(l.y+s)||0;if(k<0||h>0)o(0,b===true?k:b===false?h:k<0?k:h);if(g&&(e<0||f>0))o(e<0?e:f,0)},setState:function(a,b,
g){b=b||"cke";switch(a){case CKEDITOR.TRISTATE_ON:this.addClass(b+"_on");this.removeClass(b+"_off");this.removeClass(b+"_disabled");g&&this.setAttribute("aria-pressed",true);g&&this.removeAttribute("aria-disabled");break;case CKEDITOR.TRISTATE_DISABLED:this.addClass(b+"_disabled");this.removeClass(b+"_off");this.removeClass(b+"_on");g&&this.setAttribute("aria-disabled",true);g&&this.removeAttribute("aria-pressed");break;default:this.addClass(b+"_off");this.removeClass(b+"_on");this.removeClass(b+
"_disabled");g&&this.removeAttribute("aria-pressed");g&&this.removeAttribute("aria-disabled")}},getFrameDocument:function(){var a=this.$;try{a.contentWindow.document}catch(b){a.src=a.src}return a&&new CKEDITOR.dom.document(a.contentWindow.document)},copyAttributes:function(a,b){for(var g=this.$.attributes,b=b||{},f=0;f<g.length;f++){var h=g[f],e=h.nodeName.toLowerCase(),k;if(!(e in b))if(e=="checked"&&(k=this.getAttribute(e)))a.setAttribute(e,k);else if(!CKEDITOR.env.ie||this.hasAttribute(e)){k=this.getAttribute(e);
if(k===null)k=h.nodeValue;a.setAttribute(e,k)}}if(this.$.style.cssText!=="")a.$.style.cssText=this.$.style.cssText},renameNode:function(a){if(this.getName()!=a){var b=this.getDocument(),a=new CKEDITOR.dom.element(a,b);this.copyAttributes(a);this.moveChildren(a);this.getParent()&&this.$.parentNode.replaceChild(a.$,this.$);a.$["data-cke-expando"]=this.$["data-cke-expando"];this.$=a.$;delete this.getName}},getChild:function(){function a(b,c){var f=b.childNodes;if(c>=0&&c<f.length)return f[c]}return function(b){var g=
this.$;if(b.slice)for(;b.length>0&&g;)g=a(g,b.shift());else g=a(g,b);return g?new CKEDITOR.dom.node(g):null}}(),getChildCount:function(){return this.$.childNodes.length},disableContextMenu:function(){this.on("contextmenu",function(a){a.data.getTarget().hasClass("cke_enable_context_menu")||a.data.preventDefault()})},getDirection:function(a){return a?this.getComputedStyle("direction")||this.getDirection()||this.getParent()&&this.getParent().getDirection(1)||this.getDocument().$.dir||"ltr":this.getStyle("direction")||
this.getAttribute("dir")},data:function(a,b){a="data-"+a;if(b===void 0)return this.getAttribute(a);b===false?this.removeAttribute(a):this.setAttribute(a,b);return null},getEditor:function(){var a=CKEDITOR.instances,b,g;for(b in a){g=a[b];if(g.element.equals(this)&&g.elementMode!=CKEDITOR.ELEMENT_MODE_APPENDTO)return g}return null},find:function(b){var d=a(this),b=new CKEDITOR.dom.nodeList(this.$.querySelectorAll(e(this,b)));d();return b},findOne:function(b){var d=a(this),b=this.$.querySelector(e(this,
b));d();return b?new CKEDITOR.dom.element(b):null},forEach:function(a,b,g){if(!g&&(!b||this.type==b))var f=a(this);if(f!==false)for(var g=this.getChildren(),h=0;h<g.count();h++){f=g.getItem(h);f.type==CKEDITOR.NODE_ELEMENT?f.forEach(a,b):(!b||f.type==b)&&a(f)}}});var g={width:["border-left-width","border-right-width","padding-left","padding-right"],height:["border-top-width","border-bottom-width","padding-top","padding-bottom"]};CKEDITOR.dom.element.prototype.setSize=function(a,d,g){if(typeof d==
"number"){if(g&&(!CKEDITOR.env.ie||!CKEDITOR.env.quirks))d=d-b.call(this,a);this.setStyle(a,d+"px")}};CKEDITOR.dom.element.prototype.getSize=function(a,d){var g=Math.max(this.$["offset"+CKEDITOR.tools.capitalize(a)],this.$["client"+CKEDITOR.tools.capitalize(a)])||0;d&&(g=g-b.call(this,a));return g}}(),CKEDITOR.dom.documentFragment=function(a){a=a||CKEDITOR.document;this.$=a.type==CKEDITOR.NODE_DOCUMENT?a.$.createDocumentFragment():a},CKEDITOR.tools.extend(CKEDITOR.dom.documentFragment.prototype,CKEDITOR.dom.element.prototype,
...
f=c.startContainer;d=c.endContainer;var g=c.startOffset,k=c.endOffset,h,e=this.guard,j=this.type,i=a?"getPreviousSourceNode":"getNextSourceNode";if(!a&&!this._.guardLTR){var u=d.type==CKEDITOR.NODE_ELEMENT?d:d.getParent(),r=d.type==CKEDITOR.NODE_ELEMENT?d.getChild(k):d.getNext();this._.guardLTR=function(a,b){return(!b||!u.equals(a))&&(!r||!a.equals(r))&&(a.type!=CKEDITOR.NODE_ELEMENT||!b||!a.equals(c.root))}}if(a&&!this._.guardRTL){var y=f.type==CKEDITOR.NODE_ELEMENT?f:f.getParent(),z=f.type==CKEDITOR.NODE_ELEMENT?
g?f.getChild(g-1):null:f.getPrevious();this._.guardRTL=function(a,b){return(!b||!y.equals(a))&&(!z||!a.equals(z))&&(a.type!=CKEDITOR.NODE_ELEMENT||!b||!a.equals(c.root))}}var B=a?this._.guardRTL:this._.guardLTR;h=e?function(a,b){return B(a,b)===false?false:e(a,b)}:B;if(this.current)d=this.current[i](false,j,h);else{if(a)d.type==CKEDITOR.NODE_ELEMENT&&(d=k>0?d.getChild(k-1):h(d,true)===false?null:d.getPreviousSourceNode(true,j,h));else{d=f;if(d.type==CKEDITOR.NODE_ELEMENT&&!(d=d.getChild(g)))d=h(f,
true)===false?null:f.getNextSourceNode(true,j,h)}d&&h(d)===false&&(d=null)}for(;d&&!this._.end;){this.current=d;if(!this.evaluator||this.evaluator(d)!==false){if(!b)return d}else if(b&&this.evaluator)return false;d=d[i](false,j,h)}this.end();return this.current=null}function e(b){for(var d,c=null;d=a.call(this,b);)c=d;return c}function b(a){if(i(a))return false;if(a.type==CKEDITOR.NODE_TEXT)return true;if(a.type==CKEDITOR.NODE_ELEMENT){if(a.is(CKEDITOR.dtd.$inline)||a.is("hr")||a.getAttribute("contenteditable")==
"false")return true;var b;if(b=!CKEDITOR.env.needsBrFiller)if(b=a.is(k))a:{b=0;for(var d=a.getChildCount();b<d;++b)if(!i(a.getChild(b))){b=false;break a}b=true}if(b)return true}return false}CKEDITOR.dom.walker=CKEDITOR.tools.createClass({$:function(a){this.range=a;this._={}},proto:{end:function(){this._.end=1},next:function(){return a.call(this)},previous:function(){return a.call(this,1)},checkForward:function(){return a.call(this,0,1)!==false},checkBackward:function(){return a.call(this,1,1)!==false},
lastForward:function(){return e.call(this)},lastBackward:function(){return e.call(this,1)},reset:function(){delete this.current;this._={}}}});var g={block:1,"list-item":1,table:1,"table-row-group":1,"table-header-group":1,"table-footer-group":1,"table-row":1,"table-column-group":1,"table-column":1,"table-cell":1,"table-caption":1},c={absolute:1,fixed:1};CKEDITOR.dom.element.prototype.isBlockBoundary=function(a){return this.getComputedStyle("float")=="none"&&!(this.getComputedStyle("position")in c)&&
g[this.getComputedStyle("display")]?true:!!(this.is(CKEDITOR.dtd.$block)||a&&this.is(a))};CKEDITOR.dom.walker.blockBoundary=function(a){return function(b){return!(b.type==CKEDITOR.NODE_ELEMENT&&b.isBlockBoundary(a))}};CKEDITOR.dom.walker.listItemBoundary=function(){return this.blockBoundary({br:1})};CKEDITOR.dom.walker.bookmark=function(a,b){function d(a){return a&&a.getName&&a.getName()=="span"&&a.data("cke-bookmark")}return function(c){var f,g;f=c&&c.type!=CKEDITOR.NODE_ELEMENT&&(g=c.getParent())&&
d(g);f=a?f:f||d(c);return!!(b^f)}};CKEDITOR.dom.walker.whitespaces=function(a){return function(b){var d;b&&b.type==CKEDITOR.NODE_TEXT&&(d=!CKEDITOR.tools.trim(b.getText())||CKEDITOR.env.webkit&&b.getText()=="​");return!!(a^d)}};CKEDITOR.dom.walker.invisible=function(a){var b=CKEDITOR.dom.walker.whitespaces(),d=CKEDITOR.env.webkit?1:0;return function(c){if(b(c))c=1;else{c.type==CKEDITOR.NODE_TEXT&&(c=c.getParent());c=c.$.offsetWidth<=d}return!!(a^c)}};CKEDITOR.dom.walker.nodeType=function(a,b){return function(d){return!!(b^
d.type==a)}};CKEDITOR.dom.walker.bogus=function(a){function b(a){return!j(a)&&!f(a)}return function(c){var f=CKEDITOR.env.needsBrFiller?c.is&&c.is("br"):c.getText&&d.test(c.getText());if(f){f=c.getParent();c=c.getNext(b);f=f.isBlockBoundary()&&(!c||c.type==CKEDITOR.NODE_ELEMENT&&c.isBlockBoundary())}return!!(a^f)}};CKEDITOR.dom.walker.temp=function(a){return function(b){b.type!=CKEDITOR.NODE_ELEMENT&&(b=b.getParent());b=b&&b.hasAttribute("data-cke-temp");return!!(a^b)}};var d=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/,
j=CKEDITOR.dom.walker.whitespaces(),f=CKEDITOR.dom.walker.bookmark(),h=CKEDITOR.dom.walker.temp();CKEDITOR.dom.walker.ignored=function(a){return function(b){b=j(b)||f(b)||h(b);return!!(a^b)}};var i=CKEDITOR.dom.walker.ignored(),k=function(a){var b={},c;for(c in a)CKEDITOR.dtd[c]["#"]&&(b[c]=1);return b}(CKEDITOR.dtd.$block);CKEDITOR.dom.walker.editable=function(a){return function(c){return!!(a^b(c))}};CKEDITOR.dom.element.prototype.getBogus=function(){var a=this;do a=a.getPreviousSourceNode();while(f(a)||
j(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.is(CKEDITOR.dtd.$inline)&&!a.is(CKEDITOR.dtd.$empty));return a&&(CKEDITOR.env.needsBrFiller?a.is&&a.is("br"):a.getText&&d.test(a.getText()))?a:false}}(),CKEDITOR.dom.range=function(a){this.endOffset=this.endContainer=this.startOffset=this.startContainer=null;this.collapsed=true;var e=a instanceof CKEDITOR.dom.document;this.document=e?a:a.getDocument();this.root=e?a.getBody():a},function(){function a(){var a=false,b=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.dom.walker.bookmark(true),
f=CKEDITOR.dom.walker.bogus();return function(g){if(c(g)||b(g))return true;if(f(g)&&!a)return a=true;return g.type==CKEDITOR.NODE_TEXT&&(g.hasAscendant("pre")||CKEDITOR.tools.trim(g.getText()).length)||g.type==CKEDITOR.NODE_ELEMENT&&!g.is(d)?false:true}}function e(a){var b=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.dom.walker.bookmark(1);return function(d){return c(d)||b(d)?true:!a&&j(d)||d.type==CKEDITOR.NODE_ELEMENT&&d.is(CKEDITOR.dtd.$removeEmpty)}}function b(a){return function(){var b;return this[a?
"getPreviousNode":"getNextNode"](function(a){!b&&i(a)&&(b=a);return h(a)&&!(j(a)&&a.equals(b))})}}var g=function(a){a.collapsed=a.startContainer&&a.endContainer&&a.startContainer.equals(a.endContainer)&&a.startOffset==a.endOffset},c=function(a,b,c,d){a.optimizeBookmark();var f=a.startContainer,g=a.endContainer,h=a.startOffset,e=a.endOffset,j,i;if(g.type==CKEDITOR.NODE_TEXT)g=g.split(e);else if(g.getChildCount()>0)if(e>=g.getChildCount()){g=g.append(a.document.createText(""));i=true}else g=g.getChild(e);
if(f.type==CKEDITOR.NODE_TEXT){f.split(h);f.equals(g)&&(g=f.getNext())}else if(h)if(h>=f.getChildCount()){f=f.append(a.document.createText(""));j=true}else f=f.getChild(h).getPrevious();else{f=f.append(a.document.createText(""),1);j=true}var h=f.getParents(),e=g.getParents(),w,x,u;for(w=0;w<h.length;w++){x=h[w];u=e[w];if(!x.equals(u))break}for(var r=c,y,z,B,A=w;A<h.length;A++){y=h[A];r&&!y.equals(f)&&(z=r.append(y.clone()));for(y=y.getNext();y;){if(y.equals(e[A])||y.equals(g))break;B=y.getNext();
if(b==2)r.append(y.clone(true));else{y.remove();b==1&&r.append(y)}y=B}r&&(r=z)}r=c;for(c=w;c<e.length;c++){y=e[c];b>0&&!y.equals(g)&&(z=r.append(y.clone()));if(!h[c]||y.$.parentNode!=h[c].$.parentNode)for(y=y.getPrevious();y;){if(y.equals(h[c])||y.equals(f))break;B=y.getPrevious();if(b==2)r.$.insertBefore(y.$.cloneNode(true),r.$.firstChild);else{y.remove();b==1&&r.$.insertBefore(y.$,r.$.firstChild)}y=B}r&&(r=z)}if(b==2){x=a.startContainer;if(x.type==CKEDITOR.NODE_TEXT){x.$.data=x.$.data+x.$.nextSibling.data;
x.$.parentNode.removeChild(x.$.nextSibling)}a=a.endContainer;if(a.type==CKEDITOR.NODE_TEXT&&a.$.nextSibling){a.$.data=a.$.data+a.$.nextSibling.data;a.$.parentNode.removeChild(a.$.nextSibling)}}else{if(x&&u&&(f.$.parentNode!=x.$.parentNode||g.$.parentNode!=u.$.parentNode)){b=u.getIndex();j&&u.$.parentNode==f.$.parentNode&&b--;if(d&&x.type==CKEDITOR.NODE_ELEMENT){d=CKEDITOR.dom.element.createFromHtml('<span data-cke-bookmark="1" style="display:none">&nbsp;</span>',a.document);d.insertAfter(x);x.mergeSiblings(false);
a.moveToBookmark({startNode:d})}else a.setStart(u.getParent(),b)}a.collapse(true)}j&&f.remove();i&&g.$.parentNode&&g.remove()},d={abbr:1,acronym:1,b:1,bdo:1,big:1,cite:1,code:1,del:1,dfn:1,em:1,font:1,i:1,ins:1,label:1,kbd:1,q:1,samp:1,small:1,span:1,strike:1,strong:1,sub:1,sup:1,tt:1,u:1,"var":1},j=CKEDITOR.dom.walker.bogus(),f=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/,h=CKEDITOR.dom.walker.editable(),i=CKEDITOR.dom.walker.ignored(true);CKEDITOR.dom.range.prototype={clone:function(){var a=new CKEDITOR.dom.range(this.root);
...
c(this,0,null,a)},extractContents:function(a){var b=new CKEDITOR.dom.documentFragment(this.document);this.collapsed||c(this,1,b,a);return b},createBookmark:function(a){var b,c,d,f,g=this.collapsed;b=this.document.createElement("span");b.data("cke-bookmark",1);b.setStyle("display","none");b.setHtml("&nbsp;");if(a){d="cke_bm_"+CKEDITOR.tools.getNextNumber();b.setAttribute("id",d+(g?"C":"S"))}if(!g){c=b.clone();c.setHtml("&nbsp;");a&&c.setAttribute("id",d+"E");f=this.clone();f.collapse();f.insertNode(c)}f=
this.clone();f.collapse(true);f.insertNode(b);if(c){this.setStartAfter(b);this.setEndBefore(c)}else this.moveToPosition(b,CKEDITOR.POSITION_AFTER_END);return{startNode:a?d+(g?"C":"S"):b,endNode:a?d+"E":c,serializable:a,collapsed:g}},createBookmark2:function(){function a(c){var d=c.container,f=c.offset,g;g=d;var h=f;g=g.type!=CKEDITOR.NODE_ELEMENT||h===0||h==g.getChildCount()?0:g.getChild(h-1).type==CKEDITOR.NODE_TEXT&&g.getChild(h).type==CKEDITOR.NODE_TEXT;if(g){d=d.getChild(f-1);f=d.getLength()}d.type==
CKEDITOR.NODE_ELEMENT&&f>1&&(f=d.getChild(f-1).getIndex(true)+1);if(d.type==CKEDITOR.NODE_TEXT){g=d;for(h=0;(g=g.getPrevious())&&g.type==CKEDITOR.NODE_TEXT;)h=h+g.getLength();g=h;if(d.getText())f=f+g;else{h=d.getPrevious(b);if(g){f=g;d=h?h.getNext():d.getParent().getFirst()}else{d=d.getParent();f=h?h.getIndex(true)+1:0}}}c.container=d;c.offset=f}var b=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_TEXT,true);return function(b){var c=this.collapsed,d={container:this.startContainer,offset:this.startOffset},
f={container:this.endContainer,offset:this.endOffset};if(b){a(d);c||a(f)}return{start:d.container.getAddress(b),end:c?null:f.container.getAddress(b),startOffset:d.offset,endOffset:f.offset,normalized:b,collapsed:c,is2:true}}}(),moveToBookmark:function(a){if(a.is2){var b=this.document.getByAddress(a.start,a.normalized),c=a.startOffset,d=a.end&&this.document.getByAddress(a.end,a.normalized),a=a.endOffset;this.setStart(b,c);d?this.setEnd(d,a):this.collapse(true)}else{b=(c=a.serializable)?this.document.getById(a.startNode):
...
b.getChildCount();if(f>d)b=b.getChild(d).getPreviousSourceNode(true);else if(f<1)b=b.getPreviousSourceNode();else{for(b=b.$;b.lastChild;)b=b.lastChild;b=new CKEDITOR.dom.node(b)}}a.getPosition(b)&CKEDITOR.POSITION_FOLLOWING&&(a=b);return{startNode:a,endNode:b}},getCommonAncestor:function(a,b){var c=this.startContainer,d=this.endContainer,c=c.equals(d)?a&&c.type==CKEDITOR.NODE_ELEMENT&&this.startOffset==this.endOffset-1?c.getChild(this.startOffset):c:c.getCommonAncestor(d);return b&&!c.is?c.getParent():
...
this.setEndAt(b,CKEDITOR.POSITION_AFTER_END)},trim:function(a,b){var c=this.startContainer,d=this.startOffset,f=this.collapsed;if((!a||f)&&c&&c.type==CKEDITOR.NODE_TEXT){if(d)if(d>=c.getLength()){d=c.getIndex()+1;c=c.getParent()}else{var g=c.split(d),d=c.getIndex()+1,c=c.getParent();if(this.startContainer.equals(this.endContainer))this.setEnd(g,this.endOffset-this.startOffset);else if(c.equals(this.endContainer))this.endOffset=this.endOffset+1}else{d=c.getIndex();c=c.getParent()}this.setStart(c,d);
if(f){this.collapse(true);return}}c=this.endContainer;d=this.endOffset;if(!b&&!f&&c&&c.type==CKEDITOR.NODE_TEXT){if(d){d>=c.getLength()||c.split(d);d=c.getIndex()+1}else d=c.getIndex();c=c.getParent();this.setEnd(c,d)}},enlarge:function(a,b){function c(a){return a&&a.type==CKEDITOR.NODE_ELEMENT&&a.hasAttribute("contenteditable")?null:a}var d=RegExp(/[^\s\ufeff]/);switch(a){case CKEDITOR.ENLARGE_INLINE:var f=1;case CKEDITOR.ENLARGE_ELEMENT:if(this.collapsed)break;var g=this.getCommonAncestor(),h=this.root,
e,j,i,w,x,u=false,r,y;r=this.startContainer;var z=this.startOffset;if(r.type==CKEDITOR.NODE_TEXT){if(z){r=!CKEDITOR.tools.trim(r.substring(0,z)).length&&r;u=!!r}if(r&&!(w=r.getPrevious()))i=r.getParent()}else{z&&(w=r.getChild(z-1)||r.getLast());w||(i=r)}for(i=c(i);i||w;){if(i&&!w){!x&&i.equals(g)&&(x=true);if(f?i.isBlockBoundary():!h.contains(i))break;if(!u||i.getComputedStyle("display")!="inline"){u=false;x?e=i:this.setStartBefore(i)}w=i.getPrevious()}for(;w;){r=false;if(w.type==CKEDITOR.NODE_COMMENT)w=
w.getPrevious();else{if(w.type==CKEDITOR.NODE_TEXT){y=w.getText();d.test(y)&&(w=null);r=/[\s\ufeff]$/.test(y)}else if((w.$.offsetWidth>(CKEDITOR.env.webkit?1:0)||b&&w.is("br"))&&!w.data("cke-bookmark"))if(u&&CKEDITOR.dtd.$removeEmpty[w.getName()]){y=w.getText();if(d.test(y))w=null;else for(var z=w.$.getElementsByTagName("*"),B=0,A;A=z[B++];)if(!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]){w=null;break}w&&(r=!!y.length)}else w=null;r&&(u?x?e=i:i&&this.setStartBefore(i):u=true);if(w){r=w.getPrevious();
if(!i&&!r){i=w;w=null;break}w=r}else i=null}}i&&(i=c(i.getParent()))}r=this.endContainer;z=this.endOffset;i=w=null;x=u=false;var G=function(a,b){var c=new CKEDITOR.dom.range(h);c.setStart(a,b);c.setEndAt(h,CKEDITOR.POSITION_BEFORE_END);var c=new CKEDITOR.dom.walker(c),f;for(c.guard=function(a){return!(a.type==CKEDITOR.NODE_ELEMENT&&a.isBlockBoundary())};f=c.next();){if(f.type!=CKEDITOR.NODE_TEXT)return false;y=f!=a?f.getText():f.substring(b);if(d.test(y))return false}return true};if(r.type==CKEDITOR.NODE_TEXT)if(CKEDITOR.tools.trim(r.substring(z)).length)u=
true;else{u=!r.getLength();if(z==r.getLength()){if(!(w=r.getNext()))i=r.getParent()}else G(r,z)&&(i=r.getParent())}else(w=r.getChild(z))||(i=r);for(;i||w;){if(i&&!w){!x&&i.equals(g)&&(x=true);if(f?i.isBlockBoundary():!h.contains(i))break;if(!u||i.getComputedStyle("display")!="inline"){u=false;x?j=i:i&&this.setEndAfter(i)}w=i.getNext()}for(;w;){r=false;if(w.type==CKEDITOR.NODE_TEXT){y=w.getText();G(w,0)||(w=null);r=/^[\s\ufeff]/.test(y)}else if(w.type==CKEDITOR.NODE_ELEMENT){if((w.$.offsetWidth>0||
b&&w.is("br"))&&!w.data("cke-bookmark"))if(u&&CKEDITOR.dtd.$removeEmpty[w.getName()]){y=w.getText();if(d.test(y))w=null;else{z=w.$.getElementsByTagName("*");for(B=0;A=z[B++];)if(!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]){w=null;break}}w&&(r=!!y.length)}else w=null}else r=1;r&&u&&(x?j=i:this.setEndAfter(i));if(w){r=w.getNext();if(!i&&!r){i=w;w=null;break}w=r}else i=null}i&&(i=c(i.getParent()))}if(e&&j){g=e.contains(j)?j:e;this.setStartBefore(g);this.setEndAfter(g)}break;case CKEDITOR.ENLARGE_BLOCK_CONTENTS:case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:i=
new CKEDITOR.dom.range(this.root);h=this.root;i.setStartAt(h,CKEDITOR.POSITION_AFTER_START);i.setEnd(this.startContainer,this.startOffset);i=new CKEDITOR.dom.walker(i);var D,J,C=CKEDITOR.dom.walker.blockBoundary(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?{br:1}:null),F=null,E=function(a){if(a.type==CKEDITOR.NODE_ELEMENT&&a.getAttribute("contenteditable")=="false")if(F){if(F.equals(a)){F=null;return}}else F=a;else if(F)return;var b=C(a);b||(D=a);return b},f=function(a){var b=E(a);!b&&(a.is&&a.is("br"))&&
(J=a);return b};i.guard=E;i=i.lastBackward();D=D||h;this.setStartAt(D,!D.is("br")&&(!i&&this.checkStartOfBlock()||i&&D.contains(i))?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_AFTER_END);if(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS){i=this.clone();i=new CKEDITOR.dom.walker(i);var I=CKEDITOR.dom.walker.whitespaces(),L=CKEDITOR.dom.walker.bookmark();i.evaluator=function(a){return!I(a)&&!L(a)};if((i=i.previous())&&i.type==CKEDITOR.NODE_ELEMENT&&i.is("br"))break}i=this.clone();i.collapse();i.setEndAt(h,
CKEDITOR.POSITION_BEFORE_END);i=new CKEDITOR.dom.walker(i);i.guard=a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?f:E;D=F=J=null;i=i.lastForward();D=D||h;this.setEndAt(D,!i&&this.checkEndOfBlock()||i&&D.contains(i)?CKEDITOR.POSITION_BEFORE_END:CKEDITOR.POSITION_BEFORE_START);J&&this.setEndAfter(J)}},shrink:function(a,b,c){if(!this.collapsed){var a=a||CKEDITOR.SHRINK_TEXT,d=this.clone(),f=this.startContainer,g=this.endContainer,h=this.startOffset,e=this.endOffset,i=1,j=1;if(f&&f.type==CKEDITOR.NODE_TEXT)if(h)if(h>=
f.getLength())d.setStartAfter(f);else{d.setStartBefore(f);i=0}else d.setStartBefore(f);if(g&&g.type==CKEDITOR.NODE_TEXT)if(e)if(e>=g.getLength())d.setEndAfter(g);else{d.setEndAfter(g);j=0}else d.setEndBefore(g);var d=new CKEDITOR.dom.walker(d),w=CKEDITOR.dom.walker.bookmark();d.evaluator=function(b){return b.type==(a==CKEDITOR.SHRINK_ELEMENT?CKEDITOR.NODE_ELEMENT:CKEDITOR.NODE_TEXT)};var x;d.guard=function(b,d){if(w(b))return true;if(a==CKEDITOR.SHRINK_ELEMENT&&b.type==CKEDITOR.NODE_TEXT||d&&b.equals(x)||
c===false&&b.type==CKEDITOR.NODE_ELEMENT&&b.isBlockBoundary()||b.type==CKEDITOR.NODE_ELEMENT&&b.hasAttribute("contenteditable"))return false;!d&&b.type==CKEDITOR.NODE_ELEMENT&&(x=b);return true};if(i)(f=d[a==CKEDITOR.SHRINK_ELEMENT?"lastForward":"next"]())&&this.setStartAt(f,b?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_BEFORE_START);if(j){d.reset();(d=d[a==CKEDITOR.SHRINK_ELEMENT?"lastBackward":"previous"]())&&this.setEndAt(d,b?CKEDITOR.POSITION_BEFORE_END:CKEDITOR.POSITION_AFTER_END)}return!(!i&&
!j)}},insertNode:function(a){this.optimizeBookmark();this.trim(false,true);var b=this.startContainer,c=b.getChild(this.startOffset);c?a.insertBefore(c):b.append(a);a.getParent()&&a.getParent().equals(this.endContainer)&&this.endOffset++;this.setStartBefore(a)},moveToPosition:function(a,b){this.setStartAt(a,b);this.collapse(true)},moveToRange:function(a){this.setStart(a.startContainer,a.startOffset);this.setEnd(a.endContainer,a.endOffset)},selectNodeContents:function(a){this.setStart(a,0);this.setEnd(a,
...
b){var c=this.createBookmark(),d=this.document.createElement(b);this.collapse(a);this.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS);this.extractContents().appendTo(d);d.trim();d.appendBogus();this.insertNode(d);this.moveToBookmark(c);return d},splitBlock:function(a){var b=new CKEDITOR.dom.elementPath(this.startContainer,this.root),c=new CKEDITOR.dom.elementPath(this.endContainer,this.root),d=b.block,f=c.block,g=null;if(!b.blockLimit.equals(c.blockLimit))return null;if(a!="br"){if(!d){d=this.fixBlock(true,
a);f=(new CKEDITOR.dom.elementPath(this.endContainer,this.root)).block}f||(f=this.fixBlock(false,a))}a=d&&this.checkStartOfBlock();b=f&&this.checkEndOfBlock();this.deleteContents();if(d&&d.equals(f))if(b){g=new CKEDITOR.dom.elementPath(this.startContainer,this.root);this.moveToPosition(f,CKEDITOR.POSITION_AFTER_END);f=null}else if(a){g=new CKEDITOR.dom.elementPath(this.startContainer,this.root);this.moveToPosition(d,CKEDITOR.POSITION_BEFORE_START);d=null}else{f=this.splitElement(d);d.is("ul","ol")||
d.appendBogus()}return{previousBlock:d,nextBlock:f,wasStartOfBlock:a,wasEndOfBlock:b,elementPath:g}},splitElement:function(a){if(!this.collapsed)return null;this.setEndAt(a,CKEDITOR.POSITION_BEFORE_END);var b=this.extractContents(),c=a.clone(false);b.appendTo(c);c.insertAfter(a);this.moveToPosition(a,CKEDITOR.POSITION_AFTER_END);return c},removeEmptyBlocksAtEnd:function(){function a(d){return function(a){return b(a)||(c(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.isEmptyInlineRemoveable())||d.is("table")&&
...
h={dd:1,dt:1,li:1};a.prototype={getNextParagraph:function(a){var e,j,p,q,n,a=a||"p";if(this._.nestedEditable){if(e=this._.nestedEditable.iterator.getNextParagraph(a)){this.activeFilter=this._.nestedEditable.iterator.activeFilter;return e}this.activeFilter=this.filter;if(b(this,a,this._.nestedEditable.container,this._.nestedEditable.remaining)){this.activeFilter=this._.nestedEditable.iterator.activeFilter;return this._.nestedEditable.iterator.getNextParagraph(a)}this._.nestedEditable=null}if(!this.range.root.getDtd()[a])return null;
if(!this._.started){var l=this.range.clone();j=l.startPath();var m=l.endPath(),s=!l.collapsed&&g(l,j.block),t=!l.collapsed&&g(l,m.block,1);l.shrink(CKEDITOR.SHRINK_ELEMENT,true);s&&l.setStartAt(j.block,CKEDITOR.POSITION_BEFORE_END);t&&l.setEndAt(m.block,CKEDITOR.POSITION_AFTER_START);j=l.endContainer.hasAscendant("pre",true)||l.startContainer.hasAscendant("pre",true);l.enlarge(this.forceBrBreak&&!j||!this.enlargeBr?CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:CKEDITOR.ENLARGE_BLOCK_CONTENTS);if(!l.collapsed){j=
new CKEDITOR.dom.walker(l.clone());m=CKEDITOR.dom.walker.bookmark(true,true);j.evaluator=m;this._.nextNode=j.next();j=new CKEDITOR.dom.walker(l.clone());j.evaluator=m;j=j.previous();this._.lastNode=j.getNextSourceNode(true,null,l.root);if(this._.lastNode&&this._.lastNode.type==CKEDITOR.NODE_TEXT&&!CKEDITOR.tools.trim(this._.lastNode.getText())&&this._.lastNode.getParent().isBlockBoundary()){m=this.range.clone();m.moveToPosition(this._.lastNode,CKEDITOR.POSITION_AFTER_END);if(m.checkEndOfBlock()){m=
new CKEDITOR.dom.elementPath(m.endContainer,m.root);this._.lastNode=(m.block||m.blockLimit).getNextSourceNode(true)}}if(!this._.lastNode||!l.root.contains(this._.lastNode)){this._.lastNode=this._.docEndMarker=l.document.createText("");this._.lastNode.insertAfter(j)}l=null}this._.started=1;j=l}m=this._.nextNode;l=this._.lastNode;for(this._.nextNode=null;m;){var s=0,t=m.hasAscendant("pre"),v=m.type!=CKEDITOR.NODE_ELEMENT,w=0;if(v)m.type==CKEDITOR.NODE_TEXT&&c.test(m.getText())&&(v=0);else{var x=m.getName();
if(CKEDITOR.dtd.$block[x]&&m.getAttribute("contenteditable")=="false"){e=m;b(this,a,e);break}else if(m.isBlockBoundary(this.forceBrBreak&&!t&&{br:1})){if(x=="br")v=1;else if(!j&&!m.getChildCount()&&x!="hr"){e=m;p=m.equals(l);break}if(j){j.setEndAt(m,CKEDITOR.POSITION_BEFORE_START);if(x!="br")this._.nextNode=m}s=1}else{if(m.getFirst()){if(!j){j=this.range.clone();j.setStartAt(m,CKEDITOR.POSITION_BEFORE_START)}m=m.getFirst();continue}v=1}}if(v&&!j){j=this.range.clone();j.setStartAt(m,CKEDITOR.POSITION_BEFORE_START)}p=
(!s||v)&&m.equals(l);if(j&&!s)for(;!m.getNext(f)&&!p;){x=m.getParent();if(x.isBlockBoundary(this.forceBrBreak&&!t&&{br:1})){s=1;v=0;p||x.equals(l);j.setEndAt(x,CKEDITOR.POSITION_BEFORE_END);break}m=x;v=1;p=m.equals(l);w=1}v&&j.setEndAt(m,CKEDITOR.POSITION_AFTER_END);m=this._getNextSourceNode(m,w,l);if((p=!m)||s&&j)break}if(!e){if(!j){this._.docEndMarker&&this._.docEndMarker.remove();return this._.nextNode=null}e=new CKEDITOR.dom.elementPath(j.startContainer,j.root);m=e.blockLimit;s={div:1,th:1,td:1};
e=e.block;if(!e&&m&&!this.enforceRealBlocks&&s[m.getName()]&&j.checkStartOfBlock()&&j.checkEndOfBlock()&&!m.equals(j.root))e=m;else if(!e||this.enforceRealBlocks&&e.is(h)){e=this.range.document.createElement(a);j.extractContents().appendTo(e);e.trim();j.insertNode(e);q=n=true}else if(e.getName()!="li"){if(!j.checkStartOfBlock()||!j.checkEndOfBlock()){e=e.clone(false);j.extractContents().appendTo(e);e.trim();n=j.splitBlock();q=!n.wasStartOfBlock;n=!n.wasEndOfBlock;j.insertNode(e)}}else if(!p)this._.nextNode=
e.equals(l)?null:this._getNextSourceNode(j.getBoundaryNodes().endNode,1,l)}if(q)(q=e.getPrevious())&&q.type==CKEDITOR.NODE_ELEMENT&&(q.getName()=="br"?q.remove():q.getLast()&&q.getLast().$.nodeName.toLowerCase()=="br"&&q.getLast().remove());if(n)(q=e.getLast())&&q.type==CKEDITOR.NODE_ELEMENT&&q.getName()=="br"&&(!CKEDITOR.env.needsBrFiller||q.getPrevious(d)||q.getNext(d))&&q.remove();if(!this._.nextNode)this._.nextNode=p||e.equals(l)||!l?null:this._getNextSourceNode(e,1,l);return e},_getNextSourceNode:function(a,
...
/\s+/)||null;e.propertiesOnly=e.propertiesOnly||e.elements===true;var i=/\s*,\s*/,m=void 0;for(m in F){e[m]=j(e[m],i)||null;var n=e,k=E[m],x=j(e[E[m]],i),t=e[m],w=[],l=true,C=void 0;x?l=false:x={};for(C in t)if(C.charAt(0)=="!"){C=C.slice(1);w.push(C);x[C]=true;l=false}for(;C=w.pop();){t[C]=t["!"+C];delete t["!"+C]}n[k]=(l?false:x)||null}e.match=e.match||null;d.push(h);a.push(h)}for(var b=f.elements,f=f.generic,u,c=0,d=a.length;c<d;++c){g=G(a[c]);h=g.classes===true||g.styles===true||g.attributes===
true;e=g;m=k=i=void 0;for(i in F)e[i]=s(e[i]);n=true;for(m in E){i=E[m];k=e[i];x=[];t=void 0;for(t in k)t.indexOf("*")>-1?x.push(RegExp("^"+t.replace(/\*/g,".*")+"$")):x.push(t);k=x;if(k.length){e[i]=k;n=false}}e.nothingRequired=n;e.noProperties=!(e.attributes||e.classes||e.styles);if(g.elements===true||g.elements===null)f[h?"unshift":"push"](g);else{e=g.elements;delete g.elements;for(u in e)if(b[u])b[u][h?"unshift":"push"](g);else b[u]=[g]}}}function e(a,c,d,g){if(!a.match||a.match(c))if(g||f(a,
...
f,g={},h=1,a=D(a);b=a.match(I);){if(c=b[2]){d=o(c,"styles");f=o(c,"attrs");c=o(c,"classes")}else d=f=c=null;g["$"+h++]={elements:b[1],classes:c,styles:d,attributes:f};a=a.slice(b[0].length)}return g}function o(a,b){var c=a.match(L[b]);return c?D(c[1]):null}function p(a){var b=a.styleBackup=a.attributes.style,c=a.classBackup=a.attributes["class"];if(!a.styles)a.styles=CKEDITOR.tools.parseCssText(b||"",1);if(!a.classes)a.classes=c?c.split(/\s+/):[]}function q(a,b,c,d){var f=0,h;if(d.toHtml)b.name=b.name.replace(H,
"$1");if(d.doCallbacks&&a.elementCallbacks){a:for(var j=a.elementCallbacks,i=0,s=j.length,n;i<s;++i)if(n=j[i](b)){h=n;break a}if(h)return h}if(d.doTransform)if(h=a._.transformations[b.name]){p(b);for(j=0;j<h.length;++j)x(a,b,h[j]);l(b)}if(d.doFilter){a:{j=b.name;i=a._;a=i.allowedRules.elements[j];h=i.allowedRules.generic;j=i.disallowedRules.elements[j];i=i.disallowedRules.generic;s=d.skipRequired;n={valid:false,validAttributes:{},validClasses:{},validStyles:{},allAttributes:false,allClasses:false,
allStyles:false,hadInvalidAttribute:false,hadInvalidClass:false,hadInvalidStyle:false};var k,t;if(!a&&!h)a=null;else{p(b);if(j){k=0;for(t=j.length;k<t;++k)if(g(j[k],b,n)===false){a=null;break a}}if(i){k=0;for(t=i.length;k<t;++k)g(i[k],b,n)}if(a){k=0;for(t=a.length;k<t;++k)e(a[k],b,n,s)}if(h){k=0;for(t=h.length;k<t;++k)e(h[k],b,n,s)}a=n}}if(!a){c.push(b);return A}if(!a.valid){c.push(b);return A}t=a.validAttributes;var w=a.validStyles;h=a.validClasses;var j=b.attributes,C=b.styles,i=b.classes,s=b.classBackup,
u=b.styleBackup,o,F,r=[];n=[];var v=/^data-cke-/;k=false;delete j.style;delete j["class"];delete b.classBackup;delete b.styleBackup;if(!a.allAttributes)for(o in j)if(!t[o])if(v.test(o)){if(o!=(F=o.replace(/^data-cke-saved-/,""))&&!t[F]){delete j[o];k=true}}else{delete j[o];k=true}if(!a.allStyles||a.hadInvalidStyle){for(o in C)a.allStyles||w[o]?r.push(o+":"+C[o]):k=true;if(r.length)j.style=r.sort().join("; ")}else if(u)j.style=u;if(!a.allClasses||a.hadInvalidClass){for(o=0;o<i.length;++o)(a.allClasses||
h[i[o]])&&n.push(i[o]);n.length&&(j["class"]=n.sort().join(" "));s&&n.length<s.split(/\s+/).length&&(k=true)}else s&&(j["class"]=s);k&&(f=A);if(!d.skipFinalValidation&&!m(b)){c.push(b);return A}}if(d.toHtml)b.name=b.name.replace(Q,"cke:$1");return f}function n(a){var b=[],c;for(c in a)c.indexOf("*")>-1&&b.push(c.replace(/\*/g,".*"));return b.length?RegExp("^(?:"+b.join("|")+")$"):null}function l(a){var b=a.attributes,c;delete b.style;delete b["class"];if(c=CKEDITOR.tools.writeCssText(a.styles,true))b.style=
c;a.classes.length&&(b["class"]=a.classes.sort().join(" "))}function m(a){switch(a.name){case "a":if(!a.children.length&&!a.attributes.name)return false;break;case "img":if(!a.attributes.src)return false}return true}function s(a){if(!a)return false;if(a===true)return true;var b=n(a);return function(c){return c in a||b&&c.match(b)}}function t(){return new CKEDITOR.htmlParser.element("br")}function v(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.name=="br"||B.$block[a.name])}function w(a,b,c){var d=a.name;
if(B.$empty[d]||!a.children.length)if(d=="hr"&&b=="br")a.replaceWith(t());else{a.parent&&c.push({check:"it",el:a.parent});a.remove()}else if(B.$block[d]||d=="tr")if(b=="br"){if(a.previous&&!v(a.previous)){b=t();b.insertBefore(a)}if(a.next&&!v(a.next)){b=t();b.insertAfter(a)}a.replaceWithChildren()}else{var d=a.children,f;b:{f=B[b];for(var g=0,h=d.length,e;g<h;++g){e=d[g];if(e.type==CKEDITOR.NODE_ELEMENT&&!f[e.name]){f=false;break b}}f=true}if(f){a.name=b;a.attributes={};c.push({check:"parent-down",
...
f[h])return false;return true}function r(a,b){var c,d;if(typeof a=="string")c=a;else if(a instanceof CKEDITOR.style)d=a;else{c=a[0];d=a[1]}return[{element:c,left:d,right:function(a,c){c.transform(a,b)}}]}function y(a){return function(b){return u(b,a)}}function z(a){return function(b,c){c[a](b)}}var B=CKEDITOR.dtd,A=1,G=CKEDITOR.tools.copy,D=CKEDITOR.tools.trim,J="cke-test",C=["","p","br","div"];CKEDITOR.FILTER_SKIP_TREE=2;CKEDITOR.filter=function(a){this.allowedContent=[];this.disallowedContent=[];
...
a.toFeature&&(a=a.toFeature(this.editor));this.allow(a.allowedContent,a.name);this.addTransformations(a.contentTransformations);this.addContentForms(a.contentForms);return a.requiredContent&&(this.customConfig||this.disallowedContent.length)?this.check(a.requiredContent):true},addTransformations:function(a){var b,c;if(!this.disabled&&a){var d=this._.transformations,f;for(f=0;f<a.length;++f){b=a[f];var g=void 0,h=void 0,e=void 0,j=void 0,i=void 0,m=void 0;c=[];for(h=0;h<b.length;++h){e=b[h];if(typeof e==
"string"){e=e.split(/\s*:\s*/);j=e[0];i=null;m=e[1]}else{j=e.check;i=e.left;m=e.right}if(!g){g=e;g=g.element?g.element:j?j.match(/^([a-z0-9]+)/i)[0]:g.left.getDefinition().element}i instanceof CKEDITOR.style&&(i=y(i));c.push({check:j==g?null:j,left:i,right:typeof m=="string"?z(m):m})}b=g;d[b]||(d[b]=[]);d[b].push(c)}}},check:function(a,b,c){if(this.disabled)return true;if(CKEDITOR.tools.isArray(a)){for(var d=a.length;d--;)if(this.check(a[d],b,c))return true;return false}var f,g;if(typeof a=="string"){g=
...
lengthToAttribute:function(a,b,c){c=c||b;if(!(c in a.attributes)){var d=a.styles[b],f=d&&d.match(/^(\d+)(?:\.\d*)?px$/);f?a.attributes[c]=f[1]:d==J&&(a.attributes[c]=J)}delete a.styles[b]},alignmentToStyle:function(a){if(!("float"in a.styles)){var b=a.attributes.align;if(b=="left"||b=="right")a.styles["float"]=b}delete a.attributes.align},alignmentToAttribute:function(a){if(!("align"in a.attributes)){var b=a.styles["float"];if(b=="left"||b=="right")a.attributes.align=b}delete a.styles["float"]},matchesStyle:u,
...
c||(c=CKEDITOR);var f=b.length,h=[],i=[],k=function(a){g&&(j?g.call(c,a):g.call(c,h,i))};if(f===0)k(true);else{var o=function(a,b){(b?h:i).push(a);if(--f<=0){d&&CKEDITOR.document.getDocumentElement().removeStyle("cursor");k(b)}},p=function(b,c){a[b]=1;var d=e[b];delete e[b];for(var f=0;f<d.length;f++)d[f](b,c)},q=function(b){if(a[b])o(b,true);else{var c=e[b]||(e[b]=[]);c.push(o);if(!(c.length>1)){var d=new CKEDITOR.dom.element("script");d.setAttributes({type:"text/javascript",src:b});if(g)if(CKEDITOR.env.ie&&
CKEDITOR.env.version<11)d.$.onreadystatechange=function(){if(d.$.readyState=="loaded"||d.$.readyState=="complete"){d.$.onreadystatechange=null;p(b,true)}};else{d.$.onload=function(){setTimeout(function(){p(b,true)},0)};d.$.onerror=function(){p(b,false)}}d.appendTo(CKEDITOR.document.getHead())}}};d&&CKEDITOR.document.getDocumentElement().setStyle("cursor","wait");for(var n=0;n<f;n++)q(b[n])}},queue:function(){function a(){var b;(b=g[0])&&this.load(b.scriptUrl,b.callback,CKEDITOR,0)}var g=[];return function(c,
...
i=0;i<h.length;i++){var m=h[i];f[m]=this.get(m);g[m]=1}e.call(b,f)},this)}},CKEDITOR.plugins=new CKEDITOR.resourceManager("plugins/","plugin"),CKEDITOR.plugins.load=CKEDITOR.tools.override(CKEDITOR.plugins.load,function(a){var e={};return function(b,g,c){var d={},j=function(b){a.call(this,b,function(a){CKEDITOR.tools.extend(d,a);var b=[],f;for(f in a){var o=a[f],p=o&&o.requires;if(!e[f]){if(o.icons)for(var q=o.icons.split(","),n=q.length;n--;)CKEDITOR.skin.addIcon(q[n],o.path+"icons/"+(CKEDITOR.env.hidpi&&
o.hidpi?"hidpi/":"")+q[n]+".png");e[f]=1}if(p){p.split&&(p=p.split(","));for(o=0;o<p.length;o++)d[p[o]]||b.push(p[o])}}if(b.length)j.call(this,b);else{for(f in d){o=d[f];if(o.onLoad&&!o.onLoad._called){o.onLoad()===false&&delete d[f];o.onLoad._called=1}}g&&g.call(c||window,d)}},this)};j.call(this,b)}}),CKEDITOR.plugins.setLang=function(a,e,b){var g=this.get(a),a=g.langEntries||(g.langEntries={}),g=g.lang||(g.lang=[]);g.split&&(g=g.split(","));CKEDITOR.tools.indexOf(g,e)==-1&&g.push(e);a[e]=b},CKEDITOR.ui=
...
a.config,c=b.plugins,d=b.extraPlugins,f=b.removePlugins;if(d)var g=RegExp("(?:^|,)(?:"+d.replace(/\s*,\s*/g,"|")+")(?=,|$)","g"),c=c.replace(g,""),c=c+(","+d);if(f)var h=RegExp("(?:^|,)(?:"+f.replace(/\s*,\s*/g,"|")+")(?=,|$)","g"),c=c.replace(h,"");CKEDITOR.env.air&&(c=c+",adobeair");CKEDITOR.plugins.load(c.split(","),function(c){var d=[],f=[],g=[];a.plugins=c;for(var e in c){var j=c[e],i=j.lang,m=null,s=j.requires,k;CKEDITOR.tools.isArray(s)&&(s=s.join(","));if(s&&(k=s.match(h)))for(;s=k.pop();)CKEDITOR.tools.setTimeout(function(a,
b){throw Error('Plugin "'+a.replace(",","")+'" cannot be removed from the plugins list, because it\'s required by "'+b+'" plugin.');},0,null,[s,e]);if(i&&!a.lang[e]){i.split&&(i=i.split(","));if(CKEDITOR.tools.indexOf(i,a.langCode)>=0)m=a.langCode;else{m=a.langCode.replace(/-.*/,"");m=m!=a.langCode&&CKEDITOR.tools.indexOf(i,m)>=0?m:CKEDITOR.tools.indexOf(i,"en")>=0?"en":i[0]}if(!j.langEntries||!j.langEntries[m])g.push(CKEDITOR.getUrl(j.path+"lang/"+m+".js"));else{a.lang[e]=j.langEntries[m];m=null}}f.push(m);
...
!a&&o.call(this);this.editable(null);this.filter.destroy();delete this.filter;delete this.activeFilter;this.status="destroyed";this.fire("destroy");this.removeAllListeners();CKEDITOR.remove(this);CKEDITOR.fire("instanceDestroyed",null,this)},elementPath:function(a){if(!a){a=this.getSelection();if(!a)return null;a=a.getStartElement()}return a?new CKEDITOR.dom.elementPath(a,this.editable()):null},createRange:function(){var a=this.editable();return a?new CKEDITOR.dom.range(a):null},execCommand:function(a,
...
function(d,j,f){function h(a){var b;if(m.length>0)for(var c=0;c<m.length;c++){var d=m[c],f=d.name,g=CKEDITOR.dtd[f],h=t.name&&CKEDITOR.dtd[t.name];if((!h||h[f])&&(!a||!g||g[a]||!CKEDITOR.dtd[a])){if(!b){i();b=1}d=d.clone();d.parent=t;t=d;m.splice(c,1);c--}else if(f==t.name){o(t,t.parent,1);c--}}}function i(){for(;s.length;)o(s.shift(),t)}function k(a){if(a._.isBlockLike&&a.name!="pre"&&a.name!="textarea"){var b=a.children.length,c=a.children[b-1],d;if(c&&c.type==CKEDITOR.NODE_TEXT)(d=CKEDITOR.tools.rtrim(c.value))?
c.value=d:a.children.length=b-1}}function o(b,c,d){var c=c||t||l,g=t;if(b.previous===void 0){if(p(c,b)){t=c;n.onTagOpen(f,{});b.returnPoint=c=t}k(b);(!a(b)||b.children.length)&&c.add(b);b.name=="pre"&&(w=false);b.name=="textarea"&&(v=false)}if(b.returnPoint){t=b.returnPoint;delete b.returnPoint}else t=d?c:g}function p(a,b){if((a==l||a.name=="body")&&f&&(!a.name||CKEDITOR.dtd[a.name][f])){var c,d;return(c=b.attributes&&(d=b.attributes["data-cke-real-element-type"])?d:b.name)&&c in CKEDITOR.dtd.$inline&&
!(c in CKEDITOR.dtd.head)&&!b.isOrphan||b.type==CKEDITOR.NODE_TEXT}}function q(a,b){return a in CKEDITOR.dtd.$listItem||a in CKEDITOR.dtd.$tableContent?a==b||a=="dt"&&b=="dd"||a=="dd"&&b=="dt":false}var n=new CKEDITOR.htmlParser,l=j instanceof CKEDITOR.htmlParser.element?j:typeof j=="string"?new CKEDITOR.htmlParser.element(j):new CKEDITOR.htmlParser.fragment,m=[],s=[],t=l,v=l.name=="textarea",w=l.name=="pre";n.onTagOpen=function(c,d,f,j){d=new CKEDITOR.htmlParser.element(c,d);if(d.isUnknown&&f)d.isEmpty=
true;d.isOptionalClose=j;if(a(d))m.push(d);else{if(c=="pre")w=true;else{if(c=="br"&&w){t.add(new CKEDITOR.htmlParser.text("\n"));return}c=="textarea"&&(v=true)}if(c=="br")s.push(d);else{for(;;){j=(f=t.name)?CKEDITOR.dtd[f]||(t._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):g;if(!d.isUnknown&&!t.isUnknown&&!j[c])if(t.isOptionalClose)n.onTagClose(f);else if(c in b&&f in b){f=t.children;(f=f[f.length-1])&&f.name=="li"||o(f=new CKEDITOR.htmlParser.element("li"),t);!d.returnPoint&&(d.returnPoint=t);
t=f}else if(c in CKEDITOR.dtd.$listItem&&!q(c,f))n.onTagOpen(c=="li"?"ul":"dl",{},0,1);else if(f in e&&!q(c,f)){!d.returnPoint&&(d.returnPoint=t);t=t.parent}else{f in CKEDITOR.dtd.$inline&&m.unshift(t);if(t.parent)o(t,t.parent,1);else{d.isOrphan=1;break}}else break}h(c);i();d.parent=t;d.isEmpty?o(d):t=d}}};n.onTagClose=function(a){for(var b=m.length-1;b>=0;b--)if(a==m[b].name){m.splice(b,1);return}for(var c=[],d=[],g=t;g!=l&&g.name!=a;){g._.isBlockLike||d.unshift(g);c.push(g);g=g.returnPoint||g.parent}if(g!=
l){for(b=0;b<c.length;b++){var h=c[b];o(h,h.parent)}t=g;g._.isBlockLike&&i();o(g,g.parent);if(g==t)t=t.parent;m=m.concat(d)}a=="body"&&(f=false)};n.onText=function(a){if((!t._.hasInlineStarted||s.length)&&!w&&!v){a=CKEDITOR.tools.ltrim(a);if(a.length===0)return}var b=t.name,d=b?CKEDITOR.dtd[b]||(t._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):g;if(!v&&!d["#"]&&b in e){n.onTagOpen(c[b]||"");n.onText(a)}else{i();h();!w&&!v&&(a=a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g," "));a=new CKEDITOR.htmlParser.text(a);
if(p(t,a))this.onTagOpen(f,{},0,1);t.add(a)}};n.onCDATA=function(a){t.add(new CKEDITOR.htmlParser.cdata(a))};n.onComment=function(a){i();h();t.add(new CKEDITOR.htmlParser.comment(a))};n.parse(d);for(i();t!=l;)o(t,t.parent,1);k(l);return l};CKEDITOR.htmlParser.fragment.prototype={type:CKEDITOR.NODE_DOCUMENT_FRAGMENT,add:function(a,b){isNaN(b)&&(b=this.children.length);var c=b>0?this.children[b-1]:null;if(c){if(a._.isBlockLike&&c.type==CKEDITOR.NODE_TEXT){c.value=CKEDITOR.tools.rtrim(c.value);if(c.value.length===
...
options:c})},addMany:function(a,g,c){for(var d=[this.findIndex(g),0],e=0,f=a.length;e<f;e++)d.push({value:a[e],priority:g,options:c});this.rules.splice.apply(this.rules,d)},findIndex:function(a){for(var g=this.rules,c=g.length-1;c>=0&&a<g[c].priority;)c--;return c+1},exec:function(a,g){var c=g instanceof CKEDITOR.htmlParser.node||g instanceof CKEDITOR.htmlParser.fragment,d=Array.prototype.slice.call(arguments,1),e=this.rules,f=e.length,h,i,k,o;for(o=0;o<f;o++){if(c){h=g.type;i=g.name}k=e[o];if(!(a.nonEditable&&
...
new CKEDITOR.htmlParser.element("br",{"data-cke-bogus":1})}function e(a,c){return function(f){if(f.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var e=[],j=b(f),m,s;if(j)for(i(j,1)&&e.push(j);j;){if(d(j)&&(m=g(j))&&i(m))if((s=g(m))&&!d(s))e.push(m);else{h(k).insertAfter(m);m.remove()}j=j.previous}for(j=0;j<e.length;j++)e[j].remove();if(e=(typeof c=="function"?c(f):c)!==false)if(!k&&!CKEDITOR.env.needsBrFiller&&f.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT)e=false;else if(!k&&!CKEDITOR.env.needsBrFiller&&(document.documentMode>
7||f.name in CKEDITOR.dtd.tr||f.name in CKEDITOR.dtd.$listItem))e=false;else{e=b(f);e=!e||f.name=="form"&&e.name=="input"}e&&f.add(h(a))}}}function i(a,b){if((!k||CKEDITOR.env.needsBrFiller)&&a.type==CKEDITOR.NODE_ELEMENT&&a.name=="br"&&!a.attributes["data-cke-eol"])return true;var c;if(a.type==CKEDITOR.NODE_TEXT&&(c=a.value.match(m))){if(c.index){(new CKEDITOR.htmlParser.text(a.value.substring(0,c.index))).insertBefore(a);a.value=c[0]}if(!CKEDITOR.env.needsBrFiller&&k&&(!b||a.parent.name in x))return true;
if(!k)if((c=a.previous)&&c.name=="br"||!c||d(c))return true}return false}var s={elements:{}},k=f=="html",x=CKEDITOR.tools.extend({},w),C;for(C in x)"#"in t[C]||delete x[C];for(C in x)s.elements[C]=e(k,a.config.fillEmptyBlocks);s.root=e(k,false);s.elements.br=function(a){return function(b){if(b.parent.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var f=b.attributes;if("data-cke-bogus"in f||"data-cke-eol"in f)delete f["data-cke-bogus"];else{for(f=b.next;f&&c(f);)f=f.next;var e=g(b);!f&&d(b.parent)?j(b.parent,
h(a)):d(f)&&(e&&!d(e))&&h(a).insertBefore(f)}}}}(k);return s}function e(a,b){return a!=CKEDITOR.ENTER_BR&&b!==false?a==CKEDITOR.ENTER_DIV?"div":"p":false}function b(a){for(a=a.children[a.children.length-1];a&&c(a);)a=a.previous;return a}function g(a){for(a=a.previous;a&&c(a);)a=a.previous;return a}function c(a){return a.type==CKEDITOR.NODE_TEXT&&!CKEDITOR.tools.trim(a.value)||a.type==CKEDITOR.NODE_ELEMENT&&a.attributes["data-cke-bookmark"]}function d(a){return a&&(a.type==CKEDITOR.NODE_ELEMENT&&a.name in
...
function(a,b){return A.test(b)&&c.indexOf("data-cke-saved-"+b)==-1?" data-cke-saved-"+a+" data-cke-"+CKEDITOR.rnd+"-"+a:a})+">"})}function k(a,b){return a.replace(b,function(a,b,c){a.indexOf("<textarea")===0&&(a=b+q(c).replace(/</g,"&lt;").replace(/>/g,"&gt;")+"</textarea>");return"<cke:encoded>"+encodeURIComponent(a)+"</cke:encoded>"})}function o(a){return a.replace(J,function(a,b){return decodeURIComponent(b)})}function p(a){return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g,function(a){return"<\!--"+
s+"{C}"+encodeURIComponent(a).replace(/--/g,"%2D%2D")+"--\>"})}function q(a){return a.replace(/<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g,function(a,b){return decodeURIComponent(b)})}function n(a,b){var c=b._.dataStore;return a.replace(/<\!--\{cke_protected\}([\s\S]+?)--\>/g,function(a,b){return decodeURIComponent(b)}).replace(/\{cke_protected_(\d+)\}/g,function(a,b){return c&&c[b]||""})}function l(a,b){for(var c=[],d=b.config.protectedSource,f=b._.dataStore||(b._.dataStore={id:1}),g=/<\!--\{cke_temp(comment)?\}(\d*?)--\>/g,
...
i=1;a.cancel()}}i&&h.select()}function e(a,b){if(a.isFake)return 0;var c=b.block||b.blockLimit,d=c&&c.getLast(g);if(c&&c.isBlockBoundary()&&(!d||!(d.type==CKEDITOR.NODE_ELEMENT&&d.isBlockBoundary()))&&!c.is("pre")&&!c.getBogus())return c}function b(a){var b=a.data.getTarget();if(b.is("input")){b=b.getAttribute("type");(b=="submit"||b=="reset")&&a.data.preventDefault()}}function g(a){return p(a)&&q(a)}function c(a,b){return function(c){var d=CKEDITOR.dom.element.get(c.data.$.toElement||c.data.$.fromElement||
c.data.$.relatedTarget);(!d||!b.equals(d)&&!b.contains(d))&&a.call(this,c)}}function d(a){function b(a){return function(b,d){d&&(b.type==CKEDITOR.NODE_ELEMENT&&b.is(f))&&(c=b);if(!d&&g(b)&&(!a||!k(b)))return false}}var c,d=a.getRanges()[0],a=a.root,f={table:1,ul:1,ol:1,dl:1};if(d.startPath().contains(f)){var h=d.clone();h.collapse(1);h.setStartAt(a,CKEDITOR.POSITION_AFTER_START);a=new CKEDITOR.dom.walker(h);a.guard=b();a.checkBackward();if(c){h=d.clone();h.collapse();h.setEndAt(c,CKEDITOR.POSITION_AFTER_END);
a=new CKEDITOR.dom.walker(h);a.guard=b(true);c=false;a.checkForward();return c}}return null}function j(a,b,c){return a.config.autoParagraph!==false&&a.activeEnterMode!=CKEDITOR.ENTER_BR&&a.editable().equals(c)&&!b||b&&b.getAttribute("contenteditable")=="true"}function f(a){a.editor.focus();a.editor.fire("saveSnapshot")}function h(a){var b=a.editor;b.getSelection().scrollIntoView();setTimeout(function(){b.fire("saveSnapshot")},0)}function i(a,b,c){for(var d=a.getCommonAncestor(b),b=a=c?b:a;(a=a.getParent())&&
...
(this._.attrChanges={});a in this._.attrChanges||(this._.attrChanges[a]=c);this.setAttribute(a,b)}},insertHtml:function(a,b){f(this);n(this,b||"html",a)},insertText:function(a){f(this);var b=this.editor,c=b.getSelection().getStartElement().hasAscendant("pre",true)?CKEDITOR.ENTER_BR:b.activeEnterMode,b=c==CKEDITOR.ENTER_BR,d=CKEDITOR.tools,a=d.htmlEncode(a.replace(/\r\n/g,"\n")),a=a.replace(/\t/g,"&nbsp;&nbsp; &nbsp;"),c=c==CKEDITOR.ENTER_P?"p":"div";if(!b){var g=/\n{2}/g;if(g.test(a))var h="<"+c+
">",e="</"+c+">",a=h+a.replace(g,function(){return e+h})+e}a=a.replace(/\n/g,"<br>");b||(a=a.replace(RegExp("<br>(?=</"+c+">)"),function(a){return d.repeat(a,2)}));a=a.replace(/^ | $/g,"&nbsp;");a=a.replace(/(>|\s) /g,function(a,b){return b+"&nbsp;"}).replace(/ (?=<)/g,"&nbsp;");n(this,"text",a)},insertElement:function(a,b){b?this.insertElementIntoRange(a,b):this.insertElementIntoSelection(a)},insertElementIntoRange:function(a,b){var c=this.editor,d=c.config.enterMode,f=a.getName(),g=CKEDITOR.dtd.$block[f];
if(b.checkReadOnly())return false;b.deleteContents(1);b.startContainer.type==CKEDITOR.NODE_ELEMENT&&b.startContainer.is({tr:1,table:1,tbody:1,thead:1,tfoot:1})&&l(b);var h,e;if(g)for(;(h=b.getCommonAncestor(0,1))&&(e=CKEDITOR.dtd[h.getName()])&&(!e||!e[f]);)if(h.getName()in CKEDITOR.dtd.span)b.splitElement(h);else if(b.checkStartOfBlock()&&b.checkEndOfBlock()){b.setStartBefore(h);b.collapse(true);h.remove()}else b.splitBlock(d==CKEDITOR.ENTER_DIV?"div":"p",c.editable());b.insertNode(a);return true},
...
a.once("contentDom",function(){a.focusManager.focus(this)},this)}this.isInline()&&this.changeAttr("tabindex",a.tabIndex);if(!this.is("textarea")){a.document=this.getDocument();a.window=this.getWindow();var c=a.document;this.changeAttr("spellcheck",!a.config.disableNativeSpellChecker);var f=a.config.contentsLangDirection;this.getDirection(1)!=f&&this.changeAttr("dir",f);var h=CKEDITOR.getCss();if(h){f=c.getHead();if(!f.getCustomData("stylesheet")){h=c.appendStyleText(h);h=new CKEDITOR.dom.element(h.ownerNode||
h.owningElement);f.setCustomData("stylesheet",h);h.data("cke-temp",1)}}f=c.getCustomData("stylesheet_ref")||0;c.setCustomData("stylesheet_ref",f+1);this.setCustomData("cke_includeReadonly",!a.config.disableReadonlyStyling);this.attachListener(this,"click",function(a){var a=a.data,b=(new CKEDITOR.dom.elementPath(a.getTarget(),this)).contains("a");b&&(a.$.button!=2&&b.isReadOnly())&&a.preventDefault()});var e={8:1,46:1};this.attachListener(a,"key",function(b){if(a.readOnly)return true;var c=b.data.domEvent.getKey(),
f;if(c in e){var b=a.getSelection(),h,g=b.getRanges()[0],i=g.startPath(),j,k,s,c=c==8;if(CKEDITOR.env.ie&&CKEDITOR.env.version<11&&(h=b.getSelectedElement())||(h=d(b))){a.fire("saveSnapshot");g.moveToPosition(h,CKEDITOR.POSITION_BEFORE_START);h.remove();g.select();a.fire("saveSnapshot");f=1}else if(g.collapsed)if((j=i.block)&&(s=j[c?"getPrevious":"getNext"](p))&&s.type==CKEDITOR.NODE_ELEMENT&&s.is("table")&&g[c?"checkStartOfBlock":"checkEndOfBlock"]()){a.fire("saveSnapshot");g[c?"checkEndOfBlock":
"checkStartOfBlock"]()&&j.remove();g["moveToElementEdit"+(c?"End":"Start")](s);g.select();a.fire("saveSnapshot");f=1}else if(i.blockLimit&&i.blockLimit.is("td")&&(k=i.blockLimit.getAscendant("table"))&&g.checkBoundaryOfElement(k,c?CKEDITOR.START:CKEDITOR.END)&&(s=k[c?"getPrevious":"getNext"](p))){a.fire("saveSnapshot");g["moveToElementEdit"+(c?"End":"Start")](s);g.checkStartOfBlock()&&g.checkEndOfBlock()?s.remove():g.select();a.fire("saveSnapshot");f=1}else if((k=i.contains(["td","th","caption"]))&&
g.checkBoundaryOfElement(k,c?CKEDITOR.START:CKEDITOR.END))f=1}return!f});a.blockless&&(CKEDITOR.env.ie&&CKEDITOR.env.needsBrFiller)&&this.attachListener(this,"keyup",function(b){if(b.data.getKeystroke()in e&&!this.getFirst(g)){this.appendBogus();b=a.createRange();b.moveToPosition(this,CKEDITOR.POSITION_AFTER_START);b.select()}});this.attachListener(this,"dblclick",function(b){if(a.readOnly)return false;b={element:b.data.getTarget()};a.fire("doubleclick",b)});CKEDITOR.env.ie&&this.attachListener(this,
...
"click",function(a){a.data.getTarget().is("input","select")&&a.data.preventDefault()});this.attachListener(this,"mouseup",function(a){a.data.getTarget().is("input","textarea")&&a.data.preventDefault()})}CKEDITOR.env.webkit&&this.attachListener(a,"key",function(b){b=b.data.domEvent.getKey();if(b in e){var c=b==8,d=a.getSelection().getRanges()[0],b=d.startPath();if(d.collapsed){var f;a:{var h=b.block;if(h)if(d[c?"checkStartOfBlock":"checkEndOfBlock"]())if(!d.moveToClosestEditablePosition(h,!c)||!d.collapsed)f=
false;else{if(d.startContainer.type==CKEDITOR.NODE_ELEMENT){var g=d.startContainer.getChild(d.startOffset-(c?1:0));if(g&&g.type==CKEDITOR.NODE_ELEMENT&&g.is("hr")){a.fire("saveSnapshot");g.remove();f=true;break a}}if((d=d.startPath().block)&&(!d||!d.contains(h))){a.fire("saveSnapshot");var j;(j=(c?d:h).getBogus())&&j.remove();f=a.getSelection();j=f.createBookmarks();(c?h:d).moveChildren(c?d:h,false);b.lastElement.mergeSiblings();i(h,d,!c);f.selectBookmarks(j);f=true}}else f=false;else f=false}if(!f)return}else{c=
d;f=b.block;j=c.endPath().block;if(!f||!j||f.equals(j))b=false;else{a.fire("saveSnapshot");(h=f.getBogus())&&h.remove();c.deleteContents();if(j.getParent()){j.moveChildren(f,false);b.lastElement.mergeSiblings();i(f,j,true)}c=a.getSelection().getRanges()[0];c.collapse(1);c.select();b=true}if(!b)return}a.getSelection().scrollIntoView();a.fire("saveSnapshot");return false}},this,null,100)}}},_:{detach:function(){this.editor.setData(this.editor.getData(),0,1);this.clearListeners();this.restoreAttrs();
...
this._.editable=a?a instanceof CKEDITOR.editable?a:new CKEDITOR.editable(this,a):(b&&b.detach(),null);return b};var k=CKEDITOR.dom.walker.bogus(),o=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,p=CKEDITOR.dom.walker.whitespaces(true),q=CKEDITOR.dom.walker.bookmark(false,true);CKEDITOR.on("instanceLoaded",function(b){var c=b.editor;c.on("insertElement",function(a){a=a.data;if(a.type==CKEDITOR.NODE_ELEMENT&&(a.is("input")||
...
var n=function(){function a(b){return b.type==CKEDITOR.NODE_ELEMENT}function b(c,d){var f,h,g,e,j=[],k=d.range.startContainer;f=d.range.startPath();for(var k=i[k.getName()],n=0,o=c.getChildren(),w=o.count(),x=-1,t=-1,l=0,v=f.contains(i.$list);n<w;++n){f=o.getItem(n);if(a(f)){g=f.getName();if(v&&g in CKEDITOR.dtd.$list)j=j.concat(b(f,d));else{e=!!k[g];if(g=="br"&&f.data("cke-eol")&&(!n||n==w-1)){l=(h=n?j[n-1].node:o.getItem(n+1))&&(!a(h)||!h.is("br"));h=h&&a(h)&&i.$block[h.getName()]}x==-1&&!e&&(x=
n);e||(t=n);j.push({isElement:1,isLineBreak:l,isBlock:f.isBlockBoundary(),hasBlockSibling:h,node:f,name:g,allowed:e});h=l=0}}else j.push({isElement:0,node:f,allowed:1})}if(x>-1)j[x].firstNotAllowed=1;if(t>-1)j[t].lastNotAllowed=1;return j}function c(b,d){var f=[],h=b.getChildren(),g=h.count(),e,j=0,k=i[d],s=!b.is(i.$inline)||b.is("br");for(s&&f.push(" ");j<g;j++){e=h.getItem(j);a(e)&&!e.is(k)?f=f.concat(c(e,d)):f.push(e)}s&&f.push(" ");return f}function d(b){return b&&a(b)&&(b.is(i.$removeEmpty)||
b.is("a")&&!b.isBlockBoundary())}function f(b,c,d,h){var g=b.clone(),e,i;g.setEndAt(c,CKEDITOR.POSITION_BEFORE_END);if((e=(new CKEDITOR.dom.walker(g)).next())&&a(e)&&k[e.getName()]&&(i=e.getPrevious())&&a(i)&&!i.getParent().equals(b.startContainer)&&d.contains(i)&&h.contains(e)&&e.isIdentical(i)){e.moveChildren(i);e.remove();f(b,c,d,h)}}function e(b,c){function d(b,c){if(c.isBlock&&c.isElement&&!c.node.is("br")&&a(b)&&b.is("br")){b.remove();return 1}}var f=c.endContainer.getChild(c.endOffset),h=c.endContainer.getChild(c.endOffset-
1);f&&d(f,b[b.length-1]);if(h&&d(h,b[0])){c.setEnd(c.endContainer,c.endOffset-1);c.collapse()}}var i=CKEDITOR.dtd,k={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,ul:1,ol:1,li:1,pre:1,dl:1,blockquote:1},n={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1},o=CKEDITOR.tools.extend({},i.$inline);delete o.br;return function(k,l,q){var r=k.editor,p=r.getSelection().getRanges()[0],C=false;if(l=="unfiltered_html"){l="html";C=true}if(!p.checkReadOnly()){var F=(new CKEDITOR.dom.elementPath(p.startContainer,p.root)).blockLimit||
p.root,l={type:l,dontFilter:C,editable:k,editor:r,range:p,blockLimit:F,mergeCandidates:[],zombies:[]},r=l.range,C=l.mergeCandidates,E,I,L,H;if(l.type=="text"&&r.shrink(CKEDITOR.SHRINK_ELEMENT,true,false)){E=CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>",r.document);r.insertNode(E);r.setStartAfter(E)}I=new CKEDITOR.dom.elementPath(r.startContainer);l.endPath=L=new CKEDITOR.dom.elementPath(r.endContainer);if(!r.collapsed){var F=L.block||L.blockLimit,Q=r.getCommonAncestor();F&&(!F.equals(Q)&&
!F.contains(Q)&&r.checkEndOfBlock())&&l.zombies.push(F);r.deleteContents()}for(;(H=a(r.startContainer)&&r.startContainer.getChild(r.startOffset-1))&&a(H)&&H.isBlockBoundary()&&I.contains(H);)r.moveToPosition(H,CKEDITOR.POSITION_BEFORE_END);f(r,l.blockLimit,I,L);if(E){r.setEndBefore(E);r.collapse();E.remove()}E=r.startPath();if(F=E.contains(d,false,1)){r.splitElement(F);l.inlineStylesRoot=F;l.inlineStylesPeak=E.lastElement}E=r.createBookmark();(F=E.startNode.getPrevious(g))&&a(F)&&d(F)&&C.push(F);
(F=E.startNode.getNext(g))&&a(F)&&d(F)&&C.push(F);for(F=E.startNode;(F=F.getParent())&&d(F);)C.push(F);r.moveToBookmark(E);if(E=q){E=l.range;if(l.type=="text"&&l.inlineStylesRoot){H=l.inlineStylesPeak;r=H.getDocument().createText("{cke-peak}");for(C=l.inlineStylesRoot.getParent();!H.equals(C);){r=r.appendTo(H.clone());H=H.getParent()}q=r.getOuterHtml().split("{cke-peak}").join(q)}H=l.blockLimit.getName();if(/^\s+|\s+$/.test(q)&&"span"in CKEDITOR.dtd[H])var O='<span data-cke-marker="1">&nbsp;</span>',
q=O+q+O;q=l.editor.dataProcessor.toHtml(q,{context:null,fixForBody:false,dontFilter:l.dontFilter,filter:l.editor.activeFilter,enterMode:l.editor.activeEnterMode});H=E.document.createElement("body");H.setHtml(q);if(O){H.getFirst().remove();H.getLast().remove()}if((O=E.startPath().block)&&!(O.getChildCount()==1&&O.getBogus()))a:{var M;if(H.getChildCount()==1&&a(M=H.getFirst())&&M.is(n)){O=M.getElementsByTag("*");E=0;for(C=O.count();E<C;E++){r=O.getItem(E);if(!r.is(o))break a}M.moveChildren(M.getParent(1));
M.remove()}}l.dataWrapper=H;E=q}if(E){M=l.range;var O=M.document,K,q=l.blockLimit;E=0;var R;H=[];var N,T,C=r=0,P,V;I=M.startContainer;var F=l.endPath.elements[0],W;L=F.getPosition(I);Q=!!F.getCommonAncestor(I)&&L!=CKEDITOR.POSITION_IDENTICAL&&!(L&CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED);I=b(l.dataWrapper,l);for(e(I,M);E<I.length;E++){L=I[E];if(K=L.isLineBreak){K=M;P=q;var S=void 0,Y=void 0;if(L.hasBlockSibling)K=1;else{S=K.startContainer.getAscendant(i.$block,1);if(!S||!S.is({div:1,
...
R.remove();M.moveToPosition(T,CKEDITOR.POSITION_BEFORE_END)}if((K=M.startPath().block)&&!K.equals(N)){if(R=K.getBogus()){R.remove();H.push(K)}N=K}L.firstNotAllowed&&(r=1);if(r&&L.isElement){K=M.startContainer;for(P=null;K&&!i[K.getName()][L.name];){if(K.equals(q)){K=null;break}P=K;K=K.getParent()}if(K){if(P){V=M.splitElement(P);l.zombies.push(V);l.zombies.push(P)}}else{P=q.getName();W=!E;K=E==I.length-1;P=c(L.node,P);for(var S=[],Y=P.length,Z=0,ba=void 0,X=0,aa=-1;Z<Y;Z++){ba=P[Z];if(ba==" "){if(!X&&
(!W||Z)){S.push(new CKEDITOR.dom.text(" "));aa=S.length}X=1}else{S.push(ba);X=0}}K&&aa==S.length&&S.pop();W=S}}if(W){for(;K=W.pop();)M.insertNode(K);W=0}else M.insertNode(L.node);if(L.lastNotAllowed&&E<I.length-1){(V=Q?F:V)&&M.setEndAt(V,CKEDITOR.POSITION_AFTER_START);r=0}M.collapse()}}l.dontMoveCaret=C;l.bogusNeededBlocks=H}R=l.range;var U;V=l.bogusNeededBlocks;for(W=R.createBookmark();N=l.zombies.pop();)if(N.getParent()){T=R.clone();T.moveToElementEditStart(N);T.removeEmptyBlocksAtEnd()}if(V)for(;N=
V.pop();)CKEDITOR.env.needsBrFiller?N.appendBogus():N.append(R.document.createText(" "));for(;N=l.mergeCandidates.pop();)N.mergeSiblings();R.moveToBookmark(W);if(!l.dontMoveCaret){for(N=a(R.startContainer)&&R.startContainer.getChild(R.startOffset-1);N&&a(N)&&!N.is(i.$empty);){if(N.isBlockBoundary())R.moveToPosition(N,CKEDITOR.POSITION_BEFORE_END);else{if(d(N)&&N.getHtml().match(/(\s|&nbsp;)$/g)){U=null;break}U=R.clone();U.moveToPosition(N,CKEDITOR.POSITION_BEFORE_END)}N=N.getLast(g)}U&&R.moveToRange(U)}p.select();
...
d.getFirst().remove()}}}return function(d){var f=d.startContainer,h=f.getAscendant("table",1),g=false;c(h.getElementsByTag("td"));c(h.getElementsByTag("th"));h=d.clone();h.setStart(f,0);h=a(h).lastBackward();if(!h){h=d.clone();h.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);h=a(h).lastForward();g=true}h||(h=f);if(h.is("table")){d.setStartAt(h,CKEDITOR.POSITION_BEFORE_START);d.collapse(true);h.remove()}else{h.is({tbody:1,thead:1,tfoot:1})&&(h=b(h,"tr",g));h.is("tr")&&(h=b(h,h.getParent().is("thead")?"th":
"td",g));(f=h.getBogus())&&f.remove();d.moveToPosition(h,g?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_BEFORE_END)}}}()}(),function(){function a(){var a=this._.fakeSelection,b;if(a){b=this.getSelection(1);if(!b||!b.isHidden()){a.reset();a=0}}if(!a){a=b||this.getSelection(1);if(!a||a.getType()==CKEDITOR.SELECTION_NONE)return}this.fire("selectionCheck",a);b=this.elementPath();if(!b.compare(this._.selectionPreviousPath)){if(CKEDITOR.env.webkit)this._.previousActive=this.document.getActive();this._.selectionPreviousPath=
b;this.fire("selectionChange",{selection:a,path:b})}}function e(){n=true;if(!q){b.call(this);q=CKEDITOR.tools.setTimeout(b,200,this)}}function b(){q=null;if(n){CKEDITOR.tools.setTimeout(a,0,this);n=false}}function g(a){return l(a)||a.type==CKEDITOR.NODE_ELEMENT&&!a.is(CKEDITOR.dtd.$empty)?true:false}function c(a){function b(c,d){return!c||c.type==CKEDITOR.NODE_TEXT?false:a.clone()["moveToElementEdit"+(d?"End":"Start")](c)}if(!(a.root instanceof CKEDITOR.editable))return false;var c=a.startContainer,
...
(CKEDITOR.env.ie?"display:none":"position:fixed;top:0;left:-1000px")+'">&nbsp;</div>',a.document);a.fire("lockSnapshot");a.editable().append(b);var c=a.getSelection(1),d=a.createRange(),f=c.root.on("selectionchange",function(a){a.cancel()},null,null,0);d.setStartAt(b,CKEDITOR.POSITION_AFTER_START);d.setEndAt(b,CKEDITOR.POSITION_BEFORE_END);c.selectRanges([d]);f.removeListener();a.fire("unlockSnapshot");a._.hiddenSelectionContainer=b}function o(a){var b={37:1,39:1,8:1,46:1};return function(c){var d=
c.data.getKeystroke();if(b[d]){var f=a.getSelection().getRanges(),h=f[0];if(f.length==1&&h.collapsed)if((d=h[d<38?"getPreviousEditableNode":"getNextEditableNode"]())&&d.type==CKEDITOR.NODE_ELEMENT&&d.getAttribute("contenteditable")=="false"){a.getSelection().fake(d);c.data.preventDefault();c.cancel()}}}}function p(a){for(var b=0;b<a.length;b++){var c=a[b];c.getCommonAncestor().isReadOnly()&&a.splice(b,1);if(!c.collapsed){if(c.startContainer.isReadOnly())for(var d=c.startContainer,f;d;){if((f=d.type==
CKEDITOR.NODE_ELEMENT)&&d.is("body")||!d.isReadOnly())break;f&&d.getAttribute("contentEditable")=="false"&&c.setStartAfter(d);d=d.getParent()}d=c.startContainer;f=c.endContainer;var h=c.startOffset,g=c.endOffset,e=c.clone();d&&d.type==CKEDITOR.NODE_TEXT&&(h>=d.getLength()?e.setStartAfter(d):e.setStartBefore(d));f&&f.type==CKEDITOR.NODE_TEXT&&(g?e.setEndAfter(f):e.setEndBefore(f));d=new CKEDITOR.dom.walker(e);d.evaluator=function(d){if(d.type==CKEDITOR.NODE_ELEMENT&&d.isReadOnly()){var f=c.clone();
c.setEndBefore(d);c.collapsed&&a.splice(b--,1);if(!(d.getPosition(e.endContainer)&CKEDITOR.POSITION_CONTAINS)){f.setStartAfter(d);f.collapsed||a.splice(b+1,0,f)}return true}return false};d.next()}}return a}var q,n,l=CKEDITOR.dom.walker.invisible(1),m=function(){function a(b){return function(a){var c=a.editor.createRange();c.moveToClosestEditablePosition(a.selected,b)&&a.editor.getSelection().selectRanges([c]);return false}}function b(a){return function(b){var c=b.editor,d=c.createRange(),f;if(!(f=
...
new CKEDITOR.dom.selection(d.getSelection());m.lock()}function c(){h.removeListener("mouseup",c);k.removeListener("mouseup",c);var a=CKEDITOR.document.$.selection,b=a.createRange();a.type!="None"&&b.parentElement().ownerDocument==f.$&&b.select()}var f=d.document,h=CKEDITOR.document,g=d.editable(),i=f.getBody(),k=f.getDocumentElement(),n=g.isInline(),C,m;CKEDITOR.env.gecko&&g.attachListener(g,"focus",function(a){a.removeListener();if(C!==0)if((a=d.getSelection().getNative())&&a.isCollapsed&&a.anchorNode==
g.$){a=d.createRange();a.moveToElementEditStart(g);a.select()}},null,null,-2);g.attachListener(g,CKEDITOR.env.webkit?"DOMFocusIn":"focus",function(){C&&CKEDITOR.env.webkit&&(C=d._.previousActive&&d._.previousActive.equals(f.getActive()));d.unlockSelection(C);C=0},null,null,-1);g.attachListener(g,"mousedown",function(){C=0});if(CKEDITOR.env.ie||n){s?g.attachListener(g,"beforedeactivate",b,null,null,-1):g.attachListener(d,"selectionCheck",b,null,null,-1);g.attachListener(g,CKEDITOR.env.webkit?"DOMFocusOut":
"blur",function(){d.lockSelection(m);C=1},null,null,-1);g.attachListener(g,"mousedown",function(){C=0})}if(CKEDITOR.env.ie&&!n){var l;g.attachListener(g,"mousedown",function(a){if(a.data.$.button==2){a=d.document.getSelection();if(!a||a.getType()==CKEDITOR.SELECTION_NONE)l=d.window.getScrollPosition()}});g.attachListener(g,"mouseup",function(a){if(a.data.$.button==2&&l){d.document.$.documentElement.scrollLeft=l.x;d.document.$.documentElement.scrollTop=l.y}l=null});if(f.$.compatMode!="BackCompat"){if(CKEDITOR.env.ie7Compat||
CKEDITOR.env.ie6Compat)k.on("mousedown",function(a){function b(a){a=a.data.$;if(d){var c=i.$.createTextRange();try{c.moveToPoint(a.clientX,a.clientY)}catch(f){}d.setEndPoint(g.compareEndPoints("StartToStart",c)<0?"EndToEnd":"StartToStart",c);d.select()}}function c(){k.removeListener("mousemove",b);h.removeListener("mouseup",c);k.removeListener("mouseup",c);d.select()}a=a.data;if(a.getTarget().is("html")&&a.$.y<k.$.clientHeight&&a.$.x<k.$.clientWidth){var d=i.$.createTextRange();try{d.moveToPoint(a.$.clientX,
a.$.clientY)}catch(f){}var g=d.duplicate();k.on("mousemove",b);h.on("mouseup",c);k.on("mouseup",c)}});if(CKEDITOR.env.version>7&&CKEDITOR.env.version<11)k.on("mousedown",function(a){if(a.data.getTarget().is("html")){h.on("mouseup",c);k.on("mouseup",c)}})}}g.attachListener(g,"selectionchange",a,d);g.attachListener(g,"keyup",e,d);g.attachListener(g,CKEDITOR.env.webkit?"DOMFocusIn":"focus",function(){d.forceNextSelectionCheck();d.selectionChange(1)});if(n&&(CKEDITOR.env.webkit||CKEDITOR.env.gecko)){var t;
g.attachListener(g,"mousedown",function(){t=1});g.attachListener(f.getDocumentElement(),"mouseup",function(){t&&e.call(d);t=0})}else g.attachListener(CKEDITOR.env.ie?g:f.getDocumentElement(),"mouseup",e,d);CKEDITOR.env.webkit&&g.attachListener(f,"keydown",function(a){switch(a.data.getKey()){case 13:case 33:case 34:case 35:case 36:case 37:case 39:case 8:case 45:case 46:j(g)}},null,null,-1);g.attachListener(g,"keydown",o(d),null,null,-1)});d.on("setData",function(){d.unlockSelection();CKEDITOR.env.webkit&&
...
new CKEDITOR.dom.node(f.commonAncestorContainer);else{try{f=a.createRange()}catch(g){}d=f&&CKEDITOR.dom.element.get(f.item&&f.item(0)||f.parentElement())}if(!d||!(d.type==CKEDITOR.NODE_ELEMENT||d.type==CKEDITOR.NODE_TEXT)||!this.root.equals(d)&&!this.root.contains(d)){this._.cache.type=CKEDITOR.SELECTION_NONE;this._.cache.startElement=null;this._.cache.selectedElement=null;this._.cache.selectedText="";this._.cache.ranges=new CKEDITOR.dom.rangeList}return this};var v={img:1,hr:1,li:1,table:1,tr:1,
...
CKEDITOR.SELECTION_ELEMENT;if(c.createRange().parentElement())b=CKEDITOR.SELECTION_TEXT}catch(f){}return a.type=b}:function(){var a=this._.cache;if(a.type)return a.type;var b=CKEDITOR.SELECTION_TEXT,c=this.getNative();if(!c||!c.rangeCount)b=CKEDITOR.SELECTION_NONE;else if(c.rangeCount==1){var c=c.getRangeAt(0),d=c.startContainer;if(d==c.endContainer&&d.nodeType==1&&c.endOffset-c.startOffset==1&&v[d.childNodes[c.startOffset].nodeName.toLowerCase()])b=CKEDITOR.SELECTION_ELEMENT}return a.type=b},getRanges:function(){var a=
s?function(){function a(b){return(new CKEDITOR.dom.node(b)).getIndex()}var b=function(b,c){b=b.duplicate();b.collapse(c);var d=b.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var f=d.children,g,h,e=b.duplicate(),i=0,j=f.length-1,k=-1,s,n;i<=j;){k=Math.floor((i+j)/2);g=f[k];e.moveToElementText(g);s=e.compareEndPoints("StartToStart",b);if(s>0)j=k-1;else if(s<0)i=k+1;else return{container:d,offset:a(g)}}if(k==-1||k==f.length-1&&s<0){e.moveToElementText(d);e.setEndPoint("StartToStart",
b);e=e.text.replace(/(\r\n|\r)/g,"\n").length;f=d.childNodes;if(!e){g=f[f.length-1];return g.nodeType!=CKEDITOR.NODE_TEXT?{container:d,offset:f.length}:{container:g,offset:g.nodeValue.length}}for(d=f.length;e>0&&d>0;){h=f[--d];if(h.nodeType==CKEDITOR.NODE_TEXT){n=h;e=e-h.nodeValue.length}}return{container:n,offset:-e}}e.collapse(s>0?true:false);e.setEndPoint(s>0?"StartToStart":"EndToStart",b);e=e.text.replace(/(\r\n|\r)/g,"\n").length;if(!e)return{container:d,offset:a(g)+(s>0?0:1)};for(;e>0;)try{h=
g[s>0?"previousSibling":"nextSibling"];if(h.nodeType==CKEDITOR.NODE_TEXT){e=e-h.nodeValue.length;n=h}g=h}catch(m){return{container:d,offset:a(g)}}return{container:n,offset:s>0?-e:n.nodeValue.length+e}};return function(){var a=this.getNative(),c=a&&a.createRange(),d=this.getType();if(!a)return[];if(d==CKEDITOR.SELECTION_TEXT){a=new CKEDITOR.dom.range(this.root);d=b(c,true);a.setStart(new CKEDITOR.dom.node(d.container),d.offset);d=b(c);a.setEnd(new CKEDITOR.dom.node(d.container),d.offset);a.endContainer.getPosition(a.startContainer)&
CKEDITOR.POSITION_PRECEDING&&a.endOffset<=a.startContainer.getIndex()&&a.collapse();return[a]}if(d==CKEDITOR.SELECTION_ELEMENT){for(var d=[],f=0;f<c.length;f++){for(var g=c.item(f),h=g.parentNode,e=0,a=new CKEDITOR.dom.range(this.root);e<h.childNodes.length&&h.childNodes[e]!=g;e++);a.setStart(new CKEDITOR.dom.node(h),e);a.setEnd(new CKEDITOR.dom.node(h),e+1);d.push(a)}return d}return[]}}():function(){var a=[],b,c=this.getNative();if(!c)return a;for(var d=0;d<c.rangeCount;d++){var f=c.getRangeAt(d);
b=new CKEDITOR.dom.range(this.root);b.setStart(new CKEDITOR.dom.node(f.startContainer),f.startOffset);b.setEnd(new CKEDITOR.dom.node(f.endContainer),f.endOffset);a.push(b)}return a};return function(b){var c=this._.cache,d=c.ranges;if(!d)c.ranges=d=new CKEDITOR.dom.rangeList(a.call(this));return!b?d:p(new CKEDITOR.dom.rangeList(d.slice()))}}(),getStartElement:function(){var a=this._.cache;if(a.startElement!==void 0)return a.startElement;var b;switch(this.getType()){case CKEDITOR.SELECTION_ELEMENT:return this.getSelectedElement();
...
new CKEDITOR.dom.range(this.root);b.setStartBefore(a);b.setEndAfter(a);this.selectRanges([b])},selectRanges:function(a){var b=this.root.editor,b=b&&b._.hiddenSelectionContainer;this.reset();if(b)for(var b=this.root,d,f=0;f<a.length;++f){d=a[f];if(d.endContainer.equals(b))d.endOffset=Math.min(d.endOffset,b.getChildCount())}if(a.length)if(this.isLocked){var g=CKEDITOR.document.getActive();this.unlock();this.selectRanges(a);this.lock();g&&!g.equals(this.root)&&g.focus()}else{var h;a:{var e,i;if(a.length==
1&&!(i=a[0]).collapsed&&(h=i.getEnclosedNode())&&h.type==CKEDITOR.NODE_ELEMENT){i=i.clone();i.shrink(CKEDITOR.SHRINK_ELEMENT,true);if((e=i.getEnclosedNode())&&e.type==CKEDITOR.NODE_ELEMENT)h=e;if(h.getAttribute("contenteditable")=="false")break a}h=void 0}if(h)this.fake(h);else{if(s){i=CKEDITOR.dom.walker.whitespaces(true);e=/\ufeff|\u00a0/;b={table:1,tbody:1,tr:1};if(a.length>1){h=a[a.length-1];a[0].setEnd(h.endContainer,h.endOffset)}h=a[0];var a=h.collapsed,k,n,m;if((d=h.getEnclosedNode())&&d.type==
CKEDITOR.NODE_ELEMENT&&d.getName()in v&&(!d.is("a")||!d.getText()))try{m=d.$.createControlRange();m.addElement(d.$);m.select();return}catch(C){}if(h.startContainer.type==CKEDITOR.NODE_ELEMENT&&h.startContainer.getName()in b||h.endContainer.type==CKEDITOR.NODE_ELEMENT&&h.endContainer.getName()in b){h.shrink(CKEDITOR.NODE_ELEMENT,true);a=h.collapsed}m=h.createBookmark();b=m.startNode;if(!a)g=m.endNode;m=h.document.$.body.createTextRange();m.moveToElementText(b.$);m.moveStart("character",1);if(g){e=
h.document.$.body.createTextRange();e.moveToElementText(g.$);m.setEndPoint("EndToEnd",e);m.moveEnd("character",-1)}else{k=b.getNext(i);n=b.hasAscendant("pre");k=!(k&&k.getText&&k.getText().match(e))&&(n||!b.hasPrevious()||b.getPrevious().is&&b.getPrevious().is("br"));n=h.document.createElement("span");n.setHtml("&#65279;");n.insertBefore(b);k&&h.document.createText("﻿").insertBefore(b)}h.setStartBefore(b);b.remove();if(a){if(k){m.moveStart("character",-1);m.select();h.document.$.selection.clear()}else m.select();
h.moveToPosition(n,CKEDITOR.POSITION_BEFORE_START);n.remove()}else{h.setEndBefore(g);g.remove();m.select()}}else{g=this.getNative();if(!g)return;this.removeAllRanges();for(m=0;m<a.length;m++){if(m<a.length-1){k=a[m];n=a[m+1];e=k.clone();e.setStart(k.endContainer,k.endOffset);e.setEnd(n.startContainer,n.startOffset);if(!e.collapsed){e.shrink(CKEDITOR.NODE_ELEMENT,true);h=e.getCommonAncestor();e=e.getEnclosedNode();if(h.isReadOnly()||e&&e.isReadOnly()){n.setStart(k.startContainer,k.startOffset);a.splice(m--,
1);continue}}}h=a[m];n=this.document.$.createRange();if(h.collapsed&&CKEDITOR.env.webkit&&c(h)){k=this.root;j(k,false);e=k.getDocument().createText("​");k.setCustomData("cke-fillingChar",e);h.insertNode(e);if((k=e.getNext())&&!e.getPrevious()&&k.type==CKEDITOR.NODE_ELEMENT&&k.getName()=="br"){j(this.root);h.moveToPosition(k,CKEDITOR.POSITION_BEFORE_START)}else h.moveToPosition(e,CKEDITOR.POSITION_AFTER_END)}n.setStart(h.startContainer.$,h.startOffset);try{n.setEnd(h.endContainer.$,h.endOffset)}catch(o){if(o.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")>=
0){h.collapse(1);n.setEnd(h.endContainer.$,h.endOffset)}else throw o;}g.addRange(n)}}this.reset();this.root.fire("selectionchange")}}},fake:function(a){var b=this.root.editor;this.reset();k(b);var c=this._.cache,d=new CKEDITOR.dom.range(this.root);d.setStartBefore(a);d.setEndAfter(a);c.ranges=new CKEDITOR.dom.rangeList(d);c.selectedElement=c.startElement=a;c.type=CKEDITOR.SELECTION_ELEMENT;c.selectedText=c.nativeSel=null;this.isFake=1;this.rev=t++;b._.fakeSelection=this;this.root.fire("selectionchange")},
...
if(!k){h=true;k=CKEDITOR.dtd.span}b.enlarge(CKEDITOR.ENLARGE_INLINE,1);b.trim();var n=b.createBookmark(),s=n.startNode,o=n.endNode,l=s,t;if(!i){var p=b.getCommonAncestor(),i=a(s,p),p=a(o,p);i&&(l=i.getNextSourceNode(true));p&&(o=p)}for(l.getPosition(o)==CKEDITOR.POSITION_FOLLOWING&&(l=0);l;){i=false;if(l.equals(o)){l=null;i=true}else{var v=l.type==CKEDITOR.NODE_ELEMENT?l.getName():null,p=v&&l.getAttribute("contentEditable")=="false",w=v&&l.getAttribute("data-nostyle");if(v&&l.data("cke-bookmark")){l=
l.getNextSourceNode(true);continue}if(p&&j&&CKEDITOR.dtd.$block[v])for(var x=l,r=g(x),u=void 0,z=r.length,y=0,x=z&&new CKEDITOR.dom.range(x.getDocument());y<z;++y){var u=r[y],A=CKEDITOR.filter.instances[u.data("cke-filter")];if(A?A.check(this):1){x.selectNodeContents(u);e.call(this,x)}}r=v?!k[v]||w?0:p&&!j?0:(l.getPosition(o)|G)==G&&(!f.childRule||f.childRule(l)):1;if(r)if((r=l.getParent())&&((r.getDtd()||CKEDITOR.dtd.span)[d]||h)&&(!f.parentRule||f.parentRule(r))){if(!t&&(!v||!CKEDITOR.dtd.$removeEmpty[v]||
(l.getPosition(o)|G)==G)){t=b.clone();t.setStartBefore(l)}v=l.type;if(v==CKEDITOR.NODE_TEXT||p||v==CKEDITOR.NODE_ELEMENT&&!l.getChildCount()){for(var v=l,aa;(i=!v.getNext(B))&&(aa=v.getParent(),k[aa.getName()])&&(aa.getPosition(s)|D)==D&&(!f.childRule||f.childRule(aa));)v=aa;t.setEndAfter(v)}}else i=true;else i=true;l=l.getNextSourceNode(w||p)}if(i&&t&&!t.collapsed){for(var i=m(this,c),p=i.hasAttributes(),w=t.getCommonAncestor(),v={},r={},u={},z={},U,$,ca;i&&w;){if(w.getName()==d){for(U in f.attributes)if(!z[U]&&
(ca=w.getAttribute($)))i.getAttribute(U)==ca?r[U]=1:z[U]=1;for($ in f.styles)if(!u[$]&&(ca=w.getStyle($)))i.getStyle($)==ca?v[$]=1:u[$]=1}w=w.getParent()}for(U in r)i.removeAttribute(U);for($ in v)i.removeStyle($);p&&!i.hasAttributes()&&(i=null);if(i){t.extractContents().appendTo(i);t.insertNode(i);q.call(this,i);i.mergeSiblings();CKEDITOR.env.ie||i.$.normalize()}else{i=new CKEDITOR.dom.element("span");t.extractContents().appendTo(i);t.insertNode(i);q.call(this,i);i.remove(true)}t=null}}b.moveToBookmark(n);
b.shrink(CKEDITOR.SHRINK_TEXT);b.shrink(CKEDITOR.NODE_ELEMENT,true)}}function b(a){function b(){for(var a=new CKEDITOR.dom.elementPath(d.getParent()),c=new CKEDITOR.dom.elementPath(j.getParent()),f=null,h=null,g=0;g<a.elements.length;g++){var e=a.elements[g];if(e==a.block||e==a.blockLimit)break;k.checkElementRemovable(e,true)&&(f=e)}for(g=0;g<c.elements.length;g++){e=c.elements[g];if(e==c.block||e==c.blockLimit)break;k.checkElementRemovable(e,true)&&(h=e)}h&&j.breakParent(h);f&&d.breakParent(f)}a.enlarge(CKEDITOR.ENLARGE_INLINE,
1);var c=a.createBookmark(),d=c.startNode;if(a.collapsed){for(var f=new CKEDITOR.dom.elementPath(d.getParent(),a.root),h,g=0,e;g<f.elements.length&&(e=f.elements[g]);g++){if(e==f.block||e==f.blockLimit)break;if(this.checkElementRemovable(e)){var i;if(a.collapsed&&(a.checkBoundaryOfElement(e,CKEDITOR.END)||(i=a.checkBoundaryOfElement(e,CKEDITOR.START)))){h=e;h.match=i?"start":"end"}else{e.mergeSiblings();e.is(this.element)?p.call(this,e):n(e,v(this)[e.getName()])}}}if(h){e=d;for(g=0;;g++){i=f.elements[g];
if(i.equals(h))break;else if(i.match)continue;else i=i.clone();i.append(e);e=i}e[h.match=="start"?"insertBefore":"insertAfter"](h)}}else{var j=c.endNode,k=this;b();for(f=d;!f.equals(j);){h=f.getNextSourceNode();if(f.type==CKEDITOR.NODE_ELEMENT&&this.checkElementRemovable(f)){f.getName()==this.element?p.call(this,f):n(f,v(this)[f.getName()]);if(h.type==CKEDITOR.NODE_ELEMENT&&h.contains(d)){b();h=d.getNext()}}f=h}}a.moveToBookmark(c);a.shrink(CKEDITOR.NODE_ELEMENT,true)}function g(a){var b=[];a.forEach(function(a){if(a.getAttribute("contenteditable")==
...
a.removeStyle(f)}}function j(a){var b=a.createBookmark(true),c=a.createIterator();c.enforceRealBlocks=true;if(this._.enterMode)c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,f=a.document,g;d=c.getNextParagraph();)if(!d.isReadOnly()&&(c.activeFilter?c.activeFilter.check(this):1)){g=m(this,f,d);h(d,g)}a.moveToBookmark(b)}function f(a){var b=a.createBookmark(1),c=a.createIterator();c.enforceRealBlocks=true;c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,f;d=c.getNextParagraph();)if(this.checkElementRemovable(d))if(d.is("pre")){(f=
this._.enterMode==CKEDITOR.ENTER_BR?null:a.document.createElement(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))&&d.copyAttributes(f);h(d,f)}else p.call(this,d);a.moveToBookmark(b)}function h(a,b){var c=!b;if(c){b=a.getDocument().createElement("div");a.copyAttributes(b)}var d=b&&b.is("pre"),f=a.is("pre"),h=!d&&f;if(d&&!f){f=b;(h=a.getBogus())&&h.remove();h=a.getHtml();h=k(h,/(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g,"");h=h.replace(/[ \t\r\n]*(<br[^>]*>)[ \t\r\n]*/gi,"$1");h=h.replace(/([ \t\n\r]+|&nbsp;)/g,
" ");h=h.replace(/<br\b[^>]*>/gi,"\n");if(CKEDITOR.env.ie){var g=a.getDocument().createElement("div");g.append(f);f.$.outerHTML="<pre>"+h+"</pre>";f.copyAttributes(g.getFirst());f=g.getFirst().remove()}else f.setHtml(h);b=f}else h?b=o(c?[a.getHtml()]:i(a),b):a.moveChildren(b);b.replace(a);if(d){var c=b,e;if((e=c.getPrevious(A))&&e.type==CKEDITOR.NODE_ELEMENT&&e.is("pre")){d=k(e.getHtml(),/\n$/,"")+"\n\n"+k(c.getHtml(),/^\n/,"");CKEDITOR.env.ie?c.$.outerHTML="<pre>"+d+"</pre>":c.setHtml(d);e.remove()}}else c&&
l(b)}function i(a){var b=[];k(a.getOuterHtml(),/(\S\s*)\n(?:\s|(<span[^>]+data-cke-bookmark.*?\/span>))*\n(?!$)/gi,function(a,b,c){return b+"</pre>"+c+"<pre>"}).replace(/<pre\b.*?>([\s\S]*?)<\/pre>/gi,function(a,c){b.push(c)});return b}function k(a,b,c){var d="",f="",a=a.replace(/(^<span[^>]+data-cke-bookmark.*?\/span>)|(<span[^>]+data-cke-bookmark.*?\/span>$)/gi,function(a,b,c){b&&(d=b);c&&(f=c);return""});return d+a.replace(b,c)+f}function o(a,b){var c;a.length>1&&(c=new CKEDITOR.dom.documentFragment(b.getDocument()));
for(var d=0;d<a.length;d++){var f=a[d],f=f.replace(/(\r\n|\r)/g,"\n"),f=k(f,/^[ \t]*\n/,""),f=k(f,/\n$/,""),f=k(f,/^[ \t]+|[ \t]+$/g,function(a,b){return a.length==1?"&nbsp;":b?" "+CKEDITOR.tools.repeat("&nbsp;",a.length-1):CKEDITOR.tools.repeat("&nbsp;",a.length-1)+" "}),f=f.replace(/\n/g,"<br>"),f=f.replace(/[ \t]{2,}/g,function(a){return CKEDITOR.tools.repeat("&nbsp;",a.length-1)+" "});if(c){var h=b.clone();h.setHtml(f);c.append(h)}else b.setHtml(f)}return c||b}function p(a,b){var c=this._.definition,
d=c.attributes,c=c.styles,f=v(this)[a.getName()],h=CKEDITOR.tools.isEmpty(d)&&CKEDITOR.tools.isEmpty(c),g;for(g in d)if(!((g=="class"||this._.definition.fullMatch)&&a.getAttribute(g)!=w(g,d[g]))&&!(b&&g.slice(0,5)=="data-")){h=a.hasAttribute(g);a.removeAttribute(g)}for(var e in c)if(!(this._.definition.fullMatch&&a.getStyle(e)!=w(e,c[e],true))){h=h||!!a.getStyle(e);a.removeStyle(e)}n(a,f,u[a.getName()]);h&&(this._.definition.alwaysRemoveElement?l(a,1):!CKEDITOR.dtd.$block[a.getName()]||this._.enterMode==
CKEDITOR.ENTER_BR&&!a.hasAttributes()?l(a):a.renameNode(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))}function q(a){for(var b=v(this),c=a.getElementsByTag(this.element),d,f=c.count();--f>=0;){d=c.getItem(f);d.isReadOnly()||p.call(this,d,true)}for(var h in b)if(h!=this.element){c=a.getElementsByTag(h);for(f=c.count()-1;f>=0;f--){d=c.getItem(f);d.isReadOnly()||n(d,b[h])}}}function n(a,b,c){if(b=b&&b.attributes)for(var d=0;d<b.length;d++){var f=b[d][0],h;if(h=a.getAttribute(f)){var g=b[d][1];(g===null||
g.test&&g.test(h)||typeof g=="string"&&h==g)&&a.removeAttribute(f)}}c||l(a)}function l(a,b){if(!a.hasAttributes()||b)if(CKEDITOR.dtd.$block[a.getName()]){var c=a.getPrevious(A),d=a.getNext(A);c&&(c.type==CKEDITOR.NODE_TEXT||!c.isBlockBoundary({br:1}))&&a.append("br",1);d&&(d.type==CKEDITOR.NODE_TEXT||!d.isBlockBoundary({br:1}))&&a.append("br");a.remove(true)}else{c=a.getFirst();d=a.getLast();a.remove(true);if(c){c.type==CKEDITOR.NODE_ELEMENT&&c.mergeSiblings();d&&(!c.equals(d)&&d.type==CKEDITOR.NODE_ELEMENT)&&
d.mergeSiblings()}}}function m(a,b,c){var d;d=a.element;d=="*"&&(d="span");d=new CKEDITOR.dom.element(d,b);c&&c.copyAttributes(d);d=s(d,a);b.getCustomData("doc_processing_style")&&d.hasAttribute("id")?d.removeAttribute("id"):b.setCustomData("doc_processing_style",1);return d}function s(a,b){var c=b._.definition,d=c.attributes,c=CKEDITOR.style.getStyleText(c);if(d)for(var f in d)a.setAttribute(f,d[f]);c&&a.setAttribute("style",c);return a}function t(a,b){for(var c in a)a[c]=a[c].replace(z,function(a,
c){return b[c]})}function v(a){if(a._.overrides)return a._.overrides;var b=a._.overrides={},c=a._.definition.overrides;if(c){CKEDITOR.tools.isArray(c)||(c=[c]);for(var d=0;d<c.length;d++){var f=c[d],h,g;if(typeof f=="string")h=f.toLowerCase();else{h=f.element?f.element.toLowerCase():a.element;g=f.attributes}f=b[h]||(b[h]={});if(g){var f=f.attributes=f.attributes||[],e;for(e in g)f.push([e.toLowerCase(),g[e]])}}}return b}function w(a,b,c){var d=new CKEDITOR.dom.element("span");d[c?"setStyle":"setAttribute"](a,
b);return d[c?"getStyle":"getAttribute"](a)}function x(a,b,c){for(var d=a.document,f=a.getRanges(),b=b?this.removeFromRange:this.applyToRange,h,g=f.createIterator();h=g.getNextRange();)b.call(this,h,c);a.selectRanges(f);d.removeCustomData("doc_processing_style")}var u={address:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,p:1,pre:1,section:1,header:1,footer:1,nav:1,article:1,aside:1,figure:1,dialog:1,hgroup:1,time:1,meter:1,menu:1,command:1,keygen:1,output:1,progress:1,details:1,datagrid:1,datalist:1},r=
...
CKEDITOR.STYLE_OBJECT){var h=f.getName();if(!(typeof this.element=="string"?h==this.element:h in this.element))continue}if(this.checkElementRemovable(f,true,b))return true}}}return false},checkApplicable:function(a,b,c){b&&b instanceof CKEDITOR.filter&&(c=b);if(c&&!c.check(this))return false;switch(this.type){case CKEDITOR.STYLE_OBJECT:return!!a.contains(this.element);case CKEDITOR.STYLE_BLOCK:return!!a.blockLimit.getDtd()[this.element]}return true},checkElementMatch:function(a,b){var c=this._.definition;
if(!a||!c.ignoreReadonly&&a.isReadOnly())return false;var d=a.getName();if(typeof this.element=="string"?d==this.element:d in this.element){if(!b&&!a.hasAttributes())return true;if(d=c._AC)c=d;else{var d={},f=0,h=c.attributes;if(h)for(var g in h){f++;d[g]=h[g]}if(g=CKEDITOR.style.getStyleText(c)){d.style||f++;d.style=g}d._length=f;c=c._AC=d}if(c._length){for(var e in c)if(e!="_length"){f=a.getAttribute(e)||"";if(e=="style")a:{d=c[e];typeof d=="string"&&(d=CKEDITOR.tools.parseCssText(d));typeof f==
"string"&&(f=CKEDITOR.tools.parseCssText(f,true));g=void 0;for(g in d)if(!(g in f&&(f[g]==d[g]||d[g]=="inherit"||f[g]=="inherit"))){d=false;break a}d=true}else d=c[e]==f;if(d){if(!b)return true}else if(b)return false}if(b)return true}else return true}return false},checkElementRemovable:function(a,b,c){if(this.checkElementMatch(a,b,c))return true;if(b=v(this)[a.getName()]){var d;if(!(b=b.attributes))return true;for(c=0;c<b.length;c++){d=b[c][0];if(d=a.getAttribute(d)){var f=b[c][1];if(f===null)return true;
if(typeof f=="string"){if(d==f)return true}else if(f.test(d))return true}}}return false},buildPreview:function(a){var b=this._.definition,c=[],d=b.element;d=="bdo"&&(d="span");var c=["<",d],f=b.attributes;if(f)for(var h in f)c.push(" ",h,'="',f[h],'"');(f=CKEDITOR.style.getStyleText(b))&&c.push(' style="',f,'"');c.push(">",a||b.name,"</",d,">");return c.join("")},getDefinition:function(){return this._.definition}};CKEDITOR.style.getStyleText=function(a){var b=a._ST;if(b)return b;var b=a.styles,c=
a.attributes&&a.attributes.style||"",d="";c.length&&(c=c.replace(y,";"));for(var f in b){var h=b[f],g=(f+":"+h).replace(y,";");h=="inherit"?d=d+g:c=c+g}c.length&&(c=CKEDITOR.tools.normalizeCssText(c,true));return a._ST=c+d};CKEDITOR.style.customHandlers={};CKEDITOR.style.addCustomHandler=function(a){var b=function(a){this._={definition:a};this.setup&&this.setup(a)};b.prototype=CKEDITOR.tools.extend(CKEDITOR.tools.prototypedCopy(CKEDITOR.style.prototype),{assignedTo:CKEDITOR.STYLE_OBJECT},a,true);
...
if(!j){i=h.getName();h.getAttribute("contenteditable")=="true"?j=h:!d&&e[i]&&(d=h);if(a[i]){var k;if(k=!d){if(i=i=="div"){a:{i=h.getChildren();k=0;for(var o=i.count();k<o;k++){var p=i.getItem(k);if(p.type==CKEDITOR.NODE_ELEMENT&&CKEDITOR.dtd.$block[p.getName()]){i=true;break a}}i=false}i=!i}k=i}k?d=h:j=h}}}while(h=h.getParent());j||(j=c);this.block=d;this.blockLimit=j;this.root=c;this.elements=f}}(),CKEDITOR.dom.elementPath.prototype={compare:function(a){var e=this.elements,a=a&&a.elements;if(!a||
...
0,h;f<c.length;f++){h=c[f];if(d.ie&&(h.replace(/^ie/,"")==d.version||d.quirks&&h=="iequirks"))h="ie";if(d[h]){b=b+("_"+c[f]);break}}return CKEDITOR.getUrl(a()+b+".css")}function b(a,b){if(!d[a]){CKEDITOR.document.appendStyleSheet(e(a));d[a]=1}b&&b()}function g(a){var b=a.getById(j);if(!b){b=a.getHead().append("style");b.setAttribute("id",j);b.setAttribute("type","text/css")}return b}function c(a,b,c){var d,f,h;if(CKEDITOR.env.webkit){b=b.split("}").slice(0,-1);for(f=0;f<b.length;f++)b[f]=b[f].split("{")}for(var g=
0;g<a.length;g++)if(CKEDITOR.env.webkit)for(f=0;f<b.length;f++){h=b[f][1];for(d=0;d<c.length;d++)h=h.replace(c[d][0],c[d][1]);a[g].$.sheet.addRule(b[f][0],h)}else{h=b;for(d=0;d<c.length;d++)h=h.replace(c[d][0],c[d][1]);CKEDITOR.env.ie&&CKEDITOR.env.version<11?a[g].$.styleSheet.cssText=a[g].$.styleSheet.cssText+h:a[g].$.innerHTML=a[g].$.innerHTML+h}}var d={};CKEDITOR.skin={path:a,loadPart:function(c,d){CKEDITOR.skin.name!=CKEDITOR.skinName.split(",")[0]?CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(a()+
"skin.js"),function(){b(c,d)}):b(c,d)},getPath:function(a){return CKEDITOR.getUrl(e(a))},icons:{},addIcon:function(a,b,c,d){a=a.toLowerCase();this.icons[a]||(this.icons[a]={path:b,offset:c||0,bgsize:d||"16px"})},getIconStyle:function(a,b,c,d,f){var h;if(a){a=a.toLowerCase();b&&(h=this.icons[a+"-rtl"]);h||(h=this.icons[a])}a=c||h&&h.path||"";d=d||h&&h.offset;f=f||h&&h.bgsize||"16px";return a&&"background-image:url("+CKEDITOR.getUrl(a)+");background-position:0 "+d+"px;background-size:"+f+";"}};CKEDITOR.tools.extend(CKEDITOR.editor.prototype,
{getUiColor:function(){return this.uiColor},setUiColor:function(a){var b=g(CKEDITOR.document);return(this.setUiColor=function(a){var d=CKEDITOR.skin.chameleon,g=[[h,a]];this.uiColor=a;c([b],d(this,"editor"),g);c(f,d(this,"panel"),g)}).call(this,a)}});var j="cke_ui_color",f=[],h=/\$color/g;CKEDITOR.on("instanceLoaded",function(a){if(!CKEDITOR.env.ie||!CKEDITOR.env.quirks){var b=a.editor,a=function(a){a=(a.data[0]||a.data).element.getElementsByTag("iframe").getItem(0).getFrameDocument();if(!a.getById("cke_ui_color")){a=
...
c.includeLabel=true;CKEDITOR.ui.dialog.labeledElement.call(this,b,c,d,function(){for(var a=[],d=[],i=(c.id?c.id:CKEDITOR.tools.getNextId())+"_radio",l=0;l<c.items.length;l++){var m=c.items[l],s=m[2]!==void 0?m[2]:m[0],t=m[1]!==void 0?m[1]:m[0],v=CKEDITOR.tools.getNextId()+"_radio_input",w=v+"_label",v=CKEDITOR.tools.extend({},c,{id:v,title:null,type:null},true),s=CKEDITOR.tools.extend({},v,{title:s},true),x={type:"radio","class":"cke_dialog_ui_radio_input",name:i,value:t,"aria-labelledby":w},u=[];
if(e._["default"]==t)x.checked="checked";j(v);j(s);if(typeof v.inputStyle!="undefined")v.style=v.inputStyle;v.keyboardFocusable=true;g.push(new CKEDITOR.ui.dialog.uiElement(b,v,u,"input",null,x));u.push(" ");new CKEDITOR.ui.dialog.uiElement(b,s,u,"label",null,{id:w,"for":x.id},m[0]);a.push(u.join(""))}new CKEDITOR.ui.dialog.hbox(b,g,a,d);return d.join("")});this._.children=g}},button:function(b,c,d){if(arguments.length){typeof c=="function"&&(c=c(b.getParentEditor()));a.call(this,c,{disabled:c.disabled||
...
"aria-labelledby":this._.labelId};d.push('<div class="cke_dialog_ui_input_',c.type,'" role="presentation"');c.width&&d.push('style="width:'+c.width+'" ');d.push(">");if(c.size!=void 0)i.size=c.size;if(c.multiple!=void 0)i.multiple=c.multiple;j(a);for(var l=0,m;l<c.items.length&&(m=c.items[l]);l++)e.push('<option value="',CKEDITOR.tools.htmlEncode(m[1]!==void 0?m[1]:m[0]).replace(/"/g,"&quot;"),'" /> ',CKEDITOR.tools.htmlEncode(m[0]));if(typeof a.inputStyle!="undefined")a.style=a.inputStyle;g.select=
...
n=g.html;n.charAt(0)!="<"&&(n="<span>"+n+"</span>");var l=g.focus;if(l){var m=this.focus;this.focus=function(){(typeof l=="function"?l:m).call(this);this.fire("focus")};if(g.isFocusable)this.isFocusable=this.isFocusable;this.keyboardFocusable=true}CKEDITOR.ui.dialog.uiElement.call(this,d,g,j,"span",null,null,"");j=j.join("").match(a);n=n.match(b)||["","",""];if(c.test(n[1])){n[1]=n[1].slice(0,-1);n[2]="/"+n[2]}e.push([n[1]," ",j[1]||"",n[2]].join(""))}}}(),fieldset:function(a,b,c,d,g){var e=g.label;
...
c[1].toLowerCase(),a[g]);return this},reset:function(){function a(){c.$.open();var f="";d.size&&(f=d.size-(CKEDITOR.env.ie?7:0));var s=b.frameId+"_input";c.$.write(['<html dir="'+n+'" lang="'+l+'"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">','<form enctype="multipart/form-data" method="POST" dir="'+n+'" lang="'+l+'" action="',CKEDITOR.tools.htmlEncode(d.action),'"><label id="',b.labelId,'" for="',s,'" style="display:none">',CKEDITOR.tools.htmlEncode(d.label),
...
{32:1,13:1}&&this.fire("click")});b.on("focus",function(){this.fire("mouseover")});b.on("blur",function(){this.fire("mouseout")})}function f(a){function b(){a.layout()}var c=CKEDITOR.document.getWindow();c.on("resize",b);a.on("hide",function(){c.removeListener("resize",b)})}function h(a,b){this._={dialog:a};CKEDITOR.tools.extend(this,b)}function i(a){function b(c){var j=a.getSize(),i=CKEDITOR.document.getWindow().getViewPaneSize(),k=c.data.$.screenX,s=c.data.$.screenY,m=k-d.x,n=s-d.y;d={x:k,y:s};
f.x=f.x+m;f.y=f.y+n;a.move(f.x+h[3]<e?-h[3]:f.x-h[1]>i.width-j.width-e?i.width-j.width+(g.lang.dir=="rtl"?0:h[1]):f.x,f.y+h[0]<e?-h[0]:f.y-h[2]>i.height-j.height-e?i.height-j.height+h[2]:f.y,1);c.data.preventDefault()}function c(){CKEDITOR.document.removeListener("mousemove",b);CKEDITOR.document.removeListener("mouseup",c);if(CKEDITOR.env.ie6Compat){var a=r.getChild(0).getFrameDocument();a.removeListener("mousemove",b);a.removeListener("mouseup",c)}}var d=null,f=null;a.getElement().getFirst();var g=
a.getParentEditor(),e=g.config.dialog_magnetDistance,h=CKEDITOR.skin.margins||[0,0,0,0];typeof e=="undefined"&&(e=20);a.parts.title.on("mousedown",function(g){d={x:g.data.$.screenX,y:g.data.$.screenY};CKEDITOR.document.on("mousemove",b);CKEDITOR.document.on("mouseup",c);f=a.getPosition();if(CKEDITOR.env.ie6Compat){var e=r.getChild(0).getFrameDocument();e.on("mousemove",b);e.on("mouseup",c)}g.data.preventDefault()},a)}function k(a){var b,c;function d(f){var m=h.lang.dir=="rtl",n=s.width,l=s.height,
t=n+(f.data.$.screenX-b)*(m?-1:1)*(a._.moved?1:2),o=l+(f.data.$.screenY-c)*(a._.moved?1:2),v=a._.element.getFirst(),v=m&&v.getComputedStyle("right"),q=a.getPosition();q.y+o>k.height&&(o=k.height-q.y);if((m?v:q.x)+t>k.width)t=k.width-(m?v:q.x);if(e==CKEDITOR.DIALOG_RESIZE_WIDTH||e==CKEDITOR.DIALOG_RESIZE_BOTH)n=Math.max(g.minWidth||0,t-j);if(e==CKEDITOR.DIALOG_RESIZE_HEIGHT||e==CKEDITOR.DIALOG_RESIZE_BOTH)l=Math.max(g.minHeight||0,o-i);a.resize(n,l);a._.moved||a.layout();f.data.preventDefault()}function f(){CKEDITOR.document.removeListener("mouseup",
f);CKEDITOR.document.removeListener("mousemove",d);if(m){m.remove();m=null}if(CKEDITOR.env.ie6Compat){var a=r.getChild(0).getFrameDocument();a.removeListener("mouseup",f);a.removeListener("mousemove",d)}}var g=a.definition,e=g.resizable;if(e!=CKEDITOR.DIALOG_RESIZE_NONE){var h=a.getParentEditor(),j,i,k,s,m,n=CKEDITOR.tools.addFunction(function(g){s=a.getSize();var e=a.parts.contents;if(e.$.getElementsByTagName("iframe").length){m=CKEDITOR.dom.element.createFromHtml('<div class="cke_dialog_resize_cover" style="height: 100%; position: absolute; width: 100%;"></div>');
e.append(m)}i=s.height-a.parts.contents.getSize("height",!(CKEDITOR.env.gecko||CKEDITOR.env.ie&&CKEDITOR.env.quirks));j=s.width-a.parts.contents.getSize("width",1);b=g.screenX;c=g.screenY;k=CKEDITOR.document.getWindow().getViewPaneSize();CKEDITOR.document.on("mousemove",d);CKEDITOR.document.on("mouseup",f);if(CKEDITOR.env.ie6Compat){e=r.getChild(0).getFrameDocument();e.on("mousemove",d);e.on("mouseup",f)}g.preventDefault&&g.preventDefault()});a.on("load",function(){var b="";e==CKEDITOR.DIALOG_RESIZE_WIDTH?
b=" cke_resizer_horizontal":e==CKEDITOR.DIALOG_RESIZE_HEIGHT&&(b=" cke_resizer_vertical");b=CKEDITOR.dom.element.createFromHtml('<div class="cke_resizer'+b+" cke_resizer_"+h.lang.dir+'" title="'+CKEDITOR.tools.htmlEncode(h.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+n+', event )">'+(h.lang.dir=="ltr"?"◢":"◣")+"</div>");a.parts.footer.append(b,1)});h.on("destroy",function(){CKEDITOR.tools.removeFunction(n)})}}function o(a){a.data.preventDefault(1)}function p(a){var b=CKEDITOR.document.getWindow(),
c=a.config,d=c.dialog_backgroundCoverColor||"white",f=c.dialog_backgroundCoverOpacity,g=c.baseFloatZIndex,c=CKEDITOR.tools.genKey(d,f,g),e=u[c];if(e)e.show();else{g=['<div tabIndex="-1" style="position: ',CKEDITOR.env.ie6Compat?"absolute":"fixed","; z-index: ",g,"; top: 0px; left: 0px; ",!CKEDITOR.env.ie6Compat?"background-color: "+d:"",'" class="cke_dialog_background_cover">'];if(CKEDITOR.env.ie6Compat){d="<html><body style=\\'background-color:"+d+";\\'></body></html>";g.push('<iframe hidefocus="true" frameborder="0" id="cke_dialog_background_iframe" src="javascript:');
g.push("void((function(){"+encodeURIComponent("document.open();("+CKEDITOR.tools.fixDomain+")();document.write( '"+d+"' );document.close();")+"})())");g.push('" style="position:absolute;left:0;top:0;width:100%;height: 100%;filter: progid:DXImageTransform.Microsoft.Alpha(opacity=0)"></iframe>')}g.push("</div>");e=CKEDITOR.dom.element.createFromHtml(g.join(""));e.setOpacity(f!=void 0?f:0.5);e.on("keydown",o);e.on("keypress",o);e.on("keyup",o);e.appendTo(CKEDITOR.document.getBody());u[c]=e}a.focusManager.add(e);
...
window.onscroll||function(){};window.onscroll=j},0);h()}}function q(a){if(r){a.focusManager.remove(r);a=CKEDITOR.document.getWindow();r.hide();a.removeListener("resize",x);CKEDITOR.env.ie6Compat&&a.$.setTimeout(function(){window.onscroll=window.onscroll&&window.onscroll.prevScrollHandler||null},0);x=null}}var n=CKEDITOR.tools.cssLength,l='<div class="cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir="{langDir}" lang="{langCode}" role="dialog" aria-labelledby="cke_dialog_title_{id}"><table class="cke_dialog '+
...
CKEDITOR.dialog=function(b,f){function h(){var a=u._.focusList;a.sort(function(a,b){return a.tabIndex!=b.tabIndex?b.tabIndex-a.tabIndex:a.focusIndex-b.focusIndex});for(var b=a.length,c=0;c<b;c++)a[c].focusIndex=c}function j(a){var b=u._.focusList,a=a||0;if(!(b.length<1)){var c=u._.currentFocusIndex;try{b[c].getInputElement().$.blur()}catch(d){}for(var f=c=(c+a+b.length)%b.length;a&&!b[f].isFocusable();){f=(f+a+b.length)%b.length;if(f==c)break}b[f].focus();b[f].type=="text"&&b[f].select()}}function s(c){if(u==
CKEDITOR.dialog._.currentTop){var d=c.data.getKeystroke(),f=b.lang.dir=="rtl";x=p=0;if(d==9||d==CKEDITOR.SHIFT+9){d=d==CKEDITOR.SHIFT+9;if(u._.tabBarMode){d=d?a.call(u):e.call(u);u.selectPage(d);u._.tabs[d][0].focus()}else j(d?-1:1);x=1}else if(d==CKEDITOR.ALT+121&&!u._.tabBarMode&&u.getPageCount()>1){u._.tabBarMode=true;u._.tabs[u._.currentTabId][0].focus();x=1}else if((d==37||d==39)&&u._.tabBarMode){d=d==(f?39:37)?a.call(u):e.call(u);u.selectPage(d);u._.tabs[d][0].focus();x=1}else if((d==13||d==
32)&&u._.tabBarMode){this.selectPage(this._.currentTabId);this._.tabBarMode=false;this._.currentFocusIndex=-1;j(1);x=1}else if(d==13){d=c.data.getTarget();if(!d.is("a","button","select","textarea")&&(!d.is("input")||d.$.type!="button")){(d=this.getButton("ok"))&&CKEDITOR.tools.setTimeout(d.click,0,d);x=1}p=1}else if(d==27){(d=this.getButton("cancel"))?CKEDITOR.tools.setTimeout(d.click,0,d):this.fire("cancel",{hide:true}).hide!==false&&this.hide();p=1}else return;n(c)}}function n(a){x?a.data.preventDefault(1):
p&&a.data.stopPropagation()}var l=CKEDITOR.dialog._.dialogDefinitions[f],t=CKEDITOR.tools.clone(m),o=b.config.dialog_buttonsOrder||"OS",v=b.lang.dir,q={},x,p;(o=="OS"&&CKEDITOR.env.mac||o=="rtl"&&v=="ltr"||o=="ltr"&&v=="rtl")&&t.buttons.reverse();l=CKEDITOR.tools.extend(l(b),t);l=CKEDITOR.tools.clone(l);l=new w(this,l);t=d(b);this._={editor:b,element:t.element,name:f,contentSize:{width:0,height:0},size:{width:0,height:0},contents:{},buttons:{},accessKeyMap:{},tabs:{},tabIdList:[],currentTabId:null,
currentTabIndex:null,pageCount:0,lastTab:null,tabBarMode:false,focusList:[],currentFocusIndex:0,hasFocus:false};this.parts=t.parts;CKEDITOR.tools.setTimeout(function(){b.fire("ariaWidget",this.parts.contents)},0,this);t={position:CKEDITOR.env.ie6Compat?"absolute":"fixed",top:0,visibility:"hidden"};t[v=="rtl"?"right":"left"]=0;this.parts.dialog.setStyles(t);CKEDITOR.event.call(this);this.definition=l=CKEDITOR.fire("dialogDefinition",{name:f,definition:l},b).definition;if(!("removeDialogTabs"in b._)&&
b.config.removeDialogTabs){t=b.config.removeDialogTabs.split(";");for(v=0;v<t.length;v++){o=t[v].split(":");if(o.length==2){var r=o[0];q[r]||(q[r]=[]);q[r].push(o[1])}}b._.removeDialogTabs=q}if(b._.removeDialogTabs&&(q=b._.removeDialogTabs[f]))for(v=0;v<q.length;v++)l.removeContents(q[v]);if(l.onLoad)this.on("load",l.onLoad);if(l.onShow)this.on("show",l.onShow);if(l.onHide)this.on("hide",l.onHide);if(l.onOk)this.on("ok",function(a){b.fire("saveSnapshot");setTimeout(function(){b.fire("saveSnapshot")},
0);if(l.onOk.call(this,a)===false)a.data.hide=false});if(l.onCancel)this.on("cancel",function(a){if(l.onCancel.call(this,a)===false)a.data.hide=false});var u=this,z=function(a){var b=u._.contents,c=false,d;for(d in b)for(var f in b[d])if(c=a.call(this,b[d][f]))return};this.on("ok",function(a){z(function(b){if(b.validate){var c=b.validate(this),d=typeof c=="string"||c===false;if(d){a.data.hide=false;a.stop()}g.call(b,!d,typeof c=="string"?c:void 0);return d}})},this,null,0);this.on("cancel",function(a){z(function(c){if(c.isChanged()){if(!b.config.dialog_noConfirmCancel&&
!confirm(b.lang.common.confirmCancel))a.data.hide=false;return true}})},this,null,0);this.parts.close.on("click",function(a){this.fire("cancel",{hide:true}).hide!==false&&this.hide();a.data.preventDefault()},this);this.changeFocus=j;var y=this._.element;b.focusManager.add(y,1);this.on("show",function(){y.on("keydown",s,this);if(CKEDITOR.env.gecko)y.on("keypress",n,this)});this.on("hide",function(){y.removeListener("keydown",s);CKEDITOR.env.gecko&&y.removeListener("keypress",n);z(function(a){c.apply(a)})});
this.on("iframeAdded",function(a){(new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on("keydown",s,this,null,0)});this.on("show",function(){h();if(b.config.dialog_startupFocusTab&&u._.pageCount>1){u._.tabBarMode=true;u._.tabs[u._.currentTabId][0].focus()}else if(!this._.hasFocus){this._.currentFocusIndex=-1;if(l.onFocus){var a=l.onFocus.call(this);a&&a.focus()}else j(1)}},this,null,4294967295);if(CKEDITOR.env.ie6Compat)this.on("load",function(){var a=this.getElement(),b=a.getFirst();
b.remove();b.appendTo(a)},this);i(this);k(this);(new CKEDITOR.dom.text(l.title,CKEDITOR.document)).appendTo(this.parts.title);for(v=0;v<l.contents.length;v++)(q=l.contents[v])&&this.addPage(q);this.parts.tabs.on("click",function(a){var b=a.data.getTarget();if(b.hasClass("cke_dialog_tab")){b=b.$.id;this.selectPage(b.substring(4,b.lastIndexOf("_")));if(this._.tabBarMode){this._.tabBarMode=false;this._.currentFocusIndex=-1;j(1)}a.data.preventDefault()}},this);v=[];q=CKEDITOR.dialog._.uiElementBuilders.hbox.build(this,
{type:"hbox",className:"cke_dialog_footer_buttons",widths:[],children:l.buttons},v).getChild();this.parts.footer.setHtml(v.join(""));for(v=0;v<q.length;v++)this._.buttons[q[v].id]=q[v]};CKEDITOR.dialog.prototype={destroy:function(){this.hide();this._.element.remove()},resize:function(){return function(a,b){if(!this._.contentSize||!(this._.contentSize.width==a&&this._.contentSize.height==b)){CKEDITOR.dialog.fire("resize",{dialog:this,width:a,height:b},this._.editor);this.fire("resize",{width:a,height:b},
...
dialogDefinitions:{},currentTop:null,currentZIndex:null};CKEDITOR.event.implementOn(CKEDITOR.dialog);CKEDITOR.event.implementOn(CKEDITOR.dialog.prototype);var m={resizable:CKEDITOR.DIALOG_RESIZE_BOTH,minWidth:600,minHeight:400,buttons:[CKEDITOR.dialog.okButton,CKEDITOR.dialog.cancelButton]},s=function(a,b,c){for(var d=0,f;f=a[d];d++){if(f.id==b)return f;if(c&&f[c])if(f=s(f[c],b,c))return f}return null},t=function(a,b,c,d,f){if(c){for(var g=0,e;e=a[g];g++){if(e.id==c){a.splice(g,0,b);return b}if(d&&
e[d])if(e=t(e[d],b,c,d,true))return e}if(f)return null}a.push(b);return b},v=function(a,b,c){for(var d=0,f;f=a[d];d++){if(f.id==b)return a.splice(d,1);if(c&&f[c])if(f=v(f[c],b,c))return f}return null},w=function(a,b){this.dialog=a;for(var c=b.contents,d=0,f;f=c[d];d++)c[d]=f&&new h(a,f);CKEDITOR.tools.extend(this,b)};w.prototype={getContents:function(a){return s(this.contents,a)},getButton:function(a){return s(this.buttons,a)},addContents:function(a,b){return t(this.contents,a,b)},addButton:function(a,
b){return t(this.buttons,a,b)},removeContents:function(a){v(this.contents,a)},removeButton:function(a){v(this.buttons,a)}};h.prototype={get:function(a){return s(this.elements,a,"children")},add:function(a,b){return t(this.elements,a,b,"children")},remove:function(a){v(this.elements,a,"children")}};var x,u={},r,y={},z=function(a){var b=a.data.$.ctrlKey||a.data.$.metaKey,c=a.data.$.altKey,d=a.data.$.shiftKey,f=String.fromCharCode(a.data.$.keyCode);if((b=y[(b?"CTRL+":"")+(c?"ALT+":"")+(d?"SHIFT+":"")+
...
keydown:d||a.accessKeyDown})},G=function(a){for(var b in y){for(var c=y[b],d=c.length-1;d>=0;d--)(c[d].dialog==a||c[d].uiElement==a)&&c.splice(d,1);c.length===0&&delete y[b]}},D=function(a,b){a._.accessKeyMap[b]&&a.selectPage(a._.accessKeyMap[b])},J=function(){};(function(){CKEDITOR.ui.dialog={uiElement:function(a,b,c,d,f,g,e){if(!(arguments.length<4)){var h=(d.call?d(b):d)||"div",j=["<",h," "],i=(f&&f.call?f(b):f)||{},k=(g&&g.call?g(b):g)||{},s=(e&&e.call?e.call(this,a,b):e)||"",m=this.domId=k.id||
CKEDITOR.tools.getNextId()+"_uiElement";this.id=b.id;if(b.requiredContent&&!a.getParentEditor().filter.check(b.requiredContent)){i.display="none";this.notAllowed=true}k.id=m;var l={};b.type&&(l["cke_dialog_ui_"+b.type]=1);b.className&&(l[b.className]=1);b.disabled&&(l.cke_disabled=1);for(var n=k["class"]&&k["class"].split?k["class"].split(" "):[],m=0;m<n.length;m++)n[m]&&(l[n[m]]=1);n=[];for(m in l)n.push(m);k["class"]=n.join(" ");if(b.title)k.title=b.title;l=(b.style||"").split(";");if(b.align){n=
b.align;i["margin-left"]=n=="left"?0:"auto";i["margin-right"]=n=="right"?0:"auto"}for(m in i)l.push(m+":"+i[m]);b.hidden&&l.push("display:none");for(m=l.length-1;m>=0;m--)l[m]===""&&l.splice(m,1);if(l.length>0)k.style=(k.style?k.style+"; ":"")+l.join("; ");for(m in k)j.push(m+'="'+CKEDITOR.tools.htmlEncode(k[m])+'" ');j.push(">",s,"</",h,">");c.push(j.join(""));(this._||(this._={})).dialog=a;if(typeof b.isChanged=="boolean")this.isChanged=function(){return b.isChanged};if(typeof b.isChanged=="function")this.isChanged=
b.isChanged;if(typeof b.setValue=="function")this.setValue=CKEDITOR.tools.override(this.setValue,function(a){return function(c){a.call(this,b.setValue.call(this,c))}});if(typeof b.getValue=="function")this.getValue=CKEDITOR.tools.override(this.getValue,function(a){return function(){return b.getValue.call(this,a.call(this))}});CKEDITOR.event.implementOn(this);this.registerEvents(b);this.accessKeyUp&&(this.accessKeyDown&&b.accessKey)&&A(this,a,"CTRL+"+b.accessKey);var t=this;a.on("load",function(){var b=
t.getInputElement();if(b){var c=t.type in{checkbox:1,ratio:1}&&CKEDITOR.env.ie&&CKEDITOR.env.version<8?"cke_dialog_ui_focused":"";b.on("focus",function(){a._.tabBarMode=false;a._.hasFocus=true;t.fire("focus");c&&this.addClass(c)});b.on("blur",function(){t.fire("blur");c&&this.removeClass(c)})}});CKEDITOR.tools.extend(this,b);if(this.keyboardFocusable){this.tabIndex=b.tabIndex||0;this.focusIndex=a._.focusList.push(this)-1;this.on("focus",function(){a._.currentFocusIndex=t.focusIndex})}}},hbox:function(a,
b,c,d,f){if(!(arguments.length<4)){this._||(this._={});var g=this._.children=b,e=f&&f.widths||null,h=f&&f.height||null,j,i={role:"presentation"};f&&f.align&&(i.align=f.align);CKEDITOR.ui.dialog.uiElement.call(this,a,f||{type:"hbox"},d,"table",{},i,function(){var a=['<tbody><tr class="cke_dialog_ui_hbox">'];for(j=0;j<c.length;j++){var b="cke_dialog_ui_hbox_child",d=[];j===0&&(b="cke_dialog_ui_hbox_first");j==c.length-1&&(b="cke_dialog_ui_hbox_last");a.push('<td class="',b,'" role="presentation" ');
e?e[j]&&d.push("width:"+n(e[j])):d.push("width:"+Math.floor(100/c.length)+"%");h&&d.push("height:"+n(h));f&&f.padding!=void 0&&d.push("padding:"+n(f.padding));CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&g[j].align)&&d.push("text-align:"+g[j].align);d.length>0&&a.push('style="'+d.join("; ")+'" ');a.push(">",c[j],"</td>")}a.push("</tr></tbody>");return a.join("")})}},vbox:function(a,b,c,d,f){if(!(arguments.length<3)){this._||(this._={});var g=this._.children=b,e=f&&f.width||null,h=f&&f.heights||null;CKEDITOR.ui.dialog.uiElement.call(this,
a,f||{type:"vbox"},d,"div",null,{role:"presentation"},function(){var b=['<table role="presentation" cellspacing="0" border="0" '];b.push('style="');f&&f.expand&&b.push("height:100%;");b.push("width:"+n(e||"100%"),";");CKEDITOR.env.webkit&&b.push("float:none;");b.push('"');b.push('align="',CKEDITOR.tools.htmlEncode(f&&f.align||(a.getParentEditor().lang.dir=="ltr"?"left":"right")),'" ');b.push("><tbody>");for(var d=0;d<c.length;d++){var j=[];b.push('<tr><td role="presentation" ');e&&j.push("width:"+
n(e||"100%"));h?j.push("height:"+n(h[d])):f&&f.expand&&j.push("height:"+Math.floor(100/c.length)+"%");f&&f.padding!=void 0&&j.push("padding:"+n(f.padding));CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&g[d].align)&&j.push("text-align:"+g[d].align);j.length>0&&b.push('style="',j.join("; "),'" ');b.push(' class="cke_dialog_ui_vbox_child">',c[d],"</td></tr>")}b.push("</tbody></table>");return b.join("")})}}}})();CKEDITOR.ui.dialog.uiElement.prototype={getElement:function(){return CKEDITOR.document.getById(this.domId)},
...
"use strict",function(){function a(a){function b(){var c=a.editable();c.on(y,function(a){(!CKEDITOR.env.ie||!x)&&t(a)});CKEDITOR.env.ie&&c.on("paste",function(b){if(!u){g();b.data.preventDefault();t(b);p("paste")||a.openDialog("paste")}});if(CKEDITOR.env.ie){c.on("contextmenu",e,null,null,0);c.on("beforepaste",function(a){a.data&&(!a.data.$.ctrlKey&&!a.data.$.shiftKey)&&e()},null,null,0)}c.on("beforecut",function(){!x&&n(a)});var d;c.attachListener(CKEDITOR.env.ie?c:a.document.getDocumentElement(),
"mouseup",function(){d=setTimeout(function(){v()},0)});a.on("destroy",function(){clearTimeout(d)});c.on("keyup",v)}function c(b){return{type:b,canUndo:b=="cut",startDisabled:true,exec:function(){this.type=="cut"&&n();var b;var c=this.type;if(CKEDITOR.env.ie)b=p(c);else try{b=a.document.$.execCommand(c,false,null)}catch(d){b=false}b||alert(a.lang.clipboard[this.type+"Error"]);return b}}}function d(){return{canUndo:false,async:true,exec:function(a,b){var c=function(b,c){b&&q(b.type,b.dataValue,!!c);
a.fire("afterCommandExec",{name:"paste",command:d,returnValue:!!b})},d=this;typeof b=="string"?c({type:"auto",dataValue:b},1):a.getClipboardData(c)}}}function g(){u=1;setTimeout(function(){u=0},100)}function e(){x=1;setTimeout(function(){x=0},10)}function p(b){var c=a.document,d=c.getBody(),f=false,g=function(){f=true};d.on(b,g);(CKEDITOR.env.version>7?c.$:c.$.selection.createRange()).execCommand(b);d.removeListener(b,g);return f}function q(b,c,d){b={type:b};if(d&&a.fire("beforePaste",b)===false||
...
CKEDITOR.env.gecko)e=f.once("blur",g,null,null,-100);s&&k.focus();s=new CKEDITOR.dom.range(k);s.selectNodeContents(k);var m=s.select();CKEDITOR.env.ie&&(e=f.once("blur",function(){a.lockSelection(m)}));var l=CKEDITOR.document.getWindow().getScrollPosition().y;setTimeout(function(){if(CKEDITOR.env.webkit)CKEDITOR.document.getBody().$.scrollTop=l;e&&e.removeListener();CKEDITOR.env.ie&&f.focus();h.selectBookmarks(i);k.remove();var b;if(CKEDITOR.env.webkit&&(b=k.getFirst())&&b.is&&b.hasClass("Apple-style-span"))k=
b;a.removeListener("selectionChange",g);c(k.getHtml())},0)}}function m(){if(CKEDITOR.env.ie){a.focus();g();var b=a.focusManager;b.lock();if(a.editable().fire(y)&&!p("paste")){b.unlock();return false}b.unlock()}else try{if(a.editable().fire(y)&&!a.document.$.execCommand("Paste",false,null))throw 0;}catch(c){return false}return true}function s(b){if(a.mode=="wysiwyg")switch(b.data.keyCode){case CKEDITOR.CTRL+86:case CKEDITOR.SHIFT+45:b=a.editable();g();!CKEDITOR.env.ie&&b.fire("beforepaste");break;
case CKEDITOR.CTRL+88:case CKEDITOR.SHIFT+46:a.fire("saveSnapshot");setTimeout(function(){a.fire("saveSnapshot")},50)}}function t(b){var c={type:"auto"},d=a.fire("beforePaste",c);l(b,function(a){a=a.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/ig,"");d&&q(c.type,a,0,1)})}function v(){if(a.mode=="wysiwyg"){var b=w("paste");a.getCommand("cut").setState(w("cut"));a.getCommand("copy").setState(w("copy"));a.getCommand("paste").setState(b);a.fire("pasteState",b)}}function w(b){if(r&&b in{paste:1,
cut:1})return CKEDITOR.TRISTATE_DISABLED;if(b=="paste")return CKEDITOR.TRISTATE_OFF;var b=a.getSelection(),c=b.getRanges();return b.getType()==CKEDITOR.SELECTION_NONE||c.length==1&&c[0].collapsed?CKEDITOR.TRISTATE_DISABLED:CKEDITOR.TRISTATE_OFF}var x=0,u=0,r=0,y=CKEDITOR.env.ie?"beforepaste":"paste";(function(){a.on("key",s);a.on("contentDom",b);a.on("selectionChange",function(a){r=a.data.selection.getRanges()[0].checkReadOnly();v()});a.contextMenu&&a.contextMenu.addListener(function(a,b){r=b.getRanges()[0].checkReadOnly();
...
a.cancel();i=true;c({type:h,dataValue:a.data})}function g(){this.customTitle=b&&b.title}var e=false,h="auto",i=false;if(!c){c=b;b=null}a.on("paste",d,null,null,0);a.on("beforePaste",function(a){a.removeListener();e=true;h=a.data.type},null,null,1E3);if(m()===false){a.removeListener("paste",d);if(e&&a.fire("pasteDialog",g)){a.on("pasteDialogCommit",f);a.on("dialogHide",function(a){a.removeListener();a.data.removeListener("pasteDialogCommit",f);setTimeout(function(){i||c(null)},10)})}else c(null)}}}
...
(b=" ["+a+"] ");return new CKEDITOR.htmlParser.text(b)},td:p,th:p,$:function(a){var j=a.name,m;if(e[j])return false;a.attributes={};if(j=="br")return a;if(b[j])a.name="p";else if(c[j])delete a.name;else if(g[j]){m=new CKEDITOR.htmlParser.element("cke:br");m.isEmpty=true;if(CKEDITOR.dtd.$empty[j])return m;a.add(m,0);m=m.clone();m.isEmpty=true;a.add(m);delete a.name}d[a.name]||delete a.name;return a}}},{applyToAll:true});return a}function c(a,b,c){var b=new CKEDITOR.htmlParser.fragment.fromHtml(b),
...
null,3);d.on("paste",function(a){var a=a.data,i=a.type,k=a.dataValue,o,p=d.config.clipboard_defaultContentType||"html";o=i=="html"||a.preSniffing=="html"?"html":e(k);o=="htmlifiedtext"?k=b(d.config,k):i=="text"&&o=="html"&&(k=c(d.config,k,f||(f=g(d))));a.startsWithEOL&&(k='<br data-cke-eol="1">'+k);a.endsWithEOL&&(k=k+'<br data-cke-eol="1">');i=="auto"&&(i=o=="html"||p=="html"?"html":"text");a.type=i;a.dataValue=k;delete a.preSniffing;delete a.startsWithEOL;delete a.endsWithEOL},null,null,6);d.on("paste",
...
this._.hideTimeout=0;var k=this.element,a=this._.iframe,a=CKEDITOR.env.ie?a:new CKEDITOR.dom.window(a.$.contentWindow),o=k.getDocument(),p=this._.parentElement.getPositionedAncestor(),q=g.getDocumentPosition(o),o=p?p.getDocumentPosition(o):{x:0,y:0},n=this._.dir=="rtl",l=q.x+(d||0)-o.x,m=q.y+(e||0)-o.y;if(n&&(c==1||c==4))l=l+g.$.offsetWidth;else if(!n&&(c==2||c==3))l=l+(g.$.offsetWidth-1);if(c==3||c==4)m=m+(g.$.offsetHeight-1);this._.panel._.offsetParentId=g.getId();k.setStyles({top:m+"px",left:0,
...
i.element:a.getBody()).$.scrollWidth;CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&a>0)&&(a=a+((k.$.offsetWidth||0)-(k.$.clientWidth||0)+3));k.setStyle("width",a+10+"px");a=i.element.$.scrollHeight;CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&a>0)&&(a=a+((k.$.offsetHeight||0)-(k.$.clientHeight||0)+3));k.setStyle("height",a+"px");h._.currentBlock.element.setStyle("display","none").removeStyle("display")}else k.removeStyle("height");n&&(l=l-k.$.offsetWidth);k.setStyle("left",l+"px");var b=h.element.getWindow(),
a=k.$.getBoundingClientRect(),b=b.getViewPaneSize(),c=a.width||a.right-a.left,d=a.height||a.bottom-a.top,g=n?a.right:b.width-a.left,e=n?b.width-a.right:a.left;n?g<c&&(l=e>c?l+c:b.width>c?l-a.left:l-a.right+b.width):g<c&&(l=e>c?l-c:b.width>c?l-a.right+b.width:l-a.left);c=a.top;b.height-a.top<d&&(m=c>d?m-d:b.height>d?m-a.bottom+b.height:m-a.top);if(CKEDITOR.env.ie){b=a=new CKEDITOR.dom.element(k.$.offsetParent);b.getName()=="html"&&(b=b.getDocument().getBody());b.getComputedStyle("direction")=="rtl"&&
(l=CKEDITOR.env.ie8Compat?l-k.getDocument().getDocumentElement().$.scrollLeft*2:l-(a.$.scrollWidth-a.$.clientWidth))}var a=k.getFirst(),j;(j=a.getCustomData("activePanel"))&&j.onHide&&j.onHide.call(this,1);a.setCustomData("activePanel",this);k.setStyles({top:m+"px",left:l+"px"});k.setOpacity(1);f&&f()},this);h.isLoaded?a():h.onLoad=a;CKEDITOR.tools.setTimeout(function(){var a=CKEDITOR.env.webkit&&CKEDITOR.document.getWindow().getScrollPosition().y;this.focus();i.element.focus();if(CKEDITOR.env.webkit)CKEDITOR.document.getBody().$.scrollTop=
...
this.editor.getSelection(),b=a&&a.getStartElement(),g=this.editor.elementPath(),f=this._.listeners;this.removeAll();for(var e=0;e<f.length;e++){var i=f[e](b,a,g);if(i)for(var k in i){var o=this.editor.getMenuItem(k);if(o&&(!o.command||this.editor.getCommand(o.command).state)){o.state=i[k];this.add(o)}}}},onClick:function(a){this.hide();if(a.onClick)a.onClick();else a.command&&this.editor.execCommand(a.command)},onEscape:function(a){var b=this.parent;b?b._.panel.hideChild(1):a==27&&this.hide(1);return false},
...
(""+a));setTimeout(function(){b.show(i,2)},0)}else this._.panel.hideChild(1)}},proto:{add:function(a){if(!a.order)a.order=this.items.length;this.items.push(a)},removeAll:function(){this.items=[]},show:function(b,d,g,f){if(!this.parent){this._.onShow();if(!this.items.length)return}var d=d||(this.editor.lang.dir=="rtl"?2:1),e=this.items,i=this.editor,k=this._.panel,o=this._.element;if(!k){k=this._.panel=new CKEDITOR.ui.floatPanel(this.editor,CKEDITOR.document.getBody(),this._.panelDefinition,this._.level);
k.onEscape=CKEDITOR.tools.bind(function(a){if(this._.onEscape(a)===false)return false},this);k.onShow=function(){k._.panel.getHolderElement().getParent().addClass("cke cke_reset_all")};k.onHide=CKEDITOR.tools.bind(function(){this._.onHide&&this._.onHide()},this);o=k.addBlock(this.id,this._.panelDefinition.block);o.autoSize=true;var p=o.keys;p[40]="next";p[9]="next";p[38]="prev";p[CKEDITOR.SHIFT+9]="prev";p[i.lang.dir=="rtl"?37:39]=CKEDITOR.env.ie?"mouseup":"click";p[32]=CKEDITOR.env.ie?"mouseup":
"click";CKEDITOR.env.ie&&(p[13]="mouseup");o=this._.element=o.element;p=o.getDocument();p.getBody().setStyle("overflow","hidden");p.getElementsByTag("html").getItem(0).setStyle("overflow","hidden");this._.itemOverFn=CKEDITOR.tools.addFunction(function(a){clearTimeout(this._.showSubTimeout);this._.showSubTimeout=CKEDITOR.tools.setTimeout(this._.showSubMenu,i.config.menu_subMenuDelay||400,this,[a])},this);this._.itemOutFn=CKEDITOR.tools.addFunction(function(){clearTimeout(this._.showSubTimeout)},this);
this._.itemClickFn=CKEDITOR.tools.addFunction(function(a){var b=this.items[a];if(b.state==CKEDITOR.TRISTATE_DISABLED)this.hide(1);else if(b.getItems)this._.showSubMenu(a);else this._.onClick(b)},this)}a(e);for(var p=i.elementPath(),p=['<div class="cke_menu'+(p&&p.direction()!=i.lang.dir?" cke_mixed_dir_content":"")+'" role="presentation">'],q=e.length,n=q&&e[0].group,l=0;l<q;l++){var m=e[l];if(n!=m.group){p.push('<div class="cke_menuseparator" role="separator"></div>');n=m.group}m.render(this,l,p)}p.push("</div>");
o.setHtml(p.join(""));CKEDITOR.ui.fire("ready",this);this.parent?this.parent._.panel.showAsChild(k,this.id,b,d,g,f):k.showBlock(this.id,b,d,g,f);i.fire("menuShow",[k])},addListener:function(a){this._.listeners.push(a)},hide:function(a){this._.onHide&&this._.onHide();this._.panel&&this._.panel.hide(a)}}});CKEDITOR.menuItem=CKEDITOR.tools.createClass({$:function(a,b,g){CKEDITOR.tools.extend(this,g,{order:0,className:"cke_menubutton__"+b});this.group=a._.menuGroups[this.group];this.editor=a;this.name=
b},proto:{render:function(a,d,e){var f=a.id+(""+d),h=typeof this.state=="undefined"?CKEDITOR.TRISTATE_OFF:this.state,i="",k=h==CKEDITOR.TRISTATE_ON?"on":h==CKEDITOR.TRISTATE_DISABLED?"disabled":"off";this.role in{menuitemcheckbox:1,menuitemradio:1}&&(i=' aria-checked="'+(h==CKEDITOR.TRISTATE_ON?"true":"false")+'"');var o=this.getItems,p="&#"+(this.editor.lang.dir=="rtl"?"9668":"9658")+";",q=this.name;if(this.icon&&!/\./.test(this.icon))q=this.icon;a={id:f,name:this.name,iconName:q,label:this.label,
cls:this.className||"",state:k,hasPopup:o?"true":"false",disabled:h==CKEDITOR.TRISTATE_DISABLED,title:this.label,href:"javascript:void('"+(this.label||"").replace("'")+"')",hoverFn:a._.itemOverFn,moveOutFn:a._.itemOutFn,clickFn:a._.itemClickFn,index:d,iconStyle:CKEDITOR.skin.getIconStyle(q,this.editor.lang.dir=="rtl",q==this.icon?null:this.icon,this.iconOffset),arrowHtml:o?g.output({label:p}):"",role:this.role?this.role:"menuitem",ariaChecked:i};b.output(a,e)}}})}(),CKEDITOR.config.menu_groups="clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,table,anchor,link,image,flash,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea,div",
...
false)});a.addCommand("contextMenu",{exec:function(){a.contextMenu.open(a.document.getBody())}});a.setKeystroke(CKEDITOR.SHIFT+121,"contextMenu");a.setKeystroke(CKEDITOR.CTRL+CKEDITOR.SHIFT+121,"contextMenu")}}),function(){var a;function e(d,g){function f(a){a=o.list[a];if(a.equals(d.editable())||a.getAttribute("contenteditable")=="true"){var b=d.createRange();b.selectNodeContents(a);b.select()}else d.getSelection().selectElement(a);d.focus()}function e(){k&&k.setHtml(b);delete o.list}var i=d.ui.spaceId("path"),
k,o=d._.elementsPath,p=o.idBase;g.html=g.html+('<span id="'+i+'_label" class="cke_voice_label">'+d.lang.elementspath.eleLabel+'</span><span id="'+i+'" class="cke_path" role="group" aria-labelledby="'+i+'_label">'+b+"</span>");d.on("uiReady",function(){var a=d.ui.space("path");a&&d.focusManager.add(a,1)});o.onClick=f;var q=CKEDITOR.tools.addFunction(f),n=CKEDITOR.tools.addFunction(function(a,b){var c=o.idBase,g,b=new CKEDITOR.dom.event(b);g=d.lang.dir=="rtl";switch(b.getKeystroke()){case g?39:37:case 9:(g=
CKEDITOR.document.getById(c+(a+1)))||(g=CKEDITOR.document.getById(c+"0"));g.focus();return false;case g?37:39:case CKEDITOR.SHIFT+9:(g=CKEDITOR.document.getById(c+(a-1)))||(g=CKEDITOR.document.getById(c+(o.list.length-1)));g.focus();return false;case 27:d.focus();return false;case 13:case 32:f(a);return false}return true});d.on("selectionChange",function(){d.editable();for(var a=[],f=o.list=[],g=[],e=o.filters,h=true,j=d.elementPath().elements,x,u=j.length;u--;){var r=j[u],y=0;x=r.data("cke-display-name")?
r.data("cke-display-name"):r.data("cke-real-element-type")?r.data("cke-real-element-type"):r.getName();h=r.hasAttribute("contenteditable")?r.getAttribute("contenteditable")=="true":h;!h&&!r.hasAttribute("contenteditable")&&(y=1);for(var z=0;z<e.length;z++){var B=e[z](r,x);if(B===false){y=1;break}x=B||x}if(!y){f.unshift(r);g.unshift(x)}}f=f.length;for(e=0;e<f;e++){x=g[e];h=d.lang.elementspath.eleTitle.replace(/%1/,x);x=c.output({id:p+e,label:h,text:x,jsTitle:"javascript:void('"+x+"')",index:e,keyDownFn:n,
clickFn:q});a.unshift(x)}k||(k=CKEDITOR.document.getById(i));g=k;g.setHtml(a.join("")+b);d.fire("elementsPathUpdate",{space:g})});d.on("readOnly",e);d.on("contentDomUnload",e);d.addCommand("elementsPathFocus",a);d.setKeystroke(CKEDITOR.ALT+122,"elementsPathFocus")}a={editorFocus:false,readOnly:1,exec:function(a){(a=CKEDITOR.document.getById(a._.elementsPath.idBase+"0"))&&a.focus(CKEDITOR.env.ie||CKEDITOR.env.air)}};var b='<span class="cke_path_empty">&nbsp;</span>',g="";CKEDITOR.env.gecko&&CKEDITOR.env.mac&&
...
b.createRange(),f=a.data.node;c.setStartBefore(f);c.setEndAfter(f);for(var e=new CKEDITOR.dom.walker(c),i;i=e.next();)if(i.type==CKEDITOR.NODE_ELEMENT)if(!i.equals(f)&&i.getDirection()){c.setStartAfter(i);e=new CKEDITOR.dom.walker(c)}else{var k=b.config.indentClasses;if(k)for(var o=a.data.dir=="ltr"?["_rtl",""]:["","_rtl"],p=0;p<k.length;p++)if(i.hasClass(k[p]+o[0])){i.removeClass(k[p]+o[0]);i.addClass(k[p]+o[1])}k=i.getStyle("margin-right");o=i.getStyle("margin-left");k?i.setStyle("margin-left",
k):i.removeStyle("margin-left");o?i.setStyle("margin-right",o):i.removeStyle("margin-right")}})}});CKEDITOR.plugins.indent={genericDefinition:function(a){this.isIndent=!!a;this.startDisabled=!this.isIndent},specificDefinition:function(a,b,d){this.name=b;this.editor=a;this.jobs={};this.enterBr=a.config.enterMode==CKEDITOR.ENTER_BR;this.isIndent=!!d;this.relatedGlobal=d?"indent":"outdent";this.indentKey=d?9:CKEDITOR.SHIFT+9;this.database={}},registerCommands:function(a,b){a.on("pluginsLoaded",function(){for(var a in b)(function(a,
...
{execJob:function(a,b){var d=this.jobs[b];if(d.state!=e)return d.exec.call(this,a)},refreshJob:function(a,b,d){b=this.jobs[b];b.state=a.activeFilter.checkFeature(this)?b.refresh.call(this,a,d):e;return b.state},getContext:function(a){return a.contains(this.context)}}}(),function(){function a(a){function c(e){for(var h=q.startContainer,n=q.endContainer;h&&!h.getParent().equals(e);)h=h.getParent();for(;n&&!n.getParent().equals(e);)n=n.getParent();if(!h||!n)return false;for(var l=h,h=[],w=false;!w;){l.equals(n)&&
(w=true);h.push(l);l=l.getNext()}if(h.length<1)return false;l=e.getParents(true);for(n=0;n<l.length;n++)if(l[n].getName&&j[l[n].getName()]){e=l[n];break}for(var l=d.isIndent?1:-1,n=h[0],h=h[h.length-1],w=CKEDITOR.plugins.list.listToArray(e,g),x=w[h.getCustomData("listarray_index")].indent,n=n.getCustomData("listarray_index");n<=h.getCustomData("listarray_index");n++){w[n].indent=w[n].indent+l;if(l>0){var p=w[n].parent;w[n].parent=new CKEDITOR.dom.element(p.getName(),p.getDocument())}}for(n=h.getCustomData("listarray_index")+
1;n<w.length&&w[n].indent>x;n++)w[n].indent=w[n].indent+l;h=CKEDITOR.plugins.list.arrayToList(w,g,null,a.config.enterMode,e.getDirection());if(!d.isIndent){var r;if((r=e.getParent())&&r.is("li"))for(var l=h.listNode.getChildren(),y=[],z,n=l.count()-1;n>=0;n--)(z=l.getItem(n))&&(z.is&&z.is("li"))&&y.push(z)}h&&h.listNode.replace(e);if(y&&y.length)for(n=0;n<y.length;n++){for(z=e=y[n];(z=z.getNext())&&z.is&&z.getName()in j;){CKEDITOR.env.needsNbspFiller&&!e.getFirst(b)&&e.append(q.document.createText(" "));
e.append(z)}e.insertAfter(r)}h&&a.fire("contentDomInvalidated");return true}for(var d=this,g=this.database,j=this.context,p=a.getSelection(),p=(p&&p.getRanges()).createIterator(),q;q=p.getNextRange();){for(var n=q.getCommonAncestor();n&&!(n.type==CKEDITOR.NODE_ELEMENT&&j[n.getName()]);)n=n.getParent();n||(n=q.startPath().contains(j))&&q.setEndAt(n,CKEDITOR.POSITION_BEFORE_END);if(!n){var l=q.getEnclosedNode();if(l&&l.type==CKEDITOR.NODE_ELEMENT&&l.getName()in j){q.setStartAt(l,CKEDITOR.POSITION_AFTER_START);
q.setEndAt(l,CKEDITOR.POSITION_BEFORE_END);n=l}}if(n&&q.startContainer.type==CKEDITOR.NODE_ELEMENT&&q.startContainer.getName()in j){l=new CKEDITOR.dom.walker(q);l.evaluator=e;q.startContainer=l.next()}if(n&&q.endContainer.type==CKEDITOR.NODE_ELEMENT&&q.endContainer.getName()in j){l=new CKEDITOR.dom.walker(q);l.evaluator=e;q.endContainer=l.previous()}if(n)return c(n)}return 0}function e(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.is("li")}function b(a){return g(a)&&c(a)}var g=CKEDITOR.dom.walker.whitespaces(true),
c=CKEDITOR.dom.walker.bookmark(false,true),d=CKEDITOR.TRISTATE_DISABLED,j=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentlist",{requires:"indent",init:function(b){function c(b){g.specificDefinition.apply(this,arguments);this.requiredContent=["ul","ol"];b.on("key",function(a){if(b.mode=="wysiwyg"&&a.data.keyCode==this.indentKey){var c=this.getContext(b.elementPath());if(c&&(!this.isIndent||!CKEDITOR.plugins.indentList.firstItemInPath(this.context,b.elementPath(),c))){b.execCommand(this.relatedGlobal);
a.cancel()}}},this);this.jobs[this.isIndent?10:30]={refresh:this.isIndent?function(a,b){var c=this.getContext(b),f=CKEDITOR.plugins.indentList.firstItemInPath(this.context,b,c);return!c||!this.isIndent||f?d:j}:function(a,b){return!this.getContext(b)||this.isIndent?d:j},exec:CKEDITOR.tools.bind(a,this)}}var g=CKEDITOR.plugins.indent;g.registerCommands(b,{indentlist:new c(b,"indentlist",true),outdentlist:new c(b,"outdentlist")});CKEDITOR.tools.extend(c.prototype,g.specificDefinition.prototype,{context:{ol:1,
...
a.config.enterMode,b.root.getAttribute("dir")).listNode,j,k;d(true);d();i.replace(b.root);a.fire("contentDomInvalidated")}function e(a,b){this.name=a;this.context=this.type=b;this.allowedContent=b+" li";this.requiredContent=b}function b(a,b,c,d){for(var f,e;f=a[d?"getLast":"getFirst"](q);){(e=f.getDirection(1))!==b.getDirection(1)&&f.setAttribute("dir",e);f.remove();c?f[d?"insertBefore":"insertAfter"](c):b.append(f,d)}}function g(a){var c;(c=function(c){var d=a[c?"getPrevious":"getNext"](k);if(d&&
d.type==CKEDITOR.NODE_ELEMENT&&d.is(a.getName())){b(a,d,null,!c);a.remove();a=d}})();c(1)}function c(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.getName()in CKEDITOR.dtd.$block||a.getName()in CKEDITOR.dtd.$listItem)&&CKEDITOR.dtd[a.getName()]["#"]}function d(a,c,d){a.fire("saveSnapshot");d.enlarge(CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS);var f=d.extractContents();c.trim(false,true);var e=c.createBookmark(),h=new CKEDITOR.dom.elementPath(c.startContainer),i=h.block,h=h.lastElement.getAscendant("li",1)||
i,q=new CKEDITOR.dom.elementPath(d.startContainer),p=q.contains(CKEDITOR.dtd.$listItem),q=q.contains(CKEDITOR.dtd.$list);if(i)(i=i.getBogus())&&i.remove();else if(q)(i=q.getPrevious(k))&&o(i)&&i.remove();(i=f.getLast())&&(i.type==CKEDITOR.NODE_ELEMENT&&i.is("br"))&&i.remove();(i=c.startContainer.getChild(c.startOffset))?f.insertBefore(i):c.startContainer.append(f);if(p)if(f=j(p))if(h.contains(p)){b(f,p.getParent(),p);f.remove()}else h.append(f);for(;d.checkStartOfBlock()&&d.checkEndOfBlock();){q=
d.startPath();f=q.block;if(!f)break;if(f.is("li")){h=f.getParent();f.equals(h.getLast(k))&&f.equals(h.getFirst(k))&&(f=h)}d.moveToPosition(f,CKEDITOR.POSITION_BEFORE_START);f.remove()}d=d.clone();f=a.editable();d.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);d=new CKEDITOR.dom.walker(d);d.evaluator=function(a){return k(a)&&!o(a)};(d=d.next())&&(d.type==CKEDITOR.NODE_ELEMENT&&d.getName()in CKEDITOR.dtd.$list)&&g(d);c.moveToBookmark(e);c.select();a.fire("saveSnapshot")}function j(a){return(a=a.getLast(k))&&
a.type==CKEDITOR.NODE_ELEMENT&&a.getName()in f?a:null}var f={ol:1,ul:1},h=CKEDITOR.dom.walker.whitespaces(),i=CKEDITOR.dom.walker.bookmark(),k=function(a){return!(h(a)||i(a))},o=CKEDITOR.dom.walker.bogus();CKEDITOR.plugins.list={listToArray:function(a,b,c,d,e){if(!f[a.getName()])return[];d||(d=0);c||(c=[]);for(var g=0,h=a.getChildCount();g<h;g++){var i=a.getChild(g);i.type==CKEDITOR.NODE_ELEMENT&&i.getName()in CKEDITOR.dtd.$list&&CKEDITOR.plugins.list.listToArray(i,b,c,d+1);if(i.$.nodeName.toLowerCase()==
"li"){var j={parent:a,indent:d,element:i,contents:[]};if(e)j.grandparent=e;else{j.grandparent=a.getParent();if(j.grandparent&&j.grandparent.$.nodeName.toLowerCase()=="li")j.grandparent=j.grandparent.getParent()}b&&CKEDITOR.dom.element.setMarker(b,i,"listarray_index",c.length);c.push(j);for(var k=0,o=i.getChildCount(),q;k<o;k++){q=i.getChild(k);q.type==CKEDITOR.NODE_ELEMENT&&f[q.getName()]?CKEDITOR.plugins.list.listToArray(q,b,c,d+1,j.grandparent):j.contents.push(q)}}}return c},arrayToList:function(a,
b,c,d,e){c||(c=0);if(!a||a.length<c+1)return null;for(var g,h=a[c].parent.getDocument(),j=new CKEDITOR.dom.documentFragment(h),o=null,q=c,p=Math.max(a[c].indent,0),z=null,B,A,G=d==CKEDITOR.ENTER_P?"p":"div";;){var D=a[q];g=D.grandparent;B=D.element.getDirection(1);if(D.indent==p){if(!o||a[q].parent.getName()!=o.getName()){o=a[q].parent.clone(false,1);e&&o.setAttribute("dir",e);j.append(o)}z=o.append(D.element.clone(0,1));B!=o.getDirection(1)&&z.setAttribute("dir",B);for(g=0;g<D.contents.length;g++)z.append(D.contents[g].clone(1,
1));q++}else if(D.indent==Math.max(p,0)+1){D=a[q-1].element.getDirection(1);q=CKEDITOR.plugins.list.arrayToList(a,null,q,d,D!=B?B:null);!z.getChildCount()&&(CKEDITOR.env.needsNbspFiller&&!(h.$.documentMode>7))&&z.append(h.createText(" "));z.append(q.listNode);q=q.nextIndex}else if(D.indent==-1&&!c&&g){if(f[g.getName()]){z=D.element.clone(false,true);B!=g.getDirection(1)&&z.setAttribute("dir",B)}else z=new CKEDITOR.dom.documentFragment(h);var o=g.getDirection(1)!=B,J=D.element,C=J.getAttribute("class"),
F=J.getAttribute("style"),E=z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&(d!=CKEDITOR.ENTER_BR||o||F||C),I,L=D.contents.length,H;for(g=0;g<L;g++){I=D.contents[g];if(i(I)&&L>1)E?H=I.clone(1,1):z.append(I.clone(1,1));else if(I.type==CKEDITOR.NODE_ELEMENT&&I.isBlockBoundary()){o&&!I.getDirection()&&I.setAttribute("dir",B);A=I;var Q=J.getAttribute("style");Q&&A.setAttribute("style",Q.replace(/([^;])$/,"$1;")+(A.getAttribute("style")||""));C&&I.addClass(C);A=null;if(H){z.append(H);H=null}z.append(I.clone(1,
1))}else if(E){if(!A){A=h.createElement(G);z.append(A);o&&A.setAttribute("dir",B)}F&&A.setAttribute("style",F);C&&A.setAttribute("class",C);if(H){A.append(H);H=null}A.append(I.clone(1,1))}else z.append(I.clone(1,1))}if(H){(A||z).append(H);H=null}if(z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&q!=a.length-1){if(CKEDITOR.env.needsBrFiller)(B=z.getLast())&&(B.type==CKEDITOR.NODE_ELEMENT&&B.is("br"))&&B.remove();B=z.getLast(k);(!B||!(B.type==CKEDITOR.NODE_ELEMENT&&B.is(CKEDITOR.dtd.$block)))&&z.append(h.createElement("br"))}B=
z.$.nodeName.toLowerCase();(B=="div"||B=="p")&&z.appendBogus();j.append(z);o=null;q++}else return null;A=null;if(a.length<=q||Math.max(a[q].indent,0)<p)break}if(b)for(a=j.getFirst();a;){if(a.type==CKEDITOR.NODE_ELEMENT){CKEDITOR.dom.element.clearMarkers(b,a);if(a.getName()in CKEDITOR.dtd.$listItem){c=a;h=e=d=void 0;if(d=c.getDirection()){for(e=c.getParent();e&&!(h=e.getDirection());)e=e.getParent();d==h&&c.removeAttribute("dir")}}}a=a.getNextSourceNode()}return{listNode:j,nextIndex:q}}};var p=/^h[1-6]$/,
...
d.createBookmarks(true),h=[],j={},e=e.createIterator(),o=0;(i=e.getNextRange())&&++o;){var q=i.getBoundaryNodes(),r=q.startNode,y=q.endNode;r.type==CKEDITOR.NODE_ELEMENT&&r.getName()=="td"&&i.setStartAt(q.startNode,CKEDITOR.POSITION_AFTER_START);y.type==CKEDITOR.NODE_ELEMENT&&y.getName()=="td"&&i.setEndAt(q.endNode,CKEDITOR.POSITION_BEFORE_END);i=i.createIterator();for(i.forceBrBreak=this.state==CKEDITOR.TRISTATE_OFF;q=i.getNextParagraph();)if(!q.getCustomData("list_block")){CKEDITOR.dom.element.setMarker(j,
q,"list_block",1);for(var z=b.elementPath(q),r=z.elements,y=0,z=z.blockLimit,B,A=r.length-1;A>=0&&(B=r[A]);A--)if(f[B.getName()]&&z.contains(B)){z.removeCustomData("list_group_object_"+o);if(r=B.getCustomData("list_group_object"))r.contents.push(q);else{r={root:B,contents:[q]};h.push(r);CKEDITOR.dom.element.setMarker(j,B,"list_group_object",r)}y=1;break}if(!y){y=z;if(y.getCustomData("list_group_object_"+o))y.getCustomData("list_group_object_"+o).contents.push(q);else{r={root:y,contents:[q]};CKEDITOR.dom.element.setMarker(j,
y,"list_group_object_"+o,r);h.push(r)}}}}for(B=[];h.length>0;){r=h.shift();if(this.state==CKEDITOR.TRISTATE_OFF)if(f[r.root.getName()]){e=b;o=r;r=j;i=B;y=CKEDITOR.plugins.list.listToArray(o.root,r);z=[];for(q=0;q<o.contents.length;q++){A=o.contents[q];if((A=A.getAscendant("li",true))&&!A.getCustomData("list_item_processed")){z.push(A);CKEDITOR.dom.element.setMarker(r,A,"list_item_processed",true)}}for(var A=o.root.getDocument(),G=void 0,D=void 0,q=0;q<z.length;q++){var J=z[q].getCustomData("listarray_index"),
G=y[J].parent;if(!G.is(this.type)){D=A.createElement(this.type);G.copyAttributes(D,{start:1,type:1});D.removeStyle("list-style-type");y[J].parent=D}}r=CKEDITOR.plugins.list.arrayToList(y,r,null,e.config.enterMode);y=void 0;z=r.listNode.getChildCount();for(q=0;q<z&&(y=r.listNode.getChild(q));q++)y.getName()==this.type&&i.push(y);r.listNode.replace(o.root);e.fire("contentDomInvalidated")}else{y=b;q=r;i=B;z=q.contents;e=q.root.getDocument();o=[];if(z.length==1&&z[0].equals(q.root)){r=e.createElement("div");
z[0].moveChildren&&z[0].moveChildren(r);z[0].append(r);z[0]=r}q=q.contents[0].getParent();for(A=0;A<z.length;A++)q=q.getCommonAncestor(z[A].getParent());G=y.config.useComputedState;y=r=void 0;G=G===void 0||G;for(A=0;A<z.length;A++)for(D=z[A];J=D.getParent();){if(J.equals(q)){o.push(D);!y&&D.getDirection()&&(y=1);D=D.getDirection(G);r!==null&&(r=r&&r!=D?null:D);break}D=J}if(!(o.length<1)){z=o[o.length-1].getNext();A=e.createElement(this.type);i.push(A);for(G=i=void 0;o.length;){i=o.shift();G=e.createElement("li");
if(i.is("pre")||p.test(i.getName())||i.getAttribute("contenteditable")=="false")i.appendTo(G);else{i.copyAttributes(G);if(r&&i.getDirection()){G.removeStyle("direction");G.removeAttribute("dir")}i.moveChildren(G);i.remove()}G.appendTo(A)}r&&y&&A.setAttribute("dir",r);z?A.insertBefore(z):A.appendTo(q)}}else this.state==CKEDITOR.TRISTATE_ON&&f[r.root.getName()]&&a.call(this,b,r,j)}for(A=0;A<B.length;A++)g(B[A]);CKEDITOR.dom.element.clearAllMarkers(j);d.selectBookmarks(c);b.focus()},refresh:function(a,
...
a.ui.addButton("BulletedList",{label:a.lang.list.bulletedlist,command:"bulletedlist",directional:true,toolbar:"list,20"})}a.on("key",function(b){var e=b.data.domEvent.getKey();if(a.mode=="wysiwyg"&&e in{8:1,46:1}){var g=a.getSelection().getRanges()[0],h=g&&g.startPath();if(g&&g.collapsed){var i=e==8,q=a.editable(),p=new CKEDITOR.dom.walker(g.clone());p.evaluator=function(a){return k(a)&&!o(a)};p.guard=function(a,b){return!(b&&a.type==CKEDITOR.NODE_ELEMENT&&a.is("table"))};e=g.clone();if(i){var u,
r;if((u=h.contains(f))&&g.checkBoundaryOfElement(u,CKEDITOR.START)&&(u=u.getParent())&&u.is("li")&&(u=j(u))){r=u;u=u.getPrevious(k);e.moveToPosition(u&&o(u)?u:r,CKEDITOR.POSITION_BEFORE_START)}else{p.range.setStartAt(q,CKEDITOR.POSITION_AFTER_START);p.range.setEnd(g.startContainer,g.startOffset);if((u=p.previous())&&u.type==CKEDITOR.NODE_ELEMENT&&(u.getName()in f||u.is("li"))){if(!u.is("li")){p.range.selectNodeContents(u);p.reset();p.evaluator=c;u=p.previous()}r=u;e.moveToElementEditEnd(r)}}if(r){d(a,
e,g);b.cancel()}else if((e=h.contains(f))&&g.checkBoundaryOfElement(e,CKEDITOR.START)){r=e.getFirst(k);if(g.checkBoundaryOfElement(r,CKEDITOR.START)){u=e.getPrevious(k);if(j(r)){if(u){g.moveToElementEditEnd(u);g.select()}}else a.execCommand("outdent");b.cancel()}}}else if(r=h.contains("li")){p.range.setEndAt(q,CKEDITOR.POSITION_BEFORE_END);q=(h=r.getLast(k))&&c(h)?h:r;r=0;if((u=p.next())&&u.type==CKEDITOR.NODE_ELEMENT&&u.getName()in f&&u.equals(h)){r=1;u=p.next()}else g.checkBoundaryOfElement(q,CKEDITOR.END)&&
(r=1);if(r&&u){g=g.clone();g.moveToElementEditStart(u);d(a,e,g);b.cancel()}}else{p.range.setEndAt(q,CKEDITOR.POSITION_BEFORE_END);if((u=p.next())&&u.type==CKEDITOR.NODE_ELEMENT&&u.is(f)){u=u.getFirst(k);if(h.block&&g.checkStartOfBlock()&&g.checkEndOfBlock()){h.block.remove();g.moveToElementEditStart(u);g.select()}else if(j(u)){g.moveToElementEditStart(u);g.select()}else{g=g.clone();g.moveToElementEditStart(u);d(a,e,g)}b.cancel()}}setTimeout(function(){a.selectionChange(1)})}}})}}})}(),function(){function a(a,
b,c){c=a.config.forceEnterMode||c;if(a.mode=="wysiwyg"){if(!b)b=a.activeEnterMode;if(!a.elementPath().isContextFor("p")){b=CKEDITOR.ENTER_BR;c=1}a.fire("saveSnapshot");b==CKEDITOR.ENTER_BR?j(a,b,null,c):f(a,b,null,c);a.fire("saveSnapshot")}}function e(a){for(var a=a.getSelection().getRanges(true),b=a.length-1;b>0;b--)a[b].deleteContents();return a[0]}function b(a){var b=a.startContainer.getAscendant(function(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.getAttribute("contenteditable")=="true"},true);
if(a.root.equals(b))return a;b=new CKEDITOR.dom.range(b);b.moveToRange(a);return b}CKEDITOR.plugins.add("enterkey",{init:function(b){b.addCommand("enter",{modes:{wysiwyg:1},editorFocus:false,exec:function(b){a(b)}});b.addCommand("shiftEnter",{modes:{wysiwyg:1},editorFocus:false,exec:function(b){a(b,b.activeShiftEnterMode,1)}});b.setKeystroke([[13,"enter"],[CKEDITOR.SHIFT+13,"shiftEnter"]])}});var g=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.dom.walker.bookmark();CKEDITOR.plugins.enterkey={enterBlock:function(a,
d,f,p){if(f=f||e(a)){var f=b(f),q=f.document,n=f.checkStartOfBlock(),l=f.checkEndOfBlock(),m=a.elementPath(f.startContainer),s=m.block,t=d==CKEDITOR.ENTER_DIV?"div":"p",v;if(n&&l){if(s&&(s.is("li")||s.getParent().is("li"))){s.is("li")||(s=s.getParent());f=s.getParent();v=f.getParent();var p=!s.hasPrevious(),w=!s.hasNext(),t=a.getSelection(),x=t.createBookmarks(),n=s.getDirection(1),l=s.getAttribute("class"),u=s.getAttribute("style"),r=v.getDirection(1)!=n,a=a.enterMode!=CKEDITOR.ENTER_BR||r||u||l;
if(v.is("li"))if(p||w)s[p?"insertBefore":"insertAfter"](v);else s.breakParent(v);else{if(a){if(m.block.is("li")){v=q.createElement(d==CKEDITOR.ENTER_P?"p":"div");r&&v.setAttribute("dir",n);u&&v.setAttribute("style",u);l&&v.setAttribute("class",l);s.moveChildren(v)}else v=m.block;if(p||w)v[p?"insertBefore":"insertAfter"](f);else{s.breakParent(f);v.insertAfter(f)}}else{s.appendBogus(true);if(p||w)for(;q=s[p?"getFirst":"getLast"]();)q[p?"insertBefore":"insertAfter"](f);else for(s.breakParent(f);q=s.getLast();)q.insertAfter(f)}s.remove()}t.selectBookmarks(x);
return}if(s&&s.getParent().is("blockquote")){s.breakParent(s.getParent());s.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1))||s.getPrevious().remove();s.getNext().getFirst(CKEDITOR.dom.walker.invisible(1))||s.getNext().remove();f.moveToElementEditStart(s);f.select();return}}else if(s&&s.is("pre")&&!l){j(a,d,f,p);return}if(n=f.splitBlock(t)){d=n.previousBlock;s=n.nextBlock;m=n.wasStartOfBlock;a=n.wasEndOfBlock;if(s){x=s.getParent();if(x.is("li")){s.breakParent(x);s.move(s.getNext(),1)}}else if(d&&
(x=d.getParent())&&x.is("li")){d.breakParent(x);x=d.getNext();f.moveToElementEditStart(x);d.move(d.getPrevious())}if(!m&&!a){if(s.is("li")){v=f.clone();v.selectNodeContents(s);v=new CKEDITOR.dom.walker(v);v.evaluator=function(a){return!(c(a)||g(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.getName()in CKEDITOR.dtd.$inline&&!(a.getName()in CKEDITOR.dtd.$empty))};(x=v.next())&&(x.type==CKEDITOR.NODE_ELEMENT&&x.is("ul","ol"))&&(CKEDITOR.env.needsBrFiller?q.createElement("br"):q.createText(" ")).insertBefore(x)}s&&
f.moveToElementEditStart(s)}else{if(d){if(d.is("li")||!h.test(d.getName())&&!d.is("pre"))v=d.clone()}else s&&(v=s.clone());if(v)p&&!v.is("li")&&v.renameNode(t);else if(x&&x.is("li"))v=x;else{v=q.createElement(t);d&&(w=d.getDirection())&&v.setAttribute("dir",w)}if(q=n.elementPath){p=0;for(t=q.elements.length;p<t;p++){x=q.elements[p];if(x.equals(q.block)||x.equals(q.blockLimit))break;if(CKEDITOR.dtd.$removeEmpty[x.getName()]){x=x.clone();v.moveChildren(x);v.append(x)}}}v.appendBogus();v.getParent()||
f.insertNode(v);v.is("li")&&v.removeAttribute("value");if(CKEDITOR.env.ie&&m&&(!a||!d.getChildCount())){f.moveToElementEditStart(a?d:v);f.select()}f.moveToElementEditStart(m&&!a?s:v)}f.select();f.scrollIntoView()}}},enterBr:function(a,b,c,d){if(c=c||e(a)){var g=c.document,j=c.checkEndOfBlock(),l=new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),m=l.block,s=m&&l.block.getName();if(!d&&s=="li")f(a,b,c,d);else{if(!d&&j&&h.test(s))if(j=m.getDirection()){g=g.createElement("div");g.setAttribute("dir",
j);g.insertAfter(m);c.setStart(g,0)}else{g.createElement("br").insertAfter(m);CKEDITOR.env.gecko&&g.createText("").insertAfter(m);c.setStartAt(m.getNext(),CKEDITOR.env.ie?CKEDITOR.POSITION_BEFORE_START:CKEDITOR.POSITION_AFTER_START)}else{a=s=="pre"&&CKEDITOR.env.ie&&CKEDITOR.env.version<8?g.createText("\r"):g.createElement("br");c.deleteContents();c.insertNode(a);if(CKEDITOR.env.needsBrFiller){g.createText("﻿").insertAfter(a);j&&(m||l.blockLimit).appendBogus();a.getNext().$.nodeValue="";c.setStartAt(a.getNext(),
CKEDITOR.POSITION_AFTER_START)}else c.setStartAt(a,CKEDITOR.POSITION_AFTER_END)}c.collapse(true);c.select();c.scrollIntoView()}}}};var d=CKEDITOR.plugins.enterkey,j=d.enterBr,f=d.enterBlock,h=/^h[1-6]$/}(),function(){function a(a,b){var g={},c=[],d={nbsp:" ",shy:"­",gt:">",lt:"<",amp:"&",apos:"'",quot:'"'},a=a.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g,function(a,f){var e=b?"&"+f+";":d[f];g[e]=b?d[f]:"&"+f+";";c.push(e);return""});if(!b&&a){var a=a.split(","),j=document.createElement("div"),
f;j.innerHTML="&"+a.join(";&")+";";f=j.innerHTML;j=null;for(j=0;j<f.length;j++){var h=f.charAt(j);g[h]="&"+a[j]+";";c.push(h)}}g.regex=c.join(b?"|":"");return g}CKEDITOR.plugins.add("entities",{afterInit:function(e){var b=e.config;if(e=(e=e.dataProcessor)&&e.htmlFilter){var g=[];b.basicEntities!==false&&g.push("nbsp,gt,lt,amp");if(b.entities){g.length&&g.push("quot,iexcl,cent,pound,curren,yen,brvbar,sect,uml,copy,ordf,laquo,not,shy,reg,macr,deg,plusmn,sup2,sup3,acute,micro,para,middot,cedil,sup1,ordm,raquo,frac14,frac12,frac34,iquest,times,divide,fnof,bull,hellip,prime,Prime,oline,frasl,weierp,image,real,trade,alefsym,larr,uarr,rarr,darr,harr,crarr,lArr,uArr,rArr,dArr,hArr,forall,part,exist,empty,nabla,isin,notin,ni,prod,sum,minus,lowast,radic,prop,infin,ang,and,or,cap,cup,int,there4,sim,cong,asymp,ne,equiv,le,ge,sub,sup,nsub,sube,supe,oplus,otimes,perp,sdot,lceil,rceil,lfloor,rfloor,lang,rang,loz,spades,clubs,hearts,diams,circ,tilde,ensp,emsp,thinsp,zwnj,zwj,lrm,rlm,ndash,mdash,lsquo,rsquo,sbquo,ldquo,rdquo,bdquo,dagger,Dagger,permil,lsaquo,rsaquo,euro");
...
b.entities_additional&&g.push(b.entities_additional)}var c=a(g.join(",")),d=c.regex?"["+c.regex+"]":"a^";delete c.regex;b.entities&&b.entities_processNumerical&&(d="[^ -~]|"+d);var d=RegExp(d,"g"),j=function(a){return b.entities_processNumerical=="force"||!c[a]?"&#"+a.charCodeAt(0)+";":c[a]},f=a("nbsp,gt,lt,amp,shy",true),h=RegExp(f.regex,"g"),i=function(a){return f[a]};e.addRules({text:function(a){return a.replace(h,i).replace(d,j)}},{applyToAll:true,excludeNestedEditable:true})}}})}(),CKEDITOR.config.basicEntities=
...
{};f.CKEditor=b.name;f.CKEditorFuncNum=b._.filebrowserFn;if(!f.langCode)f.langCode=b.langCode;c.action=a(d.url,f);c.filebrowser=d}function d(a,f,j,o){if(o&&o.length)for(var p,q=o.length;q--;){p=o[q];(p.type=="hbox"||p.type=="vbox"||p.type=="fieldset")&&d(a,f,j,p.children);if(p.filebrowser){if(typeof p.filebrowser=="string")p.filebrowser={action:p.type=="fileButton"?"QuickUpload":"Browse",target:p.filebrowser};if(p.filebrowser.action=="Browse"){var n=p.filebrowser.url;if(n===void 0){n=a.config["filebrowser"+
e(f)+"BrowseUrl"];if(n===void 0)n=a.config.filebrowserBrowseUrl}if(n){p.onClick=b;p.filebrowser.url=n;p.hidden=false}}else if(p.filebrowser.action=="QuickUpload"&&p["for"]){n=p.filebrowser.url;if(n===void 0){n=a.config["filebrowser"+e(f)+"UploadUrl"];if(n===void 0)n=a.config.filebrowserUploadUrl}if(n){var l=p.onClick;p.onClick=function(a){var b=a.sender;return l&&l.call(b,a)===false?false:g.call(b,a)};p.filebrowser.url=n;p.hidden=false;c(a,j.getContents(p["for"][0]).get(p["for"][1]),p.filebrowser)}}}}}
function j(a,b,c){if(c.indexOf(";")!==-1){for(var c=c.split(";"),d=0;d<c.length;d++)if(j(a,b,c[d]))return true;return false}return(a=a.getContents(b).get(c).filebrowser)&&a.url}function f(a,b){var c=this._.filebrowserSe.getDialog(),d=this._.filebrowserSe["for"],f=this._.filebrowserSe.filebrowser.onSelect;d&&c.getContentElement(d[0],d[1]).reset();if(!(typeof b=="function"&&b.call(this._.filebrowserSe)===false)&&!(f&&f.call(this._.filebrowserSe,a,b)===false)){typeof b=="string"&&b&&alert(b);if(a){d=
...
a.data.name,b,c.elements);if(c.hidden&&c.filebrowser)c.hidden=!j(b,c.id,c.filebrowser)}})}(),function(){function a(a){var c=a.config,d=a.fire("uiSpace",{space:"top",html:""}).html,j=function(){function d(a,c,f){h.setStyle(c,b(f));h.setStyle("position",a)}function f(a){var b=k.getDocumentPosition();switch(a){case "top":d("absolute","top",b.y-t-x);break;case "pin":d("fixed","top",r);break;case "bottom":d("absolute","top",b.y+(m.height||m.bottom-m.top)+x)}i=a}var i,k,l,m,s,t,v,w=c.floatSpaceDockedOffsetX||
0,x=c.floatSpaceDockedOffsetY||0,u=c.floatSpacePinnedOffsetX||0,r=c.floatSpacePinnedOffsetY||0;return function(c){if(k=a.editable()){c&&c.name=="focus"&&h.show();h.removeStyle("left");h.removeStyle("right");l=h.getClientRect();m=k.getClientRect();s=e.getViewPaneSize();t=l.height;v="pageXOffset"in e.$?e.$.pageXOffset:CKEDITOR.document.$.documentElement.scrollLeft;if(i){t+x<=m.top?f("top"):t+x>s.height-m.bottom?f("pin"):f("bottom");var c=s.width/2,c=m.left>0&&m.right<s.width&&m.width>l.width?a.config.contentsLangDirection==
"rtl"?"right":"left":c-m.left>m.right-c?"left":"right",d;if(l.width>s.width){c="left";d=0}else{d=c=="left"?m.left>0?m.left:0:m.right<s.width?s.width-m.right:0;if(d+l.width>s.width){c=c=="left"?"right":"left";d=0}}h.setStyle(c,b((i=="pin"?u:w)+d+(i=="pin"?0:c=="left"?v:-v)))}else{i="pin";f("pin");j(c)}}}}();if(d){var f=new CKEDITOR.template('<div id="cke_{name}" class="cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} '+CKEDITOR.env.cssClass+'" dir="{langDir}" title="'+(CKEDITOR.env.gecko?
...
click:a.click||function(b){b.execCommand(a.command)}});this._={}};CKEDITOR.ui.button.handler={create:function(a){return new CKEDITOR.ui.button(a)}};CKEDITOR.ui.button.prototype={render:function(a,c){var d=CKEDITOR.env,j=this._.id=CKEDITOR.tools.getNextId(),f="",h=this.command,i;this._.editor=a;var k={id:j,button:this,editor:a,focus:function(){CKEDITOR.document.getById(j).focus()},execute:function(){this.button.click(a)},attach:function(a){this.button.attach(a)}},o=CKEDITOR.tools.addFunction(function(a){if(k.onkey){a=
new CKEDITOR.dom.event(a);return k.onkey(k,a.getKeystroke())!==false}}),p=CKEDITOR.tools.addFunction(function(a){var b;k.onfocus&&(b=k.onfocus(k,new CKEDITOR.dom.event(a))!==false);return b}),q=0;k.clickFn=i=CKEDITOR.tools.addFunction(function(){if(q){a.unlockSelection(1);q=0}k.execute();d.iOS&&a.focus()});if(this.modes){var n={},l=function(){var b=a.mode;if(b){b=this.modes[b]?n[b]!=void 0?n[b]:CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED;b=a.readOnly&&!this.readOnly?CKEDITOR.TRISTATE_DISABLED:
...
CKEDITOR.document.getById(this._.id),d=c.getFirst(),b=b.data;b!=a.lang.dir?c.addClass("cke_"+b):c.removeClass("cke_ltr").removeClass("cke_rtl");d.setAttribute("style",CKEDITOR.skin.getIconStyle(m,b=="rtl",this.icon,this.iconOffset))},this);h||(f=f+"off");var m=l=this.name||this.command;if(this.icon&&!/\./.test(this.icon)){m=this.icon;this.icon=null}f={id:j,name:l,iconName:m,label:this.label,cls:this.className||"",state:f,ariaDisabled:f=="disabled"?"true":"false",title:this.title,titleJs:d.gecko&&
!d.hc?"":(this.title||"").replace("'",""),hasArrow:this.hasArrow?"true":"false",keydownFn:o,focusFn:p,clickFn:i,style:CKEDITOR.skin.getIconStyle(m,a.lang.dir=="rtl",this.icon,this.iconOffset),arrowHtml:this.hasArrow?e.output():""};b.output(f,c);if(this.onRender)this.onRender();return k},setState:function(a){if(this._.state==a)return false;this._.state=a;var b=CKEDITOR.document.getById(this._.id);if(b){b.setState(a,"cke_button");a==CKEDITOR.TRISTATE_DISABLED?b.setAttribute("aria-disabled",true):b.removeAttribute("aria-disabled");
...
default:i.onkey(i,e)}c.preventDefault()}),o=CKEDITOR.tools.addFunction(function(){i.onfocus&&i.onfocus()}),p=0;i.keyDownFn=k;d={id:j,name:this.name||this.command,label:this.label,title:this.title,cls:this.className||"",titleJs:d.gecko&&!d.hc?"":(this.title||"").replace("'",""),keydownFn:k,focusFn:o,clickFn:f};e.output(d,g);if(this.onRender)this.onRender();return i},createPanel:function(a){if(!this._.panel){var e=this._.panelDefinition,c=this._.panelDefinition.block,d=e.parent||CKEDITOR.document.getBody(),
j="cke_combopanel__"+this.name,f=new CKEDITOR.ui.floatPanel(a,d,e),h=f.addListBlock(this.id,c),i=this;f.onShow=function(){this.element.addClass(j);i.setState(CKEDITOR.TRISTATE_ON);i._.on=1;i.editorFocus&&!a.focusManager.hasFocus&&a.focus();if(i.onOpen)i.onOpen();a.once("panelShow",function(){h.focus(!h.multiSelect&&i.getValue())})};f.onHide=function(c){this.element.removeClass(j);i.setState(i.modes&&i.modes[a.mode]?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);i._.on=0;if(!c&&i.onClose)i.onClose()};
f.onEscape=function(){f.hide(1)};h.onClick=function(a,b){i.onClick&&i.onClick.call(i,a,b);f.hide()};this._.panel=f;this._.list=h;f.getBlock(this.id).onHide=function(){i._.on=0;i.setState(CKEDITOR.TRISTATE_OFF)};this.init&&this.init()}},setValue:function(a,e){this._.value=a;var c=this.document.getById("cke_"+this.id+"_text");if(c){if(!a&&!e){e=this.label;c.addClass("cke_combo_inlinelabel")}else c.removeClass("cke_combo_inlinelabel");c.setText(typeof e!="undefined"?e:a)}},getValue:function(){return this._.value||
...
afterInit:function(a){(a=(a=a.dataProcessor)&&a.htmlFilter)&&a.addRules(c,{applyToAll:true})}});CKEDITOR.editor.prototype.createFakeElement=function(a,c,f,g){var i=this.lang.fakeobjects,i=i[f]||i.unknown,c={"class":c,"data-cke-realelement":encodeURIComponent(a.getOuterHtml()),"data-cke-real-node-type":a.type,alt:i,title:i,align:a.getAttribute("align")||""};if(!CKEDITOR.env.hc)c.src=CKEDITOR.tools.transparentImageData;f&&(c["data-cke-real-element-type"]=f);if(g){c["data-cke-resizable"]=g;f=new e;g=
a.getAttribute("width");a=a.getAttribute("height");g&&(f.rules.width=b(g));a&&(f.rules.height=b(a));f.populate(c)}return this.document.createElement("img",{attributes:c})};CKEDITOR.editor.prototype.createFakeParserElement=function(a,c,f,g){var i=this.lang.fakeobjects,i=i[f]||i.unknown,k;k=new CKEDITOR.htmlParser.basicWriter;a.writeHtml(k);k=k.getHtml();c={"class":c,"data-cke-realelement":encodeURIComponent(k),"data-cke-real-node-type":a.type,alt:i,title:i,align:a.attributes.align||""};if(!CKEDITOR.env.hc)c.src=
...
b)||b.getAttribute("name")&&(!b.getAttribute("href")||!b.getChildCount())))return"anchor"})}});var c=/^javascript:/,d=/^mailto:([^?]+)(?:\?(.+))?$/,j=/subject=([^;?:@&=$,\/]*)/,f=/body=([^;?:@&=$,\/]*)/,h=/^#(.*)$/,i=/^((?:http|https|ftp|news):\/\/)?(.*)$/,k=/^(_(?:self|top|parent|blank))$/,o=/^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/,p=/^javascript:([^(]+)\(([^)]+)\)$/,q=/\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/,
...
b){if(b&&b.data("cke-real-element-type")&&b.data("cke-real-element-type")=="anchor"){var c=a.restoreRealElement(b);if(c.data("cke-saved-name"))return c}},parseLinkAttributes:function(a,b){var e=b&&(b.data("cke-saved-href")||b.getAttribute("href"))||"",g=a.plugins.link.compiledProtectionFunction,w=a.config.emailProtection,x,u={};e.match(c)&&(w=="encode"?e=e.replace(o,function(a,b,c){return"mailto:"+String.fromCharCode.apply(String,b.split(","))+(c&&c.replace(/\\'/g,"'"))}):w&&e.replace(p,function(a,
b,c){if(b==g.name){u.type="email";for(var a=u.email={},b=/(^')|('$)/g,c=c.match(/[^,\s]+/g),d=c.length,f,e,h=0;h<d;h++){f=decodeURIComponent;e=c[h].replace(b,"").replace(/\\'/g,"'");e=f(e);f=g.params[h].toLowerCase();a[f]=e}a.address=[a.name,a.domain].join("@")}}));if(!u.type)if(w=e.match(h)){u.type="anchor";u.anchor={};u.anchor.name=u.anchor.id=w[1]}else if(w=e.match(d)){x=e.match(j);e=e.match(f);u.type="email";var r=u.email={};r.address=w[1];x&&(r.subject=decodeURIComponent(x[1]));e&&(r.body=decodeURIComponent(e[1]))}else if(e&&
(x=e.match(i))){u.type="url";u.url={};u.url.protocol=x[1];u.url.url=x[2]}if(b){if(e=b.getAttribute("target"))u.target={type:e.match(k)?e:"frame",name:e};else if(e=(e=b.data("cke-pa-onclick")||b.getAttribute("onclick"))&&e.match(q))for(u.target={type:"popup",name:e[1]};w=n.exec(e[2]);)(w[2]=="yes"||w[2]=="1")&&!(w[1]in{height:1,width:1,top:1,left:1})?u.target[w[1]]=true:isFinite(w[2])&&(u.target[w[1]]=w[2]);var e={},y;for(y in l)(w=b.getAttribute(y))&&(e[l[y]]=w);if(y=b.data("cke-saved-name")||e.advName)e.advName=
...
"toolbar","menubar","fullscreen","scrollbars","dependent"],h=n.length,j=function(a){d.target[a]&&n.push(a+"="+d.target[a])},i=0;i<h;i++)n[i]=n[i]+(d.target[n[i]]?"=yes":"=no");j("width");j("left");j("height");j("top");f.push(n.join(","),"'); return false;");g["data-cke-pa-onclick"]=f.join("")}else if(d.target.type!="notSet"&&d.target.name)g.target=d.target.name;if(d.advanced){for(var q in l)(f=d.advanced[l[q]])&&(g[q]=f);if(g.name)g["data-cke-saved-name"]=g.name}if(g["data-cke-saved-href"])g.href=
g["data-cke-saved-href"];q=CKEDITOR.tools.extend({target:1,onclick:1,"data-cke-pa-onclick":1,"data-cke-saved-name":1},l);for(var o in g)delete q[o];return{set:g,removed:CKEDITOR.tools.objectKeys(q)}}};CKEDITOR.unlinkCommand=function(){};CKEDITOR.unlinkCommand.prototype={exec:function(a){var b=new CKEDITOR.style({element:"a",type:CKEDITOR.STYLE_INLINE,alwaysRemoveElement:1});a.removeStyle(b)},refresh:function(a,b){var c=b.lastElement&&b.lastElement.getAscendant("a",true);c&&c.getName()=="a"&&c.getAttribute("href")&&
...
"data-cke-saved-name":1});d.removeClass("cke_anchor")}else d.remove(1);b.selectBookmarks(c)},requiredContent:"a[name]"};CKEDITOR.tools.extend(CKEDITOR.config,{linkShowAdvancedTab:true,linkShowTargetTab:true})}(),"use strict",function(){function a(a,b,c){return k(b)&&k(c)&&c.equals(b.getNext(function(a){return!(Y(a)||Z(a)||o(a))}))}function e(a){this.upper=a[0];this.lower=a[1];this.set.apply(this,a.slice(2))}function b(a){var b=a.element;if(b&&k(b))if((b=b.getAscendant(a.triggers,true))&&a.editable.contains(b)){var c=
d(b);if(c.getAttribute("contenteditable")=="true")return b;if(c.is(a.triggers))return c}return null}function g(a,b,c){v(a,b);v(a,c);a=b.size.bottom;c=c.size.top;return a&&c?0|(a+c)/2:a||c}function c(a,b,c){return b=b[c?"getPrevious":"getNext"](function(b){return b&&b.type==CKEDITOR.NODE_TEXT&&!Y(b)||k(b)&&!o(b)&&!i(a,b)})}function d(a,b){if(a.data("cke-editable"))return null;for(b||(a=a.getParent());a;){if(a.data("cke-editable"))break;if(a.hasAttribute("contenteditable"))return a;a=a.getParent()}return null}
function j(a){var b=a.doc,c=z('<span contenteditable="false" style="'+P+"position:absolute;border-top:1px dashed "+a.boxColor+'"></span>',b),d=CKEDITOR.getUrl(this.path+"images/"+(B.hidpi?"hidpi/":"")+"icon"+(a.rtl?"-rtl":"")+".png");r(c,{attach:function(){this.wrap.getParent()||this.wrap.appendTo(a.editable,true);return this},lineChildren:[r(z('<span title="'+a.editor.lang.magicline.title+'" contenteditable="false">&#8629;</span>',b),{base:P+"height:17px;width:17px;"+(a.rtl?"left":"right")+":17px;background:url("+
d+") center no-repeat "+a.boxColor+";cursor:pointer;"+(B.hc?"font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;":"")+(B.hidpi?"background-size: 9px 10px;":""),looks:["top:-8px;"+CKEDITOR.tools.cssVendorPrefix("border-radius","2px",1),"top:-17px;"+CKEDITOR.tools.cssVendorPrefix("border-radius","2px 2px 0px 0px",1),"top:-1px;"+CKEDITOR.tools.cssVendorPrefix("border-radius","0px 0px 2px 2px",1)]}),r(z(W,b),{base:V+"left:0px;border-left-color:"+a.boxColor+";",looks:["border-width:8px 0 8px 8px;top:-8px",
"border-width:8px 0 0 8px;top:-8px","border-width:0 0 8px 8px;top:0px"]}),r(z(W,b),{base:V+"right:0px;border-right-color:"+a.boxColor+";",looks:["border-width:8px 8px 8px 0;top:-8px","border-width:8px 8px 0 0;top:-8px","border-width:0 8px 8px 0;top:0px"]})],detach:function(){this.wrap.getParent()&&this.wrap.remove();return this},mouseNear:function(){v(a,this);var b=a.holdDistance,c=this.size;return c&&a.mouse.y>c.top-b&&a.mouse.y<c.bottom+b&&a.mouse.x>c.left-b&&a.mouse.x<c.right+b?true:false},place:function(){var b=
a.view,c=a.editable,d=a.trigger,f=d.upper,e=d.lower,g=f||e,h=g.getParent(),i={};this.trigger=d;f&&v(a,f,true);e&&v(a,e,true);v(a,h,true);a.inInlineMode&&w(a,true);if(h.equals(c)){i.left=b.scroll.x;i.right=-b.scroll.x;i.width=""}else{i.left=g.size.left-g.size.margin.left+b.scroll.x-(a.inInlineMode?b.editable.left+b.editable.border.left:0);i.width=g.size.outerWidth+g.size.margin.left+g.size.margin.right+b.scroll.x;i.right=""}if(f&&e)i.top=f.size.margin.bottom===e.size.margin.top?0|f.size.bottom+f.size.margin.bottom/
...
c.unselectable();c.lineChildren[0].on("mouseup",function(b){c.detach();f(a,function(b){var c=a.line.trigger;b[c.is(J)?"insertBefore":"insertAfter"](c.is(J)?c.lower:c.upper)},true);a.editor.focus();!B.ie&&a.enterMode!=CKEDITOR.ENTER_BR&&a.hotNode.scrollIntoView();b.data.preventDefault(true)});c.on("mousedown",function(a){a.data.preventDefault(true)});a.line=c}function f(a,b,c){var f=new CKEDITOR.dom.range(a.doc),e=a.editor,g;if(B.ie&&a.enterMode==CKEDITOR.ENTER_BR)g=a.doc.createText(O);else{g=(g=d(a.element,
true))&&g.data("cke-enter-mode")||a.enterMode;g=new y(D[g],a.doc);g.is("br")||a.doc.createText(O).appendTo(g)}c&&e.fire("saveSnapshot");b(g);f.moveToPosition(g,CKEDITOR.POSITION_AFTER_START);e.getSelection().selectRanges([f]);a.hotNode=g;c&&e.fire("saveSnapshot")}function h(a,e){return{canUndo:true,modes:{wysiwyg:1},exec:function(){function g(b){var c=B.ie&&B.version<9?" ":O,d=a.hotNode&&a.hotNode.getText()==c&&a.element.equals(a.hotNode)&&a.lastCmdDirection===!!e;f(a,function(c){d&&a.hotNode&&a.hotNode.remove();
c[e?"insertAfter":"insertBefore"](b);c.setAttributes({"data-cke-magicline-hot":1,"data-cke-magicline-dir":!!e});a.lastCmdDirection=!!e});!B.ie&&a.enterMode!=CKEDITOR.ENTER_BR&&a.hotNode.scrollIntoView();a.line.detach()}return function(f){var f=f.getSelection().getStartElement(),h,f=f.getAscendant(N,1);if(!n(a,f)&&f&&!f.equals(a.editable)&&!f.contains(a.editable)){if((h=d(f))&&h.getAttribute("contenteditable")=="false")f=h;a.element=f;h=c(a,f,!e);var i;if(k(h)&&h.is(a.triggers)&&h.is(R)&&(!c(a,h,!e)||
(i=c(a,h,!e))&&k(i)&&i.is(a.triggers)))g(h);else{i=b(a,f);if(k(i))if(c(a,i,!e))(f=c(a,i,!e))&&(k(f)&&f.is(a.triggers))&&g(i);else g(i)}}}}()}}function i(a,b){if(!b||!(b.type==CKEDITOR.NODE_ELEMENT&&b.$))return false;var c=a.line;return c.wrap.equals(b)||c.wrap.contains(b)}function k(a){return a&&a.type==CKEDITOR.NODE_ELEMENT&&a.$}function o(a){if(!k(a))return false;var b;if(!(b=p(a)))if(k(a)){b={left:1,right:1,center:1};b=!(!b[a.getComputedStyle("float")]&&!b[a.getAttribute("align")])}else b=false;
return b}function p(a){return!!{absolute:1,fixed:1}[a.getComputedStyle("position")]}function q(a,b){return k(b)?b.is(a.triggers):null}function n(a,b){if(!b)return false;for(var c=b.getParents(1),d=c.length;d--;)for(var f=a.tabuList.length;f--;)if(c[d].hasAttribute(a.tabuList[f]))return true;return false}function l(a,b,c){b=b[c?"getLast":"getFirst"](function(b){return a.isRelevant(b)&&!b.is(K)});if(!b)return false;v(a,b);return c?b.size.top>a.mouse.y:b.size.bottom<a.mouse.y}function m(a){var b=a.editable,
c=a.mouse,d=a.view,f=a.triggerOffset;w(a);var g=c.y>(a.inInlineMode?d.editable.top+d.editable.height/2:Math.min(d.editable.height,d.pane.height)/2),b=b[g?"getLast":"getFirst"](function(a){return!(Y(a)||Z(a))});if(!b)return null;i(a,b)&&(b=a.line.wrap[g?"getPrevious":"getNext"](function(a){return!(Y(a)||Z(a))}));if(!k(b)||o(b)||!q(a,b))return null;v(a,b);if(!g&&b.size.top>=0&&c.y>0&&c.y<b.size.top+f){a=a.inInlineMode||d.scroll.y===0?L:Q;return new e([null,b,J,E,a])}if(g&&b.size.bottom<=d.pane.height&&
c.y>b.size.bottom-f&&c.y<d.pane.height){a=a.inInlineMode||b.size.bottom>d.pane.height-f&&b.size.bottom<d.pane.height?H:Q;return new e([b,null,C,E,a])}return null}function s(a){var d=a.mouse,f=a.view,g=a.triggerOffset,h=b(a);if(!h)return null;v(a,h);var g=Math.min(g,0|h.size.outerHeight/2),i=[],j,n;if(d.y>h.size.top-1&&d.y<h.size.top+g)n=false;else if(d.y>h.size.bottom-g&&d.y<h.size.bottom+1)n=true;else return null;if(o(h)||l(a,h,n)||h.getParent().is(M))return null;var m=c(a,h,!n);if(m){if(m&&m.type==
CKEDITOR.NODE_TEXT)return null;if(k(m)){if(o(m)||!q(a,m)||m.getParent().is(M))return null;i=[m,h][n?"reverse":"concat"]().concat([F,E])}}else{if(h.equals(a.editable[n?"getLast":"getFirst"](a.isRelevant))){w(a);n&&d.y>h.size.bottom-g&&d.y<f.pane.height&&h.size.bottom>f.pane.height-g&&h.size.bottom<f.pane.height?j=H:d.y>0&&d.y<h.size.top+g&&(j=L)}else j=Q;i=[null,h][n?"reverse":"concat"]().concat([n?C:J,E,j,h.equals(a.editable[n?"getLast":"getFirst"](a.isRelevant))?n?H:L:Q])}return 0 in i?new e(i):
...
j.outerWidth=b.$.offsetWidth;j.outerHeight=b.$.offsetHeight;j.height=j.outerHeight-(i.top+i.bottom+g.top+g.bottom);j.width=j.outerWidth-(i.left+i.right+g.left+g.right);j.bottom=j.top+j.outerHeight;j.right=j.left+j.outerWidth;if(a.inInlineMode)j.scroll={top:b.$.scrollTop,left:b.$.scrollLeft};return r({border:g,padding:i,margin:h,ignoreScroll:c},j,true)}function v(a,b,c){if(!k(b))return b.size=null;if(b.size){if(b.size.ignoreScroll==c&&b.size.date>new Date-T)return null}else b.size={};return r(b.size,
t(a,b,c),{date:+new Date},true)}function w(a,b){a.view.editable=t(a,a.editable,b,true)}function x(a,b){if(!a.view)a.view={};var c=a.view;if(b||!(c&&c.date>new Date-T)){var d=a.win,c=d.getScrollPosition(),d=d.getViewPaneSize();r(a.view,{scroll:{x:c.x,y:c.y,width:a.doc.$.documentElement.scrollWidth-d.width,height:a.doc.$.documentElement.scrollHeight-d.height},pane:{width:d.width,height:d.height,bottom:d.height+c.y},date:+new Date},true)}}function u(a,b,c,d){for(var f=d,g=d,h=0,i=false,j=false,k=a.view.pane.height,
l=a.mouse;l.y+h<k&&l.y-h>0;){i||(i=b(f,d));j||(j=b(g,d));!i&&l.y-h>0&&(f=c(a,{x:l.x,y:l.y-h}));!j&&l.y+h<k&&(g=c(a,{x:l.x,y:l.y+h}));if(i&&j)break;h=h+2}return new e([f,g,null,null])}CKEDITOR.plugins.add("magicline",{init:function(a){var d=a.config,g=d.magicline_triggerOffset||30,l={editor:a,enterMode:d.enterMode,triggerOffset:g,holdDistance:0|g*(d.magicline_holdDistance||0.5),boxColor:d.magicline_color||"#ff0000",rtl:d.contentsLangDirection=="rtl",tabuList:["data-cke-hidden-sel"].concat(d.magicline_tabuList||
[]),triggers:d.magicline_everywhere?N:{table:1,hr:1,div:1,ul:1,ol:1,dl:1,form:1,blockquote:1}},q,v,u;l.isRelevant=function(a){return k(a)&&!i(l,a)&&!o(a)};a.on("contentDom",function(){var g=a.editable(),k=a.document,o=a.window;r(l,{editable:g,inInlineMode:g.isInline(),doc:k,win:o,hotNode:null},true);l.boundary=l.inInlineMode?l.editable:l.doc.getDocumentElement();if(!g.is(G.$inline)){l.inInlineMode&&!p(g)&&g.setStyles({position:"relative",top:null,left:null});j.call(this,l);x(l);g.attachListener(a,
...
u=null;l.line.detach()}}else{clearTimeout(u);u=null;l.line.detach()}});g.attachListener(g,"keyup",function(){l.hiddenMode=0});g.attachListener(g,"keydown",function(b){if(a.mode=="wysiwyg"){b=b.data.getKeystroke();a.getSelection().getStartElement();switch(b){case 2228240:case 16:l.hiddenMode=1;l.line.detach()}}});g.attachListener(l.inInlineMode?g:k,"mousemove",function(b){v=true;if(!(a.mode!="wysiwyg"||a.readOnly||u)){var c={x:b.data.$.clientX,y:b.data.$.clientY};u=setTimeout(function(){l.mouse=c;
u=l.trigger=null;x(l);if(v&&!l.hiddenMode&&a.focusManager.hasFocus&&!l.line.mouseNear()&&(l.element=S(l,true))){if((l.trigger=m(l)||s(l)||ba(l))&&!n(l,l.trigger.upper||l.trigger.lower))l.line.attach().place();else{l.trigger=null;l.line.detach()}v=false}},30)}});g.attachListener(o,"scroll",function(){if(a.mode=="wysiwyg"){l.line.detach();if(B.webkit){l.hiddenMode=1;clearTimeout(q);q=setTimeout(function(){if(!l.mouseDown)l.hiddenMode=0},50)}}});g.attachListener(A?k:o,"mousedown",function(){if(a.mode==
"wysiwyg"){l.line.detach();l.hiddenMode=1;l.mouseDown=1}});g.attachListener(A?k:o,"mouseup",function(){l.hiddenMode=0;l.mouseDown=0});a.addCommand("accessPreviousSpace",h(l));a.addCommand("accessNextSpace",h(l,true));a.setKeystroke([[d.magicline_keystrokePrevious,"accessPreviousSpace"],[d.magicline_keystrokeNext,"accessNextSpace"]]);a.on("loadSnapshot",function(){var b,c,d,f;for(f in{p:1,br:1,div:1}){b=a.document.getElementsByTag(f);for(d=b.count();d--;)if((c=b.getItem(d)).data("cke-magicline-hot")){l.hotNode=
c;l.lastCmdDirection=c.data("cke-magicline-dir")==="true"?true:false;return}}});this.backdoor={accessFocusSpace:f,boxTrigger:e,isLine:i,getAscendantTrigger:b,getNonEmptyNeighbour:c,getSize:t,that:l,triggerEdge:s,triggerEditable:m,triggerExpand:ba}}},this)}});var r=CKEDITOR.tools.extend,y=CKEDITOR.dom.element,z=y.createFromHtml,B=CKEDITOR.env,A=CKEDITOR.env.ie&&CKEDITOR.env.version<9,G=CKEDITOR.dtd,D={},J=128,C=64,F=32,E=16,I=8,L=4,H=2,Q=1,O=" ",M=G.$listItem,K=G.$tableContent,R=r({},G.$nonEditable,
G.$empty),N=G.$block,T=100,P="width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;",V=P+"border-color:transparent;display:block;border-style:solid;",W="<span>"+O+"</span>";D[CKEDITOR.ENTER_BR]="br";D[CKEDITOR.ENTER_P]="p";D[CKEDITOR.ENTER_DIV]="div";e.prototype={set:function(a,b,c){this.properties=a+b+(c||Q);return this},is:function(a){return(this.properties&a)==a}};var S=function(){function a(b,c){var d=b.$.elementFromPoint(c.x,
c.y);return d&&d.nodeType?new CKEDITOR.dom.element(d):null}return function(b,c,d){if(!b.mouse)return null;var f=b.doc,e=b.line.wrap,d=d||b.mouse,g=a(f,d);if(c&&i(b,g)){e.hide();g=a(f,d);e.show()}return!g||!(g.type==CKEDITOR.NODE_ELEMENT&&g.$)||B.ie&&B.version<9&&!b.boundary.equals(g)&&!b.boundary.contains(g)?null:g}}(),Y=CKEDITOR.dom.walker.whitespaces(),Z=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),ba=function(){function b(d){var f=d.element,e,h,i;if(!k(f)||f.contains(d.editable)||f.isReadOnly())return null;
i=u(d,function(a,b){return!b.equals(a)},function(a,b){return S(a,true,b)},f);e=i.upper;h=i.lower;if(a(d,e,h))return i.set(F,I);if(e&&f.contains(e))for(;!e.getParent().equals(f);)e=e.getParent();else e=f.getFirst(function(a){return c(d,a)});if(h&&f.contains(h))for(;!h.getParent().equals(f);)h=h.getParent();else h=f.getLast(function(a){return c(d,a)});if(!e||!h)return null;v(d,e);v(d,h);if(!(d.mouse.y>e.size.top&&d.mouse.y<h.size.bottom))return null;for(var f=Number.MAX_VALUE,j,l,n,m;h&&!h.equals(e);){if(!(l=
e.getNext(d.isRelevant)))break;j=Math.abs(g(d,e,l)-d.mouse.y);if(j<f){f=j;n=e;m=l}e=l;v(d,e)}if(!n||!m||!(d.mouse.y>n.size.top&&d.mouse.y<m.size.bottom))return null;i.upper=n;i.lower=m;return i.set(F,I)}function c(a,b){return!(b&&b.type==CKEDITOR.NODE_TEXT||Z(b)||o(b)||i(a,b)||b.type==CKEDITOR.NODE_ELEMENT&&b.$&&b.is("br"))}return function(c){var d=b(c),f;if(f=d){f=d.upper;var e=d.lower;f=!f||!e||o(e)||o(f)||e.equals(f)||f.equals(e)||e.contains(f)||f.contains(e)?false:q(c,f)&&q(c,e)&&a(c,f,e)?true:
...
CKEDITOR.instances,c;for(c in b){var e=b[c];if(e.mode=="wysiwyg"&&!e.readOnly){e=e.document.getBody();e.setAttribute("contentEditable",false);e.setAttribute("contentEditable",true)}}if(a.editable().hasFocus){a.toolbox.focus();a.focus()}}}CKEDITOR.plugins.add("maximize",{init:function(a){function e(){var b=i.getViewPaneSize();a.resize(b.width,b.height,null,true)}if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){var f=a.lang,h=CKEDITOR.document,i=h.getWindow(),k,o,p,q=CKEDITOR.TRISTATE_OFF;a.addCommand("maximize",
{modes:{wysiwyg:!CKEDITOR.env.iOS,source:!CKEDITOR.env.iOS},readOnly:1,editorFocus:false,exec:function(){var n=a.container.getFirst(function(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasClass("cke_inner")}),l=a.ui.space("contents");if(a.mode=="wysiwyg"){var m=a.getSelection();k=m&&m.getRanges();o=i.getScrollPosition()}else{var s=a.editable().$;k=!CKEDITOR.env.ie&&[s.selectionStart,s.selectionEnd];o=[s.scrollLeft,s.scrollTop]}if(this.state==CKEDITOR.TRISTATE_OFF){i.on("resize",e);p=i.getScrollPosition();
for(m=a.container;m=m.getParent();){m.setCustomData("maximize_saved_styles",b(m));m.setStyle("z-index",a.config.baseFloatZIndex-5)}l.setCustomData("maximize_saved_styles",b(l,true));n.setCustomData("maximize_saved_styles",b(n,true));l={overflow:CKEDITOR.env.webkit?"":"hidden",width:0,height:0};h.getDocumentElement().setStyles(l);!CKEDITOR.env.gecko&&h.getDocumentElement().setStyle("position","fixed");(!CKEDITOR.env.gecko||!CKEDITOR.env.quirks)&&h.getBody().setStyles(l);CKEDITOR.env.ie?setTimeout(function(){i.$.scrollTo(0,
0)},0):i.$.scrollTo(0,0);n.setStyle("position",CKEDITOR.env.gecko&&CKEDITOR.env.quirks?"fixed":"absolute");n.$.offsetLeft;n.setStyles({"z-index":a.config.baseFloatZIndex-5,left:"0px",top:"0px"});n.addClass("cke_maximized");e();l=n.getDocumentPosition();n.setStyles({left:-1*l.x+"px",top:-1*l.y+"px"});CKEDITOR.env.gecko&&c(a)}else if(this.state==CKEDITOR.TRISTATE_ON){i.removeListener("resize",e);l=[l,n];for(m=0;m<l.length;m++){g(l[m],l[m].getCustomData("maximize_saved_styles"));l[m].removeCustomData("maximize_saved_styles")}for(m=
a.container;m=m.getParent();){g(m,m.getCustomData("maximize_saved_styles"));m.removeCustomData("maximize_saved_styles")}CKEDITOR.env.ie?setTimeout(function(){i.$.scrollTo(p.x,p.y)},0):i.$.scrollTo(p.x,p.y);n.removeClass("cke_maximized");if(CKEDITOR.env.webkit){n.setStyle("display","inline");setTimeout(function(){n.setStyle("display","block")},0)}a.fire("resize")}this.toggleState();if(m=this.uiItems[0]){l=this.state==CKEDITOR.TRISTATE_OFF?f.maximize.maximize:f.maximize.minimize;m=CKEDITOR.document.getById(m._.id);
m.getChild(1).setHtml(l);m.setAttribute("title",l);m.setAttribute("href",'javascript:void("'+l+'");')}if(a.mode=="wysiwyg")if(k){CKEDITOR.env.gecko&&c(a);a.getSelection().selectRanges(k);(s=a.getSelection().getStartElement())&&s.scrollIntoView(true)}else i.$.scrollTo(o.x,o.y);else{if(k){s.selectionStart=k[0];s.selectionEnd=k[1]}s.scrollLeft=o[0];s.scrollTop=o[1]}k=o=null;q=this.state;a.fire("maximize",this.state)},canUndo:false});a.ui.addButton&&a.ui.addButton("Maximize",{label:f.maximize.maximize,
...
g=CKEDITOR.plugins.removeformat.filter,c=a.getSelection().getRanges(),d=c.createIterator(),j=function(a){return a.type==CKEDITOR.NODE_ELEMENT},f;f=d.getNextRange();){f.collapsed||f.enlarge(CKEDITOR.ENLARGE_ELEMENT);var h=f.createBookmark(),i=h.startNode,k=h.endNode,o=function(b){for(var c=a.elementPath(b),d=c.elements,f=1,h;h=d[f];f++){if(h.equals(c.block)||h.equals(c.blockLimit))break;e.test(h.getName())&&g(a,h)&&b.breakParent(h)}};o(i);if(k){o(k);for(i=i.getNextSourceNode(true,CKEDITOR.NODE_ELEMENT);i;){if(i.equals(k))break;
if(i.isReadOnly()){if(i.getPosition(k)&CKEDITOR.POSITION_CONTAINS)break;i=i.getNext(j)}else{o=i.getNextSourceNode(false,CKEDITOR.NODE_ELEMENT);if(!(i.getName()=="img"&&i.data("cke-realelement"))&&g(a,i))if(e.test(i.getName()))i.remove(1);else{i.removeAttributes(b);a.fire("removeFormatCleanup",i)}i=o}}}f.moveToBookmark(h)}a.forceNextSelectionCheck();a.getSelection().selectRanges(c)}}},filter:function(a,e){for(var b=a._.removeFormatFilters||[],g=0;g<b.length;g++)if(b[g](e)===false)return false;return true}},
CKEDITOR.editor.prototype.addRemoveFormatFilter=function(a){if(!this._.removeFormatFilters)this._.removeFormatFilters=[];this._.removeFormatFilters.push(a)},CKEDITOR.config.removeFormatTags="b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var",CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign",CKEDITOR.plugins.add("resize",{init:function(a){var e,b,g,c,d=a.config,j=a.ui.spaceId("resizer"),f=a.element?a.element.getDirection(1):
"ltr";!d.resize_dir&&(d.resize_dir="vertical");d.resize_maxWidth==void 0&&(d.resize_maxWidth=3E3);d.resize_maxHeight==void 0&&(d.resize_maxHeight=3E3);d.resize_minWidth==void 0&&(d.resize_minWidth=750);d.resize_minHeight==void 0&&(d.resize_minHeight=250);if(d.resize_enabled!==false){var h=null,i=(d.resize_dir=="both"||d.resize_dir=="horizontal")&&d.resize_minWidth!=d.resize_maxWidth,k=(d.resize_dir=="both"||d.resize_dir=="vertical")&&d.resize_minHeight!=d.resize_maxHeight,o=function(h){var j=e,m=
b,q=j+(h.data.$.screenX-g)*(f=="rtl"?-1:1),h=m+(h.data.$.screenY-c);i&&(j=Math.max(d.resize_minWidth,Math.min(q,d.resize_maxWidth)));k&&(m=Math.max(d.resize_minHeight,Math.min(h,d.resize_maxHeight)));a.resize(i?j:null,m)},p=function(){CKEDITOR.document.removeListener("mousemove",o);CKEDITOR.document.removeListener("mouseup",p);if(a.document){a.document.removeListener("mousemove",o);a.document.removeListener("mouseup",p)}},q=CKEDITOR.tools.addFunction(function(f){h||(h=a.getResizable());e=h.$.offsetWidth||
0;b=h.$.offsetHeight||0;g=f.screenX;c=f.screenY;d.resize_minWidth>e&&(d.resize_minWidth=e);d.resize_minHeight>b&&(d.resize_minHeight=b);CKEDITOR.document.on("mousemove",o);CKEDITOR.document.on("mouseup",p);if(a.document){a.document.on("mousemove",o);a.document.on("mouseup",p)}f.preventDefault&&f.preventDefault()});a.on("destroy",function(){CKEDITOR.tools.removeFunction(q)});a.on("uiSpace",function(b){if(b.data.space=="bottom"){var c="";i&&!k&&(c=" cke_resizer_horizontal");!i&&k&&(c=" cke_resizer_vertical");
var d='<span id="'+j+'" class="cke_resizer'+c+" cke_resizer_"+f+'" title="'+CKEDITOR.tools.htmlEncode(a.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+q+', event)">'+(f=="ltr"?"◢":"◣")+"</span>";f=="ltr"&&c=="ltr"?b.data.html=b.data.html+d:b.data.html=d+b.data.html}},a,null,100);a.on("maximize",function(b){a.ui.space("resizer")[b.data==CKEDITOR.TRISTATE_ON?"hide":"show"]()})}}}),CKEDITOR.plugins.add("menubutton",{requires:"button,menu",onLoad:function(){var a=function(a){var b=
...
function(c){if(c.data=="source"){if(c=a.scayt){b.destroy(a);a.fire("scaytButtonState",CKEDITOR.TRISTATE_DISABLED)}if(a.document){a.document.getBody().removeAttribute("_jquid");a.document.getBody().removeAttribute("dir")}}});a.on("afterCommandExec",function(b){var c;if(a.mode=="wysiwyg"&&(b.data.name=="undo"||b.data.name=="redo"))(c=a.scayt)&&setTimeout(function(){c.fire("startSpellCheck")},250)});a.on("readOnly",function(c){var d;if(c){d=a.scayt;if(c.editor.readOnly===true)d&&d.fire("removeMarkupInDocument",
...
function(b){b.data.selectPage(a.scayt.tabToOpen)})},parseConfig:function(a){var e=CKEDITOR.plugins.scayt;e.replaceOldOptionsNames(a.config);if(typeof a.config.scayt_autoStartup!=="boolean")a.config.scayt_autoStartup=false;e.state[a.name]=a.config.scayt_autoStartup;if(!a.config.scayt_contextCommands)a.config.scayt_contextCommands="ignore|ignoreall|add";if(!a.config.scayt_contextMenuItemsOrder)a.config.scayt_contextMenuItemsOrder="suggest|moresuggest|control";if(!a.config.scayt_sLang)a.config.scayt_sLang=
...
"boolean")CKEDITOR.config.scayt_handleCheckDirty=true;if(typeof CKEDITOR.config.scayt_handleUndoRedo!=="boolean")CKEDITOR.config.scayt_handleUndoRedo=true;if(a.config.scayt_disableOptionsStorage){var e=CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage)?a.config.scayt_disableOptionsStorage:typeof a.config.scayt_disableOptionsStorage==="string"?[a.config.scayt_disableOptionsStorage]:void 0,c=["all","options","lang","ignore-all-caps-words","ignore-domain-names","ignore-words-with-mixed-cases",
"ignore-words-with-numbers"],d=["lang","ignore-all-caps-words","ignore-domain-names","ignore-words-with-mixed-cases","ignore-words-with-numbers"],j=CKEDITOR.tools.search,f=CKEDITOR.tools.indexOf;a.config.scayt_disableOptionsStorage=function(a){for(var b=[],e=0;e<a.length;e++){var g=a[e],p=!!j(a,"options");if(!j(c,g)||p&&j(d,function(a){if(a==="lang")return false}))return;j(d,g)&&d.splice(f(d,g),1);if(g==="all"||p&&j(a,"lang"))return[];g==="options"&&(d=["lang"])}return b=b.concat(d)}(e)}},addRule:function(a){var e=
a.dataProcessor,b=e&&e.htmlFilter,g=a._.elementsPath&&a._.elementsPath.filters,e=e&&e.dataFilter,c=a.addRemoveFormatFilter,d=function(b){var c=CKEDITOR.plugins.scayt;if(a.scayt&&b.hasAttribute(c.options.data_attribute_name))return false},j=function(b){var c=CKEDITOR.plugins.scayt,d=true;a.scayt&&b.hasAttribute(c.options.data_attribute_name)&&(d=false);return d};g&&g.push(d);e&&e.addRules({elements:{span:function(b){var c=CKEDITOR.plugins.scayt;if(c&&c.state[a.name]&&b.classes&&CKEDITOR.tools.search(b.classes,
...
delete b.name}return b}}});c&&c.call(a,j)},scaytMenuDefinition:function(a){var e=this,a=a.scayt;return{scayt_ignore:{label:a.getLocal("btn_ignore"),group:"scayt_control",order:1,exec:function(a){a.scayt.ignoreWord()}},scayt_ignoreall:{label:a.getLocal("btn_ignoreAll"),group:"scayt_control",order:2,exec:function(a){a.scayt.ignoreAllWords()}},scayt_add:{label:a.getLocal("btn_addWord"),group:"scayt_control",order:3,exec:function(a){var e=a.scayt;setTimeout(function(){e.addWordToUserDictionary()},10)}},
...
this.backCompatibilityMap){a[this.backCompatibilityMap[e]]=a[e];delete a[e]}},createScayt:function(a){var e=this;this.loadScaytLibrary(a,function(a){var g={lang:a.config.scayt_sLang,container:a.editable().$.nodeName=="BODY"?a.document.getWindow().$.frameElement:a.editable().$,customDictionary:a.config.scayt_customDictionaryIds,userDictionaryName:a.config.scayt_userDictionaryName,localization:a.langCode,customer_id:a.config.scayt_customerId,debug:a.config.scayt_debug,data_attribute_name:e.options.data_attribute_name,
misspelled_word_class:e.options.misspelled_word_class,"options-to-restore":a.config.scayt_disableOptionsStorage,focused:a.editable().hasFocus,ignoreElementsRegex:a.config.scayt_elementsToIgnore};if(a.config.scayt_serviceProtocol)g.service_protocol=a.config.scayt_serviceProtocol;if(a.config.scayt_serviceHost)g.service_host=a.config.scayt_serviceHost;if(a.config.scayt_servicePort)g.service_port=a.config.scayt_servicePort;if(a.config.scayt_servicePath)g.service_path=a.config.scayt_servicePath;g=new SCAYT.CKSCAYT(g,
function(){},function(){});g.subscribe("suggestionListSend",function(a){for(var b={},e=[],f=0;f<a.suggestionList.length;f++)if(!b["word_"+a.suggestionList[f]]){b["word_"+a.suggestionList[f]]=a.suggestionList[f];e.push(a.suggestionList[f])}CKEDITOR.plugins.scayt.suggestions=e});a.scayt=g;a.fire("scaytButtonState",a.readOnly?CKEDITOR.TRISTATE_DISABLED:CKEDITOR.TRISTATE_ON)})},destroy:function(a){a.scayt&&a.scayt.destroy();delete a.scayt;a.fire("scaytButtonState",CKEDITOR.TRISTATE_OFF)},loadScaytLibrary:function(a,
...
function(){CKEDITOR.plugins.add("stylescombo",{requires:"richcombo",init:function(a){var e=a.config,b=a.lang.stylescombo,g={},c=[],d=[];a.on("stylesSet",function(b){if(b=b.data.styles){for(var f,h,i,k=0,o=b.length;k<o;k++){f=b[k];if(!(a.blockless&&f.element in CKEDITOR.dtd.$block)){h=f.name;f=new CKEDITOR.style(f);if(!a.filter.customConfig||a.filter.check(f)){f._name=h;f._.enterMode=e.enterMode;f._.type=i=f.assignedTo||f.type;f._.weight=k+(i==CKEDITOR.STYLE_OBJECT?1:i==CKEDITOR.STYLE_BLOCK?2:3)*1E3;
g[h]=f;c.push(f);d.push(f)}}}c.sort(function(a,b){return a._.weight-b._.weight})}});a.ui.addRichCombo("Styles",{label:b.label,title:b.panelTitle,toolbar:"styles,10",allowedContent:d,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(e.contentsCss),multiSelect:true,attributes:{"aria-label":b.panelTitle}},init:function(){var a,d,e,g,k,o;k=0;for(o=c.length;k<o;k++){a=c[k];d=a._name;g=a._.type;if(g!=e){this.startGroup(b["panelTitle"+g]);e=g}this.add(d,a.type==CKEDITOR.STYLE_OBJECT?d:a.buildPreview(),
d)}this.commit()},onClick:function(b){a.focus();a.fire("saveSnapshot");var b=g[b],c=a.elementPath();a[b.checkActive(c,a)?"removeStyle":"applyStyle"](b);a.fire("saveSnapshot")},onRender:function(){a.on("selectionChange",function(b){for(var c=this.getValue(),b=b.data.path.elements,d=0,e=b.length,k;d<e;d++){k=b[d];for(var o in g)if(g[o].checkElementRemovable(k,true,a)){o!=c&&this.setValue(o);return}}this.setValue("")},this)},onOpen:function(){var c=a.getSelection().getSelectedElement(),c=a.elementPath(c),
...
f.getParent(),b=b.getAscendant("table").$.rows[b.$.rowIndex+(a?-1:1)];return b.cells[a?b.cells.length-1:0]});if(!g&&!a){for(var i=f.getAscendant("table").$,g=f.getParent().$.cells,i=new CKEDITOR.dom.element(i.insertRow(-1),b.document),k=0,o=g.length;k<o;k++)i.append((new CKEDITOR.dom.element(g[k],b.document)).clone(false,false)).appendBogus();e.moveToElementEditStart(i)}else if(g){g=new CKEDITOR.dom.element(g);e.moveToElementEditStart(g);(!e.checkStartOfBlock()||!e.checkEndOfBlock())&&e.selectNodeContents(g)}else return true;
...
h=c;h<=g;h++){for(var i=e[h],j=new CKEDITOR.dom.element(f.$.rows[h]),k=0;k<i.length;k++){var o=new CKEDITOR.dom.element(i[k]),p=o.getParent().$.rowIndex;if(o.$.rowSpan==1)o.remove();else{o.$.rowSpan=o.$.rowSpan-1;if(p==h){p=e[h+1];p[k-1]?o.insertAfter(new CKEDITOR.dom.element(p[k-1])):(new CKEDITOR.dom.element(f.$.rows[h+1])).append(o,1)}}k=k+(o.$.colSpan-1)}d.push(j)}e=f.$.rows;f=new CKEDITOR.dom.element(e[g+1]||(c>0?e[c-1]:null)||f.$.parentNode);for(h=d.length;h>=0;h--)b(d[h]);return f}if(c instanceof
...
a[b]==c.$)return b;if(b==c)return new CKEDITOR.dom.element(a[b])}return c.is?-1:null}function i(b,c,d){var f=a(b),e;if((c?f.length!=1:f.length<2)||(e=b.getCommonAncestor())&&e.type==CKEDITOR.NODE_ELEMENT&&e.is("table"))return false;var g,b=f[0];e=b.getAscendant("table");var i=CKEDITOR.tools.buildTableMap(e),j=i.length,k=i[0].length,o=b.getParent().$.rowIndex,p=h(i,o,b);if(c){var y;try{var z=parseInt(b.getAttribute("rowspan"),10)||1;g=parseInt(b.getAttribute("colspan"),10)||1;y=i[c=="up"?o-z:c=="down"?
o+z:o][c=="left"?p-g:c=="right"?p+g:p]}catch(B){return false}if(!y||b.$==y)return false;f[c=="up"||c=="left"?"unshift":"push"](new CKEDITOR.dom.element(y))}for(var c=b.getDocument(),A=o,z=y=0,G=!d&&new CKEDITOR.dom.documentFragment(c),D=0,c=0;c<f.length;c++){g=f[c];var J=g.getParent(),C=g.getFirst(),F=g.$.colSpan,E=g.$.rowSpan,J=J.$.rowIndex,I=h(i,J,g),D=D+F*E,z=Math.max(z,I-p+F);y=Math.max(y,J-o+E);if(!d){F=g;(E=F.getBogus())&&E.remove();F.trim();if(g.getChildren().count()){if(J!=A&&C&&(!C.isBlockBoundary||
...
if(c)return true;var d=d[0],f=d.getParent(),e=f.getAscendant("table"),g=CKEDITOR.tools.buildTableMap(e),i=f.$.rowIndex,j=h(g,i,d),k=d.$.rowSpan,o;if(k>1){o=Math.ceil(k/2);for(var k=Math.floor(k/2),f=i+o,e=new CKEDITOR.dom.element(e.$.rows[f]),g=h(g,f),p,f=d.clone(),i=0;i<g.length;i++){p=g[i];if(p.parentNode==e.$&&i>j){f.insertBefore(new CKEDITOR.dom.element(p));break}else p=null}p||e.append(f)}else{k=o=1;e=f.clone();e.insertAfter(f);e.append(f=d.clone());p=h(g,i);for(j=0;j<p.length;j++)p[j].rowSpan++}f.appendBogus();
d.$.rowSpan=o;f.$.rowSpan=k;o==1&&d.removeAttribute("rowSpan");k==1&&f.removeAttribute("rowSpan");return f}function o(b,c){var d=a(b);if(d.length>1)return false;if(c)return true;var d=d[0],f=d.getParent(),e=f.getAscendant("table"),e=CKEDITOR.tools.buildTableMap(e),g=h(e,f.$.rowIndex,d),i=d.$.colSpan;if(i>1){f=Math.ceil(i/2);i=Math.floor(i/2)}else{for(var i=f=1,j=[],k=0;k<e.length;k++){var o=e[k];j.push(o[g]);o[g].rowSpan>1&&(k=k+(o[g].rowSpan-1))}for(e=0;e<j.length;e++)j[e].colSpan++}e=d.clone();
e.insertAfter(d);e.appendBogus();d.$.colSpan=f;e.$.colSpan=i;f==1&&d.removeAttribute("colSpan");i==1&&e.removeAttribute("colSpan");return e}var p=/^(?:td|th)$/;CKEDITOR.plugins.tabletools={requires:"table,dialog,contextmenu",init:function(g){function h(a){return CKEDITOR.tools.extend(a||{},{contextSensitive:1,refresh:function(a,b){this.setState(b.contains({td:1,th:1},1)?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED)}})}function l(a,b){var c=g.addCommand(a,b);g.addFeature(c)}var m=g.lang.table;
...
h({allowedContent:"td[colspan]",requiredContent:"td[colspan]",exec:function(a){f(o(a.getSelection()))}}));l("cellInsertBefore",h({requiredContent:"table",exec:function(a){a=a.getSelection();d(a,true)}}));l("cellInsertAfter",h({requiredContent:"table",exec:function(a){a=a.getSelection();d(a)}}));g.addMenuItems&&g.addMenuItems({tablecell:{label:m.cell.menu,group:"tablecell",order:1,getItems:function(){var b=g.getSelection(),c=a(b);return{tablecell_insertBefore:CKEDITOR.TRISTATE_OFF,tablecell_insertAfter:CKEDITOR.TRISTATE_OFF,
...
CKEDITOR.TRISTATE_DISABLED}}},tablecell_insertBefore:{label:m.cell.insertBefore,group:"tablecell",command:"cellInsertBefore",order:5},tablecell_insertAfter:{label:m.cell.insertAfter,group:"tablecell",command:"cellInsertAfter",order:10},tablecell_delete:{label:m.cell.deleteCell,group:"tablecell",command:"cellDelete",order:15},tablecell_merge:{label:m.cell.merge,group:"tablecell",command:"cellMerge",order:16},tablecell_merge_right:{label:m.cell.mergeRight,group:"tablecell",command:"cellMergeRight",
...
tablerow_insertAfter:CKEDITOR.TRISTATE_OFF,tablerow_delete:CKEDITOR.TRISTATE_OFF}}},tablerow_insertBefore:{label:m.row.insertBefore,group:"tablerow",command:"rowInsertBefore",order:5},tablerow_insertAfter:{label:m.row.insertAfter,group:"tablerow",command:"rowInsertAfter",order:10},tablerow_delete:{label:m.row.deleteRow,group:"tablerow",command:"rowDelete",order:15},tablecolumn:{label:m.column.menu,group:"tablecolumn",order:1,getItems:function(){return{tablecolumn_insertBefore:CKEDITOR.TRISTATE_OFF,
tablecolumn_insertAfter:CKEDITOR.TRISTATE_OFF,tablecolumn_delete:CKEDITOR.TRISTATE_OFF}}},tablecolumn_insertBefore:{label:m.column.insertBefore,group:"tablecolumn",command:"columnInsertBefore",order:5},tablecolumn_insertAfter:{label:m.column.insertAfter,group:"tablecolumn",command:"columnInsertAfter",order:10},tablecolumn_delete:{label:m.column.deleteColumn,group:"tablecolumn",command:"columnDelete",order:15}});g.contextMenu&&g.contextMenu.addListener(function(a,b,c){return(a=c.contains({td:1,th:1},
...
true;CKEDITOR.env.ie||CKEDITOR.env.air?setTimeout(function(){a.toolbox.focus()},100):a.toolbox.focus()}}};CKEDITOR.plugins.add("toolbar",{requires:"button",init:function(c){var d,e=function(a,b){var g,k=c.lang.dir=="rtl",o=c.config.toolbarGroupCycling,p=k?37:39,k=k?39:37,o=o===void 0||o;switch(b){case 9:case CKEDITOR.SHIFT+9:for(;!g||!g.items.length;){g=b==9?(g?g.next:a.toolbar.next)||c.toolbox.toolbars[0]:(g?g.previous:a.toolbar.previous)||c.toolbox.toolbars[c.toolbox.toolbars.length-1];if(g.items.length)for(a=
g.items[d?g.items.length-1:0];a&&!a.focus;)(a=d?a.previous:a.next)||(g=0)}a&&a.focus();return false;case p:g=a;do{g=g.next;!g&&o&&(g=a.toolbar.items[0])}while(g&&!g.focus);g?g.focus():e(a,9);return false;case 40:if(a.button&&a.button.hasArrow){c.once("panelShow",function(a){a.data._.panel._.currentBlock.onKeyDown(40)});a.execute()}else e(a,b==40?p:k);return false;case k:case 38:g=a;do{g=g.previous;!g&&o&&(g=a.toolbar.items[a.toolbar.items.length-1])}while(g&&!g.focus);if(g)g.focus();else{d=1;e(a,
...
false,k,o;c.config.toolbarCanCollapse&&c.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE&&i.push('<span class="cke_toolbox_main"'+(g?">":' style="display:none">'));for(var p=c.toolbox.toolbars,q=a(c),n=0;n<q.length;n++){var l,m=0,s,t=q[n],v;if(t){if(k){i.push("</span>");o=k=0}if(t==="/")i.push('<span class="cke_toolbar_break"></span>');else{v=t.items||t;for(var w=0;w<v.length;w++){var x=v[w],u;if(x)if(x.type==CKEDITOR.UI_SEPARATOR)o=k&&x;else{u=x.canGroup!==false;if(!m){l=CKEDITOR.tools.getNextId();m={id:l,
items:[]};s=t.name&&(c.lang.toolbar.toolbarGroups[t.name]||t.name);i.push('<span id="',l,'" class="cke_toolbar"',s?' aria-labelledby="'+l+'_label"':"",' role="toolbar">');s&&i.push('<span id="',l,'_label" class="cke_voice_label">',s,"</span>");i.push('<span class="cke_toolbar_start"></span>');var r=p.push(m)-1;if(r>0){m.previous=p[r-1];m.previous.next=m}}if(u){if(!k){i.push('<span class="cke_toolgroup" role="presentation">');k=1}}else if(k){i.push("</span>");k=0}l=function(a){a=a.render(c,i);r=m.items.push(a)-
1;if(r>0){a.previous=m.items[r-1];a.previous.next=a}a.toolbar=m;a.onkey=e;a.onfocus=function(){c.toolbox.focusCommandExecuted||c.focus()}};if(o){l(o);o=0}l(x)}}if(k){i.push("</span>");o=k=0}m&&i.push('<span class="cke_toolbar_end"></span></span>')}}}c.config.toolbarCanCollapse&&i.push("</span>");if(c.config.toolbarCanCollapse&&c.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){var y=CKEDITOR.tools.addFunction(function(){c.execCommand("toolbarCollapse")});c.on("destroy",function(){CKEDITOR.tools.removeFunction(y)});
...
c.undoManager=new b(c),o=j.editingHandler=new d(j),p=c.addCommand("undo",{exec:function(){if(j.undo()){c.selectionChange();this.fire("afterUndo")}},startDisabled:true,canUndo:false}),q=c.addCommand("redo",{exec:function(){if(j.redo()){c.selectionChange();this.fire("afterRedo")}},startDisabled:true,canUndo:false});c.setKeystroke([[a[0],"undo"],[a[1],"redo"],[a[2],"redo"]]);j.onChange=function(){p.setState(j.undoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);q.setState(j.redoable()?CKEDITOR.TRISTATE_OFF:
CKEDITOR.TRISTATE_DISABLED)};c.on("beforeCommandExec",e);c.on("afterCommandExec",e);c.on("saveSnapshot",function(a){j.save(a.data&&a.data.contentOnly)});c.on("contentDom",o.attachListeners,o);c.on("instanceReady",function(){c.fire("saveSnapshot")});c.on("beforeModeUnload",function(){c.mode=="wysiwyg"&&j.save(true)});c.on("mode",g);c.on("readOnly",g);if(c.ui.addButton){c.ui.addButton("Undo",{label:c.lang.undo.undo,command:"undo",toolbar:"undo,10"});c.ui.addButton("Redo",{label:c.lang.undo.redo,command:"redo",
...
false;this.keyEventsStack=new j;this.lastKeydownImage=null};d.prototype={onKeydown:function(c){if(CKEDITOR.tools.indexOf(a,c.data.getKeystroke())>-1)c.data.preventDefault();else{this.keyEventsStack.cleanUp(c);var c=c.data.getKey(),d=this.undoManager;this.keyEventsStack.getLast(c)||this.keyEventsStack.push(c);this.lastKeydownImage=new g(d.editor);if(b.isNavigationKey(c)||this.undoManager.keyGroupChanged(c))if(d.strokesRecorded[0]||d.strokesRecorded[1]){d.save(false,this.lastKeydownImage,false);d.resetType()}}},
...
var i=a.ui.space("contents");i.append(h);if(f=CKEDITOR.env.ie||CKEDITOR.env.gecko)h.on("load",e);var k=a.title,o=a.fire("ariaEditorHelpLabel",{}).label;if(k){CKEDITOR.env.ie&&o&&(k=k+(", "+o));h.setAttribute("title",k)}if(o){var k=CKEDITOR.tools.getNextId(),p=CKEDITOR.dom.element.createFromHtml('<span id="'+k+'" class="cke_voice_label">'+o+"</span>");i.append(p,1);h.setAttribute("aria-describedby",k)}a.on("beforeModeUnload",function(a){a.removeListener();p&&p.remove()});h.setAttributes({tabIndex:a.tabIndex,
...
g||(k=k+CKEDITOR.tools.buildStyleHtml(e.config.contentsCss));var o=f.baseHref?'<base href="'+f.baseHref+'" data-cke-temp="1" />':"";g&&(a=a.replace(/<!DOCTYPE[^>]*>/i,function(a){e.docType=i=a;return""}).replace(/<\?xml\s[^\?]*\?>/i,function(a){e.xmlDeclaration=a;return""}));a=e.dataProcessor.toHtml(a);if(g){/<body[\s|>]/.test(a)||(a="<body>"+a);/<html[\s|>]/.test(a)||(a="<html>"+a+"</html>");/<head[\s|>]/.test(a)?/<title[\s|>]/.test(a)||(a=a.replace(/<head[^>]*>/,"$&<title></title>")):a=a.replace(/<html[^>]*>/,
"$&<head><title></title></head>");o&&(a=a.replace(/<head[^>]*?>/,"$&"+o));a=a.replace(/<\/head\s*>/,k+"$&");a=i+a}else a=f.docType+'<html dir="'+f.contentsLangDirection+'" lang="'+(f.contentsLanguage||e.langCode)+'"><head><title>'+this._.docTitle+"</title>"+o+k+"</head><body"+(f.bodyId?' id="'+f.bodyId+'"':"")+(f.bodyClass?' class="'+f.bodyClass+'"':"")+">"+a+"</body></html>";if(CKEDITOR.env.gecko){a=a.replace(/<body/,'<body contenteditable="true" ');CKEDITOR.env.version<2E4&&(a=a.replace(/<body[^>]*>/,
